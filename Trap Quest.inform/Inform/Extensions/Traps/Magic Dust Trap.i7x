...
To check magic dust:
	...
	if debuginfo > 0, say "[input-style]Magic Dust Attack Roll: d23+7 ([X]) | ([dexterity of the player].5) Dexterity[roman type][line break]";
...
To compute magic dust:
	let C be most-transformable-uncovered-clothing;
	if diaper quest is 1 and diaper messing >= 3 and the player is full and asshole is not actually occupied and there is worn total protection soilable knickers and a random number between 1 and 2 is 1:
