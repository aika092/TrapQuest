...
To trigger (Y - a magic dust trap):
	...
	if X > the dexterity of the player:
		if diaper quest is 1 and hypno-trigger-maturity is 0 and diaper lover >= 3 and the player is a November 2017 diaper donator:
			say "A phrase rapidly repeats in your head over and over and over and over. [line break][second custom style]'I don't need maturity!  I don't need maturity!  I don't need maturity!  Don't need maturity!  Don't need maturity!  Maturity!  Maturity!  Maturity...'[roman type][line break]You feel that if you were to hear someone say that word out loud, you might lose control over your own actions.";
