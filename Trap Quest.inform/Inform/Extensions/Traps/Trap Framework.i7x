...
Definition: a room is trapped rather than untrapped:
	if there is a trap in it, decide yes;
	decide no.

Definition: a room is click trapped rather than click untrapped:
	if there is a click trap in it, decide yes;
	decide no.

Definition: a room is wire trapped rather than wire untrapped:
	if there is a wire trap in it, decide yes;
	decide no.

Definition: a room is pressure trapped rather than pressure untrapped:
