...
To say TransformReaction of (C - a sissy suspenders):
	...
	otherwise if the humiliation of the player < 40000:
		say "[variable custom style]These are so [if the humiliation of the player > 30000]perfect[otherwise]cute[end if].  I love the silky frills![roman type][line break]".
