...
[To say PussyAssFlav:
	...
	if S > 13, say "[if the bimbo of the player < 14][first custom style]I'm on the verge of tears...  [roman type][otherwise][second custom style]I think I need more lube...  [roman type][end if]".]
