...
To say ClothesDescription:
	...
	repeat with O running through worn overdresses:
		...
		If O is audible jiggles and the largeness of breasts > 1, say "Your [ShortDesc of O] is vocalizing the sound your [BreastBounceDesc] make as they [ShortDescBreasts].";
