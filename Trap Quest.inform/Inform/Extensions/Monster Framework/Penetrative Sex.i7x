...
To say SpitroastPrep of (M - a monster) with (O - a monster) in (F - asshole):
	say "[BigNameDesc of M] pulls your hips up against [his of M] body, forcing you to support yourself with your hands as [he of M] spreads your asscheeks apart.".

To say ThreesomePrep of (M - a monster) with (N - a monster) in (F - asshole):
	if N is intelligent, say "The [N] flips you over so you're face to face, holding you by the waist as [NameDesc of M] pulls apart your asscheeks.";
	otherwise say "[BigNameDesc of M] flips you onto your side, so you're facing the [N]. The [N] continues to fuck your [vagina] as the newcomer spreads apart your asscheeks.".
		
To say FoursomePrep of (M - a monster) with (N - a monster) and (O - a monster) in (F - asshole):
	if N is intelligent, say "The [N] flips you over so your chin is resting on [his of N] chest, holding you by the waist as [NameDesc of M] pulls apart your asscheeks.";
	otherwise say "[BigNameDesc of M] flips you onto your side, so you[']re facing the [N]. The [N] and the [O] continue to fuck you as the newcomer spreads apart your asscheeks.".

To say TwosomePrep of (M - a monster) in (F - asshole):[in other words, sex.]
	say "[BigNameDesc of M] shoves you face down and pulls your hips up against [his of M] body. [big he of M] spreads your asscheeks apart.".
...
To say VeryTightAssholePenetrationFlav of (M - a monster):[low bimbo: 2, mid: 2, high: 1. Think of this spread as a prediction of when the player will be seeing this. We expect the player to have lower sex addiction at lower tightness, so we put more variation there.]
	...
	if the relevant sex addiction of M < 7:
		say "[one of]You [if O is monster]complain as loudly as you can through your mouthful of [O][otherwise]look over your shoulder[end if] as [his of M] [DickDesc of M] prods at your sphincter, attempting to force its way in with brute force alone. [BigNameDesc of M] stops only to[unless O is monster] leer at your furious face and[end if] spit in your hole, giving [him of M] that last bit of lubrication needed to slowly, painfully, force [his of M] way in.[or][if O is monster]You try as hard as you can to evade it, but your mouth is much too full of dick for you to manage anything but a low groan of pain[otherwise]You try as hard as you can to make it difficult for [him of M], cursing through the pain[end if] as [NameDesc of M] slowly and painfully forces [his of M] [DickDesc of M] into your [asshole], only pausing when [his of M] balls are in full contact with your taint.[at random]";
	otherwise if the relevant sex addiction of M < 12:
		say "[one of]You [if O is monster]half-heartedly struggle as [his of M] [DickDesc of M] prods at your sphincter, trying your best to ignore what[']s in your mouth and focus on keeping [him of M] at bay. [BigNameDesc of M] stops, but[otherwise]silently look over your shoulder as [his of M] [DickDesc of M] prods at your sphincter, doing absolutely nothing to stop [him of M] even though every part of your being is telling you you should. [BigNameDesc of M] stops, but[end if] only to spit in your hole, giving [him of M] that last bit of lubrication needed to slowly, painfully, force [his of M] way into your [asshole].[or]You brace yourself as [NameDesc of M]'s [DickDesc of M] presses at your sphincter, stretching it bit by painful bit as it slowly forces its way into your [asshole]. The feeling is so intense, that by the time it occurs to you to bolt or at least fight, [his of M] balls are already slapping your [if the player is male]coin-purse[otherwise]taint[end if].[at random]";
	otherwise:
		say "You [if O is monster]continue servicing the dick in your mouth[otherwise]look over your shoulder with a grin[end if] as [his of M] [DickDesc of M] prods at your sphincter, attempting to force its way in with brute force alone. [BigNameDesc of M] pauses only to [unless O is monster]return your look and [end if]spit in your hole, giving [him of M] that last bit of lubrication needed to slowly, painfully, force [his of M] way in.".

To say LessTightAssholePenetrationFlav of (M - a monster):[low bimbo: 3 mid: 2, high: 1]
	let O be a random monster penetrating face;
	if the relevant sex addiction of M < 7:
		say "[one of]You [if O is monster]groan as loudly as you can through the dick in your mouth[otherwise]grit your teeth and shoot a furious glare over your shoulder[end if] as [his of M] [DickDesc of M] forces open your sphincter, just big enough to hurt as much as possible without needing any extra lube. [BigNameDesc of M] answers your look with a hearty smack of your [AssDesc], and grabs your hips with both hands to ensure you can[']t escape.[or][if O is monster]You try to dissuade [him of M], but your mouth is much too full of dick for you to manage anything but a pained grunt[otherwise]You try as hard as you can to make it difficult for [him of M], cursing through the pain[end if] as [NameDesc of M] forces [his of M] [DickDesc of M] into your [asshole], only pausing when [his of M] balls slap your [if the player is male]taint[otherwise]cunt[end if]. Easily stopping your last escape attempt with a stronger grip, [he of M] begins to thrust.[or]You [if O is monster]grunt around the dick in your mouth[otherwise]snarl at [NameDesc of M][end if] as [his of M] cockhead presses at your sphincter, which painfully stretches to let [his of M] [DickDesc of M] slowly slide its way in. Something tells you this will be a long, unpleasant fucking.[at random]";
	otherwise if the relevant sex addiction of M < 12:
...
To say FriendlyLessTightAssholePenetrationFlav of (M - a monster):[low bimbo: 3 mid: 2, high: 1; less tight]
	if the sex addiction of the player < 7:
		say "[one of]You angrily chide yourself as [his of M] [DickDesc of M] presses at your sphincter, just tight enough to hurt as much as possible and still allow [him of M] to force [his of M] way in without extra lube. [BigNameDesc of M] gives you a moment to get used to [him of M] and slowly begins to thrust.[or]You tremble with shame as [he of M] presses [his of M] [DickDesc of M] against your sphincter, which barely stretches enough to let [him of M] slowly force [his of M] way in. [BigNameDesc of M] gives your [AssDesc] a slap and slowly begins to thrust. [or]You give [him of M] a fake smile over your shoulder as [his of M] [DickDesc of M] forces open your sphincter, realizing with a stifled grunt of pain exactly how much power you have if [he of M] doesn[']t want to listen to you. None. Maybe this was a bad idea.[at random]";
	otherwise if the sex addiction of the player < 12:
		say "[one of]It's all you can do not to impale yourself backward on [his of M] [DickDesc of M] as the throbbing tip presses at your sphincter, which has just enough give to allow [him of M] to force [his of M] way in without adding any lube at all, and remind you how much you wish it didn't. [BigNameDesc of M] chuckles and immediately begins thrusting.[or]You bite your lip as [his of M] throbbing cockhead pushes through your reluctant sphincter, desperately trying to hate the big, hard [DickDesc of M] slowly forcing its way into your too-tight [asshole]. [BigNameDesc of M] gives you an uncomfortably welcome spank and immediately begins to thrust.[at random]";
	otherwise:
		say "You eagerly push back against [him of M] as [his of M] [DickDesc of M] presses at your sphincter, which is just tight enough for you to feel [him of M] as much as possible without needing any extra lube. [BigNameDesc of M] gives your [AssDesc] a spank as [he of M] slides in and begins to thrust.".

To say FriendlyLessLooseAssholePenetrationFlav of (M - a monster):[low bimbo: 2 mid: 2, high: 2; less loose]
	if the sex addiction of the player < 7:
		say "[one of]You scowl at the ground in front of you as [he of M] pushes [his of M] [DickDesc of M] into your [asshole], which easily stretches to accommodate [him of M]. [BigNameDesc of M] slowly begins to thrust, holding your hips for 'support' as [his of M] balls slap your taint.[or]You give [him of M] a fake smile over your shoulder as [he of M] pushes [his of M] [DickDesc of M] into your [asshole], which [he of M] mistakes for real enthusiasm. [BigNameDesc of M] starts out hard and fast, every thrust further shaming you for letting it happen.[at random]";
	otherwise if the sex addiction of the player < 12:
		say "[one of]You look over your shoulder as [he of M] pushes [his of M] [DickDesc of M] into your [asshole], which is all too ready to accommodate [him of M]. [BigNameDesc of M] leers at you as [his of M] hands explore your body, groping your [BreastDesc] and squeezing your [AssDesc] until you finally lose your patience and begin fucking yourself with [his of M] cock.[or]You ease yourself backward, onto [his of M] of [DickDesc of M], emitting a quiet moan when [he of M] suddenly tightens [his of M] grip on your waist and slams it the rest of the way into your [asshole]. [BigNameDesc of M] 'apologises' with an all-too-welcome slap on your ass and immediately begins to thrust.[at random]";
	otherwise:
		say "[one of]You [if there is a monster penetrating face]moan happily[otherwise]give [him of M] a hungry look over your shoulder[end if], wiggling your hips as [he of M] pushes every inch of [his of M] [DickDesc of M] into your eager [asshole]. [BigNameDesc of M] slaps your [AssDesc] and immediately begins to thrust.[or]You push back against [his of M] invading [DickDesc of M], moaning throatily as every inch sinks into your loose hole. [BigNameDesc of M] gropes your [BreastDesc] as you begin to work your hips back and forth, eager to enjoy [him of M]self while you proudly do the work.[at random]".

To say FriendlyVeryLooseAssholePenetrationFlav of (M - a monster):[low bimbo: 1 mid: 3, high: 3; very loose]
	if the sex addiction of the player < 7:
		say "You sigh and roll your eyes as [he of M] slides [his of M] dick into your [asshole], beginning to mechanically fuck yourself on [his of M] cock. [BigNameDesc of M] brazenly smacks your [AssDesc] and gropes your [BreastDesc], obviously willing to let you do all the work.";
	otherwise if the sex addiction of the player < 12:
		say "[one of]You emit a low moan as [he of M] slides [his of M] [DickDesc of M] slides into your [asshole], grabbing both of your wrists and pinning them behind your back as [he of M] immediately begins to thrust. Somehow, the thought that [he of M] might not stop if you ask turns you on even more.[or]You look over your shoulder as [he of M] slides [his of M] [DickDesc of M] into your [asshole], suddenly realizing what a [line break][second custom style]naughty[roman type][line break]expression you're making when [he of M] slaps your [AssDesc] and immediately begins thrusting.[or]You moan as [NameDesc of M] slams [his of M] [DickDesc of M] into your [asshole] and begins thrusting at full force! [BigNameDesc of M] doesn[']t seem to care you invited [him of M], [he of M][']s still treating you like a piece of meat! But then again, it's not like you hate it...[at random]";
	otherwise:
		say "[one of]You giggle happily as [he of M] slides [his of M] [DickDesc of M] into your [asshole], working your hips back and forth as [he of M] smacks your [AssDesc] and gropes your [BreastDesc]. It's even more fun when you get to do the work![or]You proudly look over your shoulder as [he of M] slides [his of M] [DickDesc of M] into your loose [asshole], grinning at [him of M] as [he of M] begins to thrust. You[']re loose enough that [he of M] can go all out from the get go, [his of M] balls slapping audibly against your [if the player is male]sack[otherwise]cunt[end if] as [his of M] hands grab hold of your waist.[or]You push backward against [him of M] as [his of M] [DickDesc of M] enters your [asshole], glancing over your shoulder to [if there is a worn ballgag]stare seductively at [NameDesc of M] as you begin to work your hips back and forth.[otherwise]seductively lick your lips as you begin to work your hips back and forth.[end if][at random]".
...
To say SpitroastPrep of (M - a monster) with (O - a monster) in (F - vagina):[Does this monster have something unique to do or set up during a spitroast, or does O interact with M in a special way? override this function]
	say "[BigNameDesc of M] pulls your hips up against [his of M] body, forcing you to support yourself with your hands as [he of M] spreads your legs.".
...
To say ThreesomePrep of (M - a monster) with (N - a monster) in (F - vagina):[Does this monster have something unique for double penetration, or do N and M interact in a special way? override this function]
	if N is intelligent, say "The [N] flips you so your head is resting on [his of N] chest, holding you by the waist as [NameDesc of M] spreads your legs.";
	otherwise say "[BigNameDesc of M] grabs your leg and lifts it out of the way.".
...
To say FoursomePrep of (M - a monster) with (N - a monster) and (O - a monster) in (F - vagina):[Does this monster have something special for triple penetration, or do M, N, or O have something special to do together]
	if N is intelligent, say "The [N] pulls you into [his of N] lap, pinning your arms to your waist as [NameDesc of M] spreads your legs.";
	otherwise say "[BigNameDesc of M] grabs your leg and lifts it out of the way.".

To say TwosomePrep of (M - a monster) in (F - vagina):[in other words, sex.]
	say "[BigNameDesc of M] shoves you face down and pulls your hips up against [his of M] body. [big he of M] spreads your legs.".
...
To say VeryLooseVaginaPenetrationFlav of (M - a monster):[low bimbo: 1 mid: 3, high: 3]
	if the sex addiction of the player < 7:
		say "You sigh and roll your eyes as [he of M] slides [his of M] [DickDesc of M] into your [vagina], waiting silently as [he of M] smacks your [AssDesc] and gropes your [BreastDesc]. [BigNameDesc of M] brazenly smacks your [AssDesc] and gropes your [BreastDesc], obviously willing to let you do all the work.";
	otherwise if the sex addiction of the player < 12:
...
To say FriendlyVeryTightVaginaPenetrationFlav of (M - a monster):[low bimbo: 2, mid: 2, high: 1]
	...
	otherwise:
		say "You eagerly push back against [him of M] as [his of M] [DickDesc of M] slowly enters your [vagina], every inch more deliciously painful than the last as your inner walls desperately try to adjust to the huge invader. [BigNameDesc of M] can't help but let you know how much [he of M] loves it at every turn, beginning to thrust without bothering to get it all the way in.".

To say FriendlyLessTightVaginaPenetrationFlav of (M - a monster):[low bimbo: 3 mid: 2, high: 1]
	if the sex addiction of the player < 7:
		say "[one of]You angrily chide yourself as [his of M] [DickDesc of M] slowly enters your [vagina], fingers of pain licking their way through your belly as your inner walls strain desperately to stretch. [BigNameDesc of M] doesn't seem to react to your barely hidden groan of pain, [if M is intelligent]hissing[otherwise]grunting[end if] with pleasure as [he of M] slowly begins to thrust.[or]You tremble with shame as [he of M] slowly forces [his of M] [DickDesc of M] into your [vagina], which only barely stretches enough to accommodate him. [BigNameDesc of M] gives your [AssDesc] a slap, as if to remind you of everything about this you regret as [he of M] slowly begins to thrust.[or]You give [him of M] a fake smile over your shoulder as [his of M] [DickDesc of M] forces its way into your [vagina], realizing with a stifled grunt of pain precisely how much power you have if [he of M] doesn[']t want to listen to you, or if you don[']t want a creampie. None. Maybe [he of M] won[']t realize that?[at random]";
	otherwise if the sex addiction of the player < 12:
		say "[one of]You can[']t help a sigh of pleasure as [he of M] slowly forces [his of M] [DickDesc of M] into your [vagina], faking a grunt of pain just so [he of M] knows [he of M]'s a little too big. [BigNameDesc of M] chuckles, giving your [AssDesc] a firm swat as [he of M] slowly begins to thrust.[or]You bite your lip as [his of M] throbbing [if M is gladiator]'man'[otherwise]man[end if]hood enters your [vagina], only dimly realizing how much it hurts as your inner walls desperately stretch to accommodate him. [BigNameDesc of M] gives you a brief moment to get used to [him of M] before [he of M] begins to thrust.[at random]";
	otherwise:
		say "You already know he[']s a little too big, but that[']s why you want to fuck [him of M] so much! [BigNameDesc of M] tightens [his of M] grip on your waist as you [if the player is able to use manual dexterity]guide [his of M] throbbing hardness into your [vagina], emitting a throaty moan as your walls draw taut around [his of M] invading [DickDesc of M][otherwise]impale yourself on [his of M] throbbing hardness, emitting a throaty moan as your [vagina] desperately stretches to accommodate the invading [DickDesc of M][end if]. [BigNameDesc of M] immediately begins to thrust.".

To say FriendlyLessLooseVaginaPenetrationFlav of (M - a monster):[low bimbo: 2 mid: 2, high: 2]
	if the sex addiction of the player < 7:
		say "[one of]You scowl at the ground in front of you as [he of M] pushes [his of M] [DickDesc of M] into your [vagina], which easily stretches to accommodate [him of M]. [BigNameDesc of M] pauses for a moment to grope your [BreastDesc] before [he of M] begins to thrust, as if to remind you how dumb you are for actually letting [him of M] do it.[or]You give [him of M] a fake smile over your shoulder as [he of M] pushes [his of M] [DickDesc of M] into your [vagina], which [he of M] somehow mistakes for real enthusiasm. [BigNameDesc of M] starts out hard and fast, every thrust further shaming you for actually inviting [him of M] into this.[at random]";
	otherwise if the sex addiction of the player < 12:
		say "[one of]You look over your shoulder as [he of M] pushes [his of M] [DickDesc of M] into your [vagina], which is all too ready to accommodate [him of M]. [BigNameDesc of M] looks you in the eye as [his of M] hands explore your body, groping your [BreastDesc] and squeezing your [AssDesc] until you finally lose your patience and begin fucking yourself with [his of M] cock.[or]You ease yourself backward, onto [his of M] of [DickDesc of M], emitting a quiet moan when [he of M] suddenly tightens [his of M] grip on your waist and slams it the rest of the way into your [vagina]. [BigNameDesc of M] 'apologises' with an all-too-welcome slap on the ass and immediately begins to thrust.[at random]";
	otherwise:
		say "[one of]You [if there is a monster penetrating face]moan happily[otherwise]give [him of M] a hungry look over your shoulder[end if], wiggling your hips as [he of M] pushes every inch of [his of M] [DickDesc of M] into your eager [vagina]. [BigNameDesc of M] slaps your [AssDesc] and immediately begins to thrust.[or]You push back against [his of M] invading [DickDesc of M], moaning throatily as every inch sinks into your [vagina]. [BigNameDesc of M] gropes your [BreastDesc] as you begin to work your hips back and forth, eager to enjoy [him of M]self while you proudly do the work.[at random]".

To say FriendlyVeryLooseVaginaPenetrationFlav of (M - a monster):[low bimbo: 1 mid: 3, high: 3]
	if the sex addiction of the player < 7:
		say "You sigh and roll your eyes as [he of M] slides [his of M] [DickDesc of M] into your [vagina], mechanically beginning to fuck yourself on [his of M] throbbing hardness. [BigNameDesc of M] brazenly smacks your [AssDesc] and gropes your [BreastDesc], obviously willing to let you do all the work.";
	otherwise if the sex addiction of the player < 12:
...
To say sexSubmitFondleFlav of (M - a monster) in (O - an orifice):
	say "[BigNameDesc of M] takes the opportunity to reach underneath you and fondle your [BreastDesc] as [he of M] pistons [his of M] [DickDesc of M] in and out of your [variable O].".

To say sexSubmitPushFlav of (M - a monster) in (O - an orifice):
	say "[BigNameDesc of M] pushes you into the floor, leaning over so you can feel [his of M] breath on your back as [he of M] slams [his of M] [DickDesc of M] in and out of your [variable O].".

To say sexSubmitBiteFlav of (M - a monster) in (O - an orifice):
	say "[if the relevant sex addiction of M < 6][BigNameDesc of M] fucks your [variable O] with fast, hard thrusts. You screw your eyes shut and grit your teeth, focusing as hard as possible on when it will be over.[otherwise if the relevant sex addiction of M < 10][BigNameDesc of M] slams in and out of your [variable O], grunting heavily. You bite back a moan of pleasure.[otherwise][BigNameDesc of M] slams in and out of your [variable O], grunting heavily. You look over your shoulder and make a show of biting your lip.[end if]".
...
To say sexSubmitEmbarrassFlav of (M - a monster) in (O - an orifice):
	say "[if the relevant sex addiction of M < 7][BigNameDesc of M] gives your [variable O] the hard fucking it deserves. You clench your fists and try to ignore your growing embarrassment.[otherwise if the humiliation of the player < 15000][BigNameDesc of M] roughly fucks your [variable O], panting heavily. You can almost feel your dignity crumbling, every thrust humiliating you more and more.[otherwise if the relevant sex addiction of M < 10][BigNameDesc of M] plows [his of M] [DickDesc of M] in and out of your [variable O]. There's something so invigorating about letting [him of M] do it![otherwise][BigNameDesc of M] plows [his of M] [DickDesc of M] in and out of your [variable O]. It's so satisfying to degrade yourself like this![end if]".

To say sexSubmitSplitFlav of (M - a monster) in (O - an orifice):
	if the player is male, say "[if the size of penis < 4 and tg fetish >= 1][BigNameDesc of M] ruts you like an animal. At this point, there's not a lot separating you from a girl.[otherwise if the size of penis < 4 and the size of penis > 0 and the bimbo of the player < 14][BigNameDesc of M] pounds your [asshole] hard and fast. You can't help feeling a little embarrassed of how minuscule your [ShortDesc of penis] is compared to [his of M].[otherwise if the size of penis < 4 and the size of penis > 0][BigNameDesc of M] pounds your [asshole] hard and fast. You feel proud of how minuscule your [ShortDesc of penis] is compared to [his of M].[otherwise if the bimbo of the player < 3][BigNameDesc of M]'s balls repeatedly slap your taint as he pistons in and out of your [asshole],as if to remind you how little you've actually done to stop [him of M].[otherwise if the bimbo of the player < 5]Shocks of pleasure ripple through your [DickDesc of M] as [he of M] pounds your [asshole]. And you thought it was humiliating before...[otherwise if the bimbo of the player < 7][BigNameDesc of M]'s [DickDesc of M] relentlessly pounds your sensitive prostate, reminding you how humiliating it is to get fucked by another man.[otherwise if the bimbo of the player < 9]Shocks of pleasure ripple through your [ShortDesc of penis] as [he of M] pounds your [asshole]. It's difficult to resist when it feels this good.[otherwise if the bimbo of the player < 10][BigNameDesc of M]'s [DickDesc of M] relentlessly pounds your sensitive prostate, reminding you that you're a dirty faggot for enjoying this.[otherwise if the bimbo of the player < 12][BigNameDesc of M]'s balls repeatedly slap your taint as he pistons in and out of your [asshole], as if to remind you how much you secretly like this.[otherwise if the bimbo of the player < 14][BigNameDesc of M]'s balls repeatedly slap your taint as he pistons in and out of your [asshole], as if to remind you how much you LOVE getting fucked.[otherwise]Shocks of pleasure ripple through your [ShortDesc of penis] as [he of M] pounds your [asshole]. Phew, [he of M] sure knows how to show a girl a good time![end if]";
	otherwise say "[if the player is horny and the relevant sex addiction of M < 10][BigNameDesc of M] fucks your [variable O] hard and fast. After a few seconds [he of M] reaches between your legs, chuckling when [he of M] discovers just how wet you are.[otherwise if the player is horny][BigNameDesc of M] fucks your [asshole] hard and fast. After a few seconds [he of M] reaches between your legs, sinking a finger into your [vagina] when [he of M] realizes how wet you are.[otherwise if the openness of vagina > 3][BigNameDesc of M] reaches between your legs, sinking two fingers into your [vagina] as [he of M] slams in and out of your [asshole].[otherwise][BigNameDesc of M] reaches between your legs, gently rubbing your clit in small circles as [he of M] plows your [asshole].[end if]".
...
To say (M - a monster) rough sex (N - a number):
	let O be a random orifice penetrated by M;
	if N is 1:
		say "[if there is a worn ballgag and the bimbo of the player > 12][BigNameDesc of M] rams [his of M] [DickDesc of M] in and out of your [variable O]. You feel slightly annoyed that your [random worn ballgag] is muffling your moans.[otherwise if there is a worn ballgag and the bimbo of the player > 7][BigNameDesc of M] rams [his of M] [DickDesc of M] in and out of your [variable O]. You feel slightly relieved that your [random worn ballgag] muffles the sound of your moans.[otherwise if there is a worn ballgag][BigNameDesc of M] rams [his of M] [DickDesc of M] in and out of your [variable O]. Your grunts of displeasure are muffled by the lump of plastic in your mouth.[otherwise if the relevant sex addiction of M > 12][BigNameDesc of M] gives your [variable O] the hard fucking it deserves. You arch your back and shamelessly moan in pleasure.[otherwise if the relevant sex addiction of M > 7][BigNameDesc of M] gives your [variable O] the hard fucking it deserves. You arch your back and emit an involuntary moan of pleasure.[otherwise][BigNameDesc of M] gives your [variable O] the hard fucking it deserves, panting heavily. You try as hard as possible to show your displeasure.[end if]";
	if N is 2:
		let F be the openness of O - the girth of M;
		say "[if the F < 0 and the relevant sex addiction of M > 11][BigNameDesc of M] is roughly fucking your [variable O] and panting heavily. It's so exciting knowing [he of M] barely fits![otherwise if F < -2]The thickness of [NameDesc of M]'s [DickDesc of M] is VERY noticeable as [he of M] slams it in and out of your tight [variable O].[otherwise if F < 0][BigNameDesc of M] ruts you like an animal. Each of [his of M] thrusts reach nice and deep, as if to acclimate your tight [variable O] to the feeling of [DickDesc of M].[otherwise if F > 4][BigNameDesc of M] pounds your [variable O] mercilessly, but your [variable O] is so stretched that it doesn't feel rough at all.[otherwise if F > 2][BigNameDesc of M] fucks you hard and fast. However, your [variable O] is loose enough that it doesn[']t actually feel rough at all.[otherwise][BigNameDesc of M]'s thrusts come quickly, greedily seeking the inner reaches of your [variable O].[end if]";
	if N is 3:
		say "[if the thickness of hips > 6][BigNameDesc of M] plunges into your [variable O] at full force. Lewd claps ring through the air as [his of M] hips slam into your [HipDesc].[otherwise if the flesh volume of hips > 4][BigNameDesc of M] plows your [variable O] as if you were some kind of fuck toy! You can feel your [HipDesc] jiggling with each thrust.[otherwise][BigNameDesc of M] slams in and out of your [variable O], grunting heavily.[end if]";
	if N is 4:
		say "[if the largeness of breasts > 15 and the bimbo of the player > 11][BigNameDesc of M] explores your [BreastDesc] with [his of M] hands as [he of M] plows your [variable O]. You giggle. Of course, [he of M] knows you're much too heavy to get away.[otherwise if the largeness of breasts > 15][BigNameDesc of M] explores your [BreastDesc] with [his of M] hands as [he of M] plows your [variable O]. You sigh. Obviously [he of M] knows you're much too heavy to get away.[otherwise if the largeness of breasts > 12 and the number of worn bras is 0][BigNameDesc of M] roughly fucks your [variable O], causing your unrestrained [BreastDesc] to slap audibly against your chest.[otherwise if the largeness of breasts > 9][BigNameDesc of M] roughly fucks your [variable O], jostling your [BreastDesc] with the force of [his of M] thrusts.[otherwise if the largeness of breasts > 5][BigNameDesc of M] roughly fucks your [variable O] as your [BreastDesc] [BreastBounceDesc] with the force of [his of M] thrusts.[otherwise][BigNameDesc of M] pounds your [variable O] with fast, powerful strokes.";
	if N is 5:
		say "[if the relevant sex addiction of M > 12][BigNameDesc of M] slams [his of M] [DickDesc of M] in and out of your [variable O], panting heavily. You're enjoying it so much you can hardly think![otherwise if the relevant sex addiction of M > 7][BigNameDesc of M] fucks your [variable O] with fast, hard thrusts. You close your eyes and tilt your head to the ground, trying to ignore how good it feels.[otherwise][BigNameDesc of M] slams in and out of your [variable O], grunting heavily. You look over your shoulder and scowl in hopes of turning [him of M] off.[end if]";
	if N is 6:
		if the size of penis > 0 and the relevant sex addiction of M > 7 and there is worn knickers and the number of worn chastity cages is 0:
			...
			say "[if the size of penis < 3][BigNameDesc of M] plows your [asshole] without mercy. Your desperately hard [sissy-penis] not even tenting your [printed name of P].[otherwise if the armour of P - 3 < the size of penis][BigNameDesc of M] plows your [asshole] without mercy, your [ShortDesc of penis] hard and peeking out of your [printed name of P].[otherwise][BigNameDesc of M] plows your [asshole] without mercy, your [ShortDesc of penis] hard enough to visibly tent your [printed name of P].[end if]";
		otherwise if the size of penis > 2 and the relevant sex addiction of M > 7:
			say "[BigNameDesc of M] plows your [asshole] without mercy, your [ShortDesc of penis] slapping audibly against your [belly].";
		otherwise if the player is male:
			say "[if the bimbo of the player < 6 and the size of penis > 2][BigNameDesc of M] ruts you like an animal. You have a penis, but [he of M][']s still treating you just like a woman![otherwise if the size of penis > 2][BigNameDesc of M] rams [his of M] [DickDesc of M] in and out of your [asshole]. Your [ShortDesc of penis] jiggles around.[otherwise if the humiliation of the player < 22500][BigNameDesc of M] fucks your [asshole] hard and fast. There's something so humiliating about sex with another man![otherwise][BigNameDesc of M] fucks your [asshole] with fast, powerful thrusts. You can feel [his of M] [DickDesc of M] slamming into your sensitive prostate.[end if]";
		otherwise:[TODO: remove masturbation text here, since the player can actually masturbate during sex]
			say "[if the relevant sex addiction of M > 10 and there is a worn chastity cage][BigNameDesc of M] slams in and out of your [asshole]. You desperately want to play with yourself but you can't because of your stupid belt![otherwise if the relevant sex addiction of M > 6 and there is a worn chastity cage][BigNameDesc of M] slams in and out of your [asshole]. You can't help feeling ashamed that you would be playing with yourself if not for your chastity belt.[otherwise if the relevant sex addiction of M > 13 and vagina is not actually occupied][BigNameDesc of M] slams in and out of your [asshole], panting heavily. You eagerly finger yourself, determined to enjoy this as much as possible.[otherwise if the relevant sex addiction of M > 13][BigNameDesc of M] roughly fucks your [asshole] as you frantically diddle your clit. You want to enjoy yourself as much as you possibly can![otherwise if the relevant sex addiction of M > 9][BigNameDesc of M] roughly fucks your [asshole] as you play with your clit. You know you shouldn't, but it's like you just can't stop yourself![otherwise if the relevant sex addiction of M > 6][BigNameDesc of M] slams in and out of your [asshole], panting heavily. You want to touch yourself so badly, but you won't give [him of M] the satisfaction![otherwise][BigNameDesc of M] slams in and out of your [asshole], panting heavily. You know it would make it easier to take if you touched yourself as well, but you definitely won't give [him of M] or Nintendolls the satisfaction![end if]".
...
To say CondomFailFlav of (M - a monster) in (F - a fuckhole):
	say "The condom breaks as [NameDesc of M] ejaculates, and [semen] flows freely into your [variable F].";
...
To say PullOutFlav of (M - a monster) in (F - a fuckhole):
	say "[BigNameDesc of M] pulls out and sprays [semen] on the floor.".
...
To say MessyPullOutFlav of (M - a monster) in (F - a fuckhole):
	say "[BigNameDesc of M] pulls out and sprays your crotch with [semen]".
