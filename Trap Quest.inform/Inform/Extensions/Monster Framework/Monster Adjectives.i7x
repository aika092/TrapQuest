...
Definition: a monster (called M) is dungeon dwelling:
	decide no.
Definition: a monster (called M) is woods dwelling:
	decide no.
Definition: a monster (called M) is hotel dwelling:
	decide no.
Definition: a monster (called M) is mansion dwelling:
	decide no.
Definition: a monster (called M) is school dwelling:
	decide no.
...
Definition: a monster (called M) is willing to urinate:
	decide no.
...
Definition: a monster (called M) is nonexistant:
...
Definition: a monster (called M) is dark skinned:
	decide no.
