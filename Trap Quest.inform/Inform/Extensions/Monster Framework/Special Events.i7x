...
To say (M - a monster) submission sex (N - a number):[We care about friendly fucking here but not during rough sex.]
	...
	if N is 4:
		say "[if the relevant sex addiction of M < 6][BigNameDesc of M] fucks your [variable O] with fast, hard thrusts. You close your eyes and tilt your head to the ground, focusing as hard as possible on when it will be over.[otherwise if the relevant sex addiction of M < 10][BigNameDesc of M] slams in and out of your [variable O], grunting heavily. You bite back a moan of pleasure.[otherwise][BigNameDesc of M] slams in and out of your [variable O], grunting heavily. You look over your shoulder and make a show of biting your lip.[end if]";
	if N is 5:
