...
To decide which figure-name is the monster-image of (M - gymnast-explorer):
	if the explorer-bimbo of M >= 2, decide on Figure of rank 3 laci dry;
	if the explorer-bimbo of M is 1, decide on Figure of rank 2 laci;
	decide on Figure of rank 1 laci.
To say UniqueMonsterDesc of (M - gymnast-explorer):
	say "[big he of M] seems addicted to bending over at the waist and testing [his of M] balance - perhaps due to a curse. Anyway, this lets you see up [his of M] skirt and see that [he of M] is wearing a [if the explorer-bimbo of M is 0]pair of white panties[otherwise if the explorer-bimbo of M is 1]small purple diaper[otherwise]massive white diaper and pink pacifier[end if].".
