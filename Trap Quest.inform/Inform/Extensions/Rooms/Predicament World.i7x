...
To compute non-lewd worsened perception reaction of (M - female-sunbather-bystander):
	say "[BigNameDesc of M] hums with approval.[line break][first custom style]'You flaunt what you got, [brother of the player]! Ain't no shame in that!'[roman type][line break]".
...
To compute non-lewd perception reaction of (M - partygirl-bystander):
	say "[line break][first custom style]'Ugh, [if the saved appearance of the player < 3]I'm never drinking again[otherwise]you and me both, [brother of the player][end if]...'[roman type][line break]".
