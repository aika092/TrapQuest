...
The printed name of sissy bow is usually "[TQlink of item described][clothing-title-before]sissy bow[clothing-title-after][TQxlink of item described][verb-desc of item described]". 
...
To decide which number is the initial outrage of (C - a sissy bow):
	if diaper quest is 1, decide on 0;
	decide on 3.

Definition: a thing (called T) is bow themed:
	decide no.

Definition: a sissy bow (called C) is bow themed:
	decide yes.
...
To decide which number is the initial cringe of (C - a sissy bow):
	decide on 3.

Definition: a pink sissy bow (called C) is untransformable:
...
Definition: a pink sissy bow is untransformable:
	if diaper quest is 1, decide no;
	decide yes.

To decide which object is the potential-upgrade-target of (C - a pink sissy bow):
	decide on a random off-stage baby sissy bow.
...
To decide which number is the initial cringe of (C - a baby sissy bow):
	decide on 6.
