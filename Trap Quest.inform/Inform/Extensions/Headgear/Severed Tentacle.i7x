...
The printed name of severed-tentacle is "[clothing-title-before][if there is a worn severed-tentacle]The Master[otherwise]severed tentacle[end if][clothing-title-after]". The text-shortcut of severed-tentacle is "sev".
...
Check taking off severed-tentacle:
	...
	otherwise if the tentInt of severed-tentacle + a random number between 1 and 5 > the intelligence of the player + a random number between 1 and 5:
