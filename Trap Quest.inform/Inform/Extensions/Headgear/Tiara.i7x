...
To compute SelfExamineDesc of (H - a metal tiara):
	say "You are wearing a[if the bimbo of the player > 11]n[second custom style] absolutely gorgeous and shiny[roman type][end if] metal [ShortDesc of H] on top of your [ShortDesc of hair]. ".
...
To compute class outfit of (H - a tiara):
	...
	if the headgear chance of H < the threshold of H and (R is actually summonable or (R is royal dress and tiara-summoned is 0)):
