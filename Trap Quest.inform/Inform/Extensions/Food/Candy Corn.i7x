...
A candy corn is a kind of candy.  The printed name of candy corn is "[TQlink of item described]pack of candy corn[shortcut-desc][TQxlink of item described][verb-desc of item described]".  The printed plural name of chocolate bar is "[TQlink of item described]packs of candy corn[shortcut-desc][TQxlink of item described][verb-desc of item described]".  The text-shortcut of candy corn is "crn".  The description of candy corn is "A translucent packet of white, orange and yellow candies.".  There are 1 candy corn.
...
Carry out TQeating candy corn:
	...
	otherwise:
		...
		otherwise if the make-up of face < 3:
			say "a tingle passes over your cheeks, leaving them covered in a new layer of makeup. [one of][variable custom style]Why do I feel like a jack-o-lantern?[roman type][line break][or][stopping]";
			FaceUp 1;
