...
To compute furniture resting on (F - a guest bed):
	...
	[now song is 0]
	if M is a monster:
		say "The [M] sings smoothly as you pull up the covers, sliding off the bed as drowsiness takes a surprisingly quick hold on your body. Your arms go limp and droop off the side of the bed as the woman sways around the room, your chest rising and falling with the lilting timbre of her voice. Hints of arousal creep into her tone as she gently lifts your arm back onto the bed and firmly tucks you in.";
		now F is tended;
...
To say RestingDesc of (F - a guest bed):
	let M be a random clairvoyant acolyte in the location of the player;
	let N be the song of F;
	say "[line break]";
	if N < 4:
		say "You [one of][or]continue to [stopping]rest on the comfortable mattress[if M is monster]. The [M] [one of]twists her nipples[or]strokes her clit[or]fondles herself[or]paws at herself[or]fondles you through the covers[or][at random][one of] as she whispers incomprehensible lyrics into your ear.[or] as she moans her song into your ear.[or] as she croons lecherously.[at random][otherwise].[end if][line break]";
	otherwise if N < 7:
