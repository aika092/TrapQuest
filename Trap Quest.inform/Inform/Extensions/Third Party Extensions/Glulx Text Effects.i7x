Version 4 of Glulx Text Effects (for Glulx only) by Third Party Extensions begins here.
...
Example: * The Gallic War - An excuse to print a large, fancily-formatted bit of text using custom styles.
	...
	Include Glulx Text Effects by Third Party Extensions. Include Basic Screen Effects by Third Party Extensions.
