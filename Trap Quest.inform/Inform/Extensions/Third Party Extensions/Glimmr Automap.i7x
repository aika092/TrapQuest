Version 2/101030 of Glimmr Automap (for Glulx only) by Third Party Extensions begins here.
...
Section - Default tileset (for use with Glimmr Automap Tileset by Third Party Extensions)
...
Chapter - Deciding (in place of Chapter - Hacking Automap in Glimmr Automap by Third Party Extensions)
...
Chapter - Popup room labels (for use with Glimmr Bitmap Font by Third Party Extensions)
...
[Section - Optional undo control (for use with Undo Output Control by Third Party Extensions)
...
The extension requires most of the other Glimmr extensions in order to function, including Glimmr Canvas-Based Drawing, Glimmr Drawing Commands, and Glimmr Graphic Hyperlinks. Also required are Glimmr's dependencies, including Flexible Windows by Third Party Extensions and Fixed Point Maths by Third Party Extensions.
...
Glimmr Automap should be included before any font or tileset extensions, e.g.:
	...
	Include Glimmr Automap by Third Party Extensions.
	Include Glimmr Automap Tileset by Third Party Extensions.
...
Glimmr Automap has the MAP command open and close the graphical map window. If you prefer that the MAP command toggle the ASCII/Unicode/Font3 version of the map rather than remove the map window entirely, you can paste the following into your story file:
	...
	*: Chapter - Toggling text map view (in place of Chapter - Hacking Automap in Glimmr Automap by Third Party Extensions)
...
Add the line "Include Glimmr Bitmap Font by Third Party Extensions" after the Glimmr Automap inclusions to activate the query functionality.
