Version 5 of Fixed Point Maths (for Glulx only) by Third Party Extensions begins here.
...
Thanks to Third Party Extensions and Mike Tarbert for their helpful comments that have helped to improve this extension.  Any errors and omissions remain with the author.
...
Example: * The Classroom - Shows the use of the sine function
	...
	*: "The Classroom" by Third Party Extensions

	Include Fixed Point Maths by Third Party Extensions.
...
Example: *** Ballistics - Shows the use of real numbers in ballistic calculations
	...
	*: "Ballistics" by Third Party Extensions
