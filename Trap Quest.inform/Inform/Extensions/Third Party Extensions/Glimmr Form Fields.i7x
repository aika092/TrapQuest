Version 1/101201 of Glimmr Form Fields (for Glulx only) by Third Party Extensions begins here.
...
Include Glulx Input Loops by Third Party Extensions.
...
Chapter - Defining the window for char input (for use without Text Window Input-Output Control by Third Party Extensions)
...
Glimmr Form Fields must be included before any font extension, e.g.:
	...
	Include Glimmr Form Fields by Third Party Extensions.
...
You may prefer to do a release build and run this in a standalone interpreter for better performance. If you choose not to release to a standalone file, you may need to type slowly into the fields.
	...
	*: "Color Picker" by Third Party Extensions
	
	Include Glimmr Form Fields by Third Party Extensions.
	Include Glimmr Image Font by Third Party Extensions.
	Include Extended Debugging by Third Party Extensions.
