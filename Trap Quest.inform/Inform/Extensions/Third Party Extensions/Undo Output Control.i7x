Version 3/110717 of Undo Output Control by Third Party Extensions begins here.
...
Section - Patches and Undo Suspension (for use without Conditional Undo by Third Party Extensions)
...
Section - Patches (for use with Conditional Undo by Third Party Extensions)
...
Undo Output Control is compatible with Conditional Undo by Third Party Extensions, which provides a more flexible framework for undo prevention. Using the extension with Conditional Undo does change some aspects of usage; see below.
