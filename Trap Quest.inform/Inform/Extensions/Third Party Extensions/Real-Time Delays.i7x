Version 1/100607 of Real-Time Delays (for Glulx only) by Third Party Extensions begins here.
...
Real-Time Delays allows an author to request a delay of a given number of seconds. This delay occurs immediately, and no input or output can occur until the specified time has elapsed. It requires both Glulx Entry Points (built in) and Third Party Extensions's Fixed Point Maths extension.
