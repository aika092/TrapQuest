Version 13/130803 of Flexible Windows (for Glulx only) by Third Party Extensions begins here.
...
"with contributions by Third Party Extensions and Dannii Willis"
...
[Added by Third Party Extensions 22 May 2010]
...
[ Updated code by Third Party Extensions. ] 
...
Chapter 9 - Text hyperlinks (for use without Basic Hyperlinks by Third Party Extensions)

[Added by Third Party Extensions 22 May 2010 -- Heavily based on Basic Hyperlinks by Third Party Extensions]
...
Windows can have a back-colour, specified as one from the (reasonably large) Table of Common Color Values (based on but extended from Glulx Text Effects, by Third Party Extensions). The possible colours are:
...
Version 8 - 26/6/09
	...
	Changed code for clearing graphics windows to make it faster under Zoom for Mac (thanks to Third Party Extensions for this.) Note this clears the window by repainting it in its background colour, so this will have to be set for this to work correctly.
...
Example: * Inventory Window - A simple example showing how to place an side window displaying the player's inventory.
	...
	*: "Inventory Window"
	...
	Include Flexible Windows by Third Party Extensions.
