Version 1/130803 of Ultra Undo (for Glulx only) by Third Party Extensions begins here.
...
Chapter (for use without Undo Output Control by Third Party Extensions) unindexed

Save undo state is a truth state that varies. Save undo state is usually true.

Chapter (for use with Undo Output Control by Third Party Extensions)

Section - Undo save control (in place of Section - Undo save control in Undo Output Control by Third Party Extensions)
...
This extension is compatible with Conditional Undo by Third Party Extensions and Undo Output Control by Third Party Extensions.
