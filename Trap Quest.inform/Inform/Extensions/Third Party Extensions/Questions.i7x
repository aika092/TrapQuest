Version 4 of Questions by Third Party Extensions begins here.
...
Chapter 7 - Real number question mode (for use with Fixed Point Maths by Third Party Extensions)
...
Section 1 - Basic decision (for use without Fixed Point Maths by Third Party Extensions)
...
Section 2 - Extended decision (for use with Fixed Point Maths by Third Party Extensions)
...
Many thanks are due to Third Party Extensions for suggesting the changes implemented in version 2.

Version 3

The variable "current menu" has been changed to "current question menu" to avoid a namespace clash with Third Party Extensions's Menu extension.
...
- Questions that require a real number answer.  For use in conjunction with the Fixed Point Maths extension by Third Party Extensions.
...
Example: * Open Sesame - A short example to show the question rules with an initial open text question followed by an interview section to gather information about the player.
	...
	*: "Open Sesame" by Third Party Extensions
	...
	A text question rule (this is the open sesame rule):
		if introduction is happening:
			if the current answer is "Third Party Extensions":
	...
	Test me with "x boulder / push boulder/ say Third Party Extensions / e / d / Peter / 34 / M / 3 / Y".

Example: * Quiz Night - A short example to show creating a multiple choice quiz.

	*: "Quiz Night" by Third Party Extensions
