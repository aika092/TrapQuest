Version 2/101030 of Inline Hyperlinks (for Glulx only) by Third Party Extensions begins here.

"Provides a simple, HTML-inspired syntax for adding hyperlinks within say phrases. No manual management of hyperlinks required. Requires Text Capture by Third Party Extensions. Works seamlessly with, but does not require, Flexible Windows."

Chapter 0 - Inclusions

Include Glulx Entry Points by Third Party Extensions.
Include Text Capture by Third Party Extensions.

Chapter 1 - Basic hyperlink control (for use without Flexible Windows by Third Party Extensions)
...
Chapter 2 - Replace Flexible Windows hyperlink handling if necessary (for use with Flexible Windows by Third Party Extensions)

Section - Code for placing links (replaces Section - Placing hyperlinks in  Flexible Windows by Third Party Extensions)
...
Section - Code for selecting the replacement command (replaces Section - Selecting the replacement command in Flexible Windows by Third Party Extensions)
...
Section - Previewing the hyperlink list (for use without Extended Debugging by Third Party Extensions)
...
Chapter 3b - Debugging (for use with Extended Debugging by Third Party Extensions)
