Version 1/100805 of Glimmr Graphic Hyperlinks (for Glulx only) by Third Party Extensions begins here.
...
Part 3a - Clicking Graphlink Rules II (for use without Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Chapter - Debugging niceties (for use without Glimmr Drawing Commands by Third Party Extensions)
...
Part 3b - Clicking Graphlink Rules II (for use with Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Part 4a - Graphlink processing rules (for use without Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Part 4b - Graphlink processing rules (for use with Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Part 6a - Link Management (for use without Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Part 6b - Link Management (for use with Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Chapter 7.2a - Report window coordinates (for use without Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Chapter 7.2a - Report window and canvas coordinates (for use with Glimmr Canvas-Based Drawing by Third Party Extensions)
