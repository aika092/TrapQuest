Version 1/100805 of Glimmr Simple Graphics Window (for Glulx only) by Third Party Extensions begins here.
...
Section - Canvas (for use with Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Section - Current window (for use with Glimmr Drawing Commands by Third Party Extensions)

The current graphics window is the graphics-window.


Section - Very basic drawing rule (for use without Glimmr Canvas-Based Drawing by Third Party Extensions)
...
Section - Enable graphic hyperlinks (for use with Glimmr Graphic Hyperlinks by Third Party Extensions)

The graphics-window is g-graphlinked.


Chapter - Debugging niceties (for use without Glimmr Canvas-Based Drawing by Third Party Extensions)

[We only define the phrases in the following section if *both* GCBD and GDC are not included.]

Section - Debugging niceties (for use without Glimmr Drawing Commands by Third Party Extensions)
