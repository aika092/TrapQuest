...
To say TakeMyPenisVirginity of (M - a monster):
	...
	otherwise:
		...
		otherwise if the size of penis > 7:
			say "[variable custom style]'I think its about time I lost my virginity. How do you fancy being the first one to take a ride on this monster?'";
		otherwise:
