...
Check giving:
	...
	otherwise if the second noun is witch:[TODO: compute WitchGiving (T - a thing) to (M- a witch)]
		...
		if the noun is vessel:
			...
			otherwise:
				say "After [he of the second noun][']s finished, [he of the second noun] frowns.[line break][speech style of the second noun]'[one of]This is pretty bland, you know. I bet you just [if the fill-colour of the noun is golden]pissed directly into this cup[otherwise]used your own bodily fluids[end if], didn't you? This only gets you 1 use of the altar. Sorry but really I want something actually interesting, something that took some kinky act for you to collect. Go find someone else's cum [if watersports fetish is 1]or piss [end if]and then I'll properly reward you. Or at the very least, at least use a squirt dildo to stew this in your butthole for a bit first, that might add a little flavour.'[or]Boring and bland again. Only worth 1 use of the altar, I'm afraid.'[stopping][roman type][line break]";
				AltarUsesUp 1;
