...
To say WaitingActionFlav of (M - a monster):
	...
	otherwise:
		say "You stay still and wait to see [if M is willing to shag]how the [ShortDesc of M] will [one of]play with[or]fuck[or]use[or]dominate[as decreasingly likely outcomes] you[otherwise][one of]what the [ShortDesc of M] plans to do with you[or]how the [M] punishes you[in random order][end if].".
