...
To say DQwaitingflav of (M - a monster):
	if M is intelligent:
		...
		otherwise:
			say "[if the sex addiction of the player > 14 and the player is able to speak and the player is a bit horny][variable custom style]'[one of]Are you going to help me get my cummies?'[or]Please help me cum!'[or]I've been a good baby, will you please let me cum?'[at random][roman type][line break][otherwise if the diaper addiction of the player > 14 and there is a worn messed knickers and the player is able to speak][variable custom style]'[one of]I hope you're going to change me!'[or]I need a change, are you going to help me?'[at random][roman type][otherwise if the diaper addiction of the player > 14 and the player is diapered and the player is able to speak][variable custom style]'[one of]Do what you want with me.'[or]Go ahead, do what you like.'[at random][roman type][line break][otherwise if the player is able to speak and the diaper addiction of the player > 14][variable custom style]'[one of]I need a new nappy, can you help?'[or]I've been a naughty baby and lost my nappy, can you change me?'[or]If you're going to put a diaper on me, make sure it's a big puffy one!'[at random][roman type][line break][otherwise if the delicateness of the player < 6 and M is female and the player is able to speak and the player is not horny and the sex addiction of the player < 12][variable custom style]'Do your worst, [bitch].'[roman type][line break][otherwise if the delicateness of the player < 6 and the player is able to speak and the player is not horny and the sex addiction of the player < 12][variable custom style]'[one of]Do your worst.'[or]I'm not scared of you.  Let's see what you've got.'[or]Go on, get it over with.  I can take it.'[at random][roman type][line break][otherwise if the delicateness of the player < 12 and the player is able to speak and the sex addiction of the player < 12][variable custom style]'[one of]I'm not going to let you make me cry!'[or]Go on then, I can take it.  I think.'[or]Please don't be too cruel.'[at random][roman type][line break][otherwise]You wait to see what the [M] has in mind.[end if]";
	otherwise:
...
To say waitingflav of (M - a monster):
	if M is intelligent, say "[if (the sex addiction of the player > 15 or the bimbo of the player > 15) and the player is able to speak and M is willing to shag][variable custom style]'[one of]You choose, hun!  I'm down for whatever.'[or]Use any or all of my holes.  Ruin me!'[or]Be my guest.  I'm your little fucktoy.'[or]I'm yours to use how you please.'[or]Please relieve yourself with my body as you see fit.'[or]I am free for your use, however you want me.'[or]Come on then, climb aboard!'[or]I don't give a damn how you fuck me, just get started already!'[or]Please touch me.  Fuck me.  Do anything you want, sugar!'[at random][roman type][line break][otherwise if (the sex addiction of the player > 15 or the bimbo of the player > 15) and the player is able to speak][variable custom style]'[one of]Do what you want with me.'[or]Go ahead, do what you like, honey.'[at random][roman type][line break][otherwise if the player is able to speak and the player is very horny and M is willing to shag][variable custom style]'[one of]Please fuck me, I need to cum.'[or]Do me wherever, I'm too horny to care...'[or]Go on, get it over with.'[at random][roman type][line break][otherwise if the delicateness of the player < 6 and M is female and the player is able to speak and the player is not horny and the sex addiction of the player < 12][variable custom style]'Do your worst, [bitch].'[roman type][line break][otherwise if the delicateness of the player < 6 and M is male and the player is able to speak and the player is not horny and the sex addiction of the player < 12][variable custom style]'[one of]Do your worst.'[or]I'm not scared of you.  Let's see what you've got.'[or]Go on, get it over with.  I can take it.'[at random][roman type][line break][otherwise if the delicateness of the player < 12 and the player is able to speak and the sex addiction of the player < 12][variable custom style]'[one of]I'm not going to let you make me cry!'[or]Go on then, I can take it.  I think.'[or]Please don't be too cruel.'[at random][roman type][line break][otherwise]You wait to see what the [M] has in mind.[end if]";
