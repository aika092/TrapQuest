...
+!]
Check begging:
	if the mercyskill of the player is 0 and the class of the player is not cheerleader and the class of the player is not sissy, say "You don't know this ability.  Try [bold type]submit[roman type]ting for now." instead;
