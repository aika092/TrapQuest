...
To say PlayerFantasy: [paired with "fantasizing about [X]." syntax, so no punctuation, and preferably, not super long. Relies on bimbo rather than sex addiction. In random order is used here to cut down on repetitiveness. If you find punctuation at the end of clauses in here, it's wrong and needs to be fixed.]
	...
	otherwise:[even more degradation from strangers]
		say "[one of]getting gangbanged in the alleyway behind your favourite bar[or][if the player is male and bukkake fetish is 1]life as a pornographic actress specializing in mass bukkake[otherwise if the player is originally female]using all that time you wasted in business school to further your career as the only pornographic actress that always works for free[otherwise]life as a pornographic actress specializing in gangbangs[end if][or]waking up bound, naked, and surrounded by a gang of complete strangers with big hard [manly-penis]s[or]giving a wet, sloppy blowjob to every man that passes you in the street[or]play-testing even more [line break][second custom style]fun[roman type][line break] games for Nintendolls[in random order]".
...
Carry out masturbating:
	...
	if asswank is 1 and auto is 0:
		repeat with O running through insertable objects held by the player:
...
To say InstantMasturbationFlav of (O - an object) in (C - an object):[We're only doing an introduction here, the rest is handled by the climaxmasturbationflav function; sex addiction here should be raw sex addiction]
	...
	if the player is male:
		...
		if R is 1:
			say "You [if O is vibe-wand]turn on the [ShortDesc of O] and grind your [ShortDesc of penis] against it[otherwise if C is clothing]stroke your [ShortDesc of penis] through your [ShortDesc of C][otherwise]eagerly begin to stroke your [ShortDesc of penis][end if], [if M is a thing]focusing all your thoughts on [NameDesc of M][otherwise]fantasizing about [PlayerFantasy][end if]. [if A < 5]It's almost embarrassing how much it turns you on[otherwise if A < 10]It's a little surprising how much it turns you on[otherwise]It makes you uncontrollably turned on[end if], as the pleasure rapidly builds upon itself, you realize you're already about to cum.";
		otherwise if R is 2:
			say "You [if O is vibe-wand]turn on the [ShortDesc of O] and[end if] begin to rub your [ShortDesc of penis] [if C is clothing]through your [ShortDesc of C][end if], closing your eyes as you [if M is a thing]focus on [NameDesc of M][otherwise]fantasize about [PlayerFantasy][end if]. Nothing more than a moment passes, [if A < 5]and you are immediately ashamed to[otherwise if A < 10]and you tell yourself you should be ashamed to[otherwise]and you feel your muscles tightening in anticipation as you[end if] realize that you're already going to cum.";
		otherwise if R is 3:
...
To say InstantAnalMasturbationFlav of (O - an object) in (C - an object):
	...
	let R be a random number between 1 and 3;
	if R is 1:
		say "You [if O is insertable object]ease the [printed name of O] into your [asshole][otherwise]ease your fingers into your [asshole][end if], [if A < 5]cheeks burning with shame[otherwise if A < 10]panting with excitement[otherwise]cooing with unabashed excitement[end if] as you begin to fuck yourself to the thought of [PlayerFantasy]. Nothing more than a moment passes, [if A < 5]and you are immediately ashamed to[otherwise if A < 10]and you tell yourself you should be ashamed to[otherwise]and you feel your muscles tightening in anticipation as you[end if] realize that you're about to cum.";
	otherwise if R is 2:
