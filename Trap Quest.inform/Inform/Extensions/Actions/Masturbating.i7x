...
+!]
To say PlayerFantasy: [paired with "fantasising about [X]." syntax, so no punctuation, and preferably, not super long. Relies on bimbo rather than sex addiction. In random order is used here to cut down on repetitiveness. If you find punctuation at the end of clauses in here, it's wrong and needs to be fixed.]
	...
	otherwise if the bimbo of the player < 8 and the player is male:[Being dominated by women, or the player isn't dominated but there's emphasis on penises]
		say "[one of]sexy women getting fucked by long, hard cocks[or]being pinned underneath a strongly muscled [if futanari fetish is 1]futa[otherwise]woman[end if] as she plows you with her big hard [if futanari fetish is 0]strap-on[otherwise]cock[end if][or]having a threesome with a girl and her strong, muscular boyfriend[or]serving a gorgeous woman as she locks you into chastity[in random order]";
	otherwise if the bimbo of the player < 8:[being dominated by women, men taking passive/equal role]
		say "[one of]the slutty sisters and their sexy choice of clothes[or]being stripped nude by a tall, strap-on-wearing woman and roughly impaled on her plastic cock[or]joining in after walking in on your room-mate and her boyfriend having sex[or]getting in bed with the cute guy from the accounting division[or]being held down by a tall, shirtless man as the slutty sisters take turns pounding you with strap-on dildos[in random order]";
