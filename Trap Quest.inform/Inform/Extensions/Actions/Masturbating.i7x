...
To say PlayerFantasy:
	...
	otherwise if the bimbo of the player < 12 and the player is gendered male:[submitting to women and men at the same time. Submitting to men because of women.]
		say "[one of]making out with your ex-girlfriend after [if bukkake fetish is 1]her boyfriend unloads on your face[otherwise if watersports fetish is 1]her boyfriend pisses on your face[otherwise]swallowing her boyfriend's load[end if][or]eating out your ex-girlfriend right after her boyfriend finishes giving her a massive creampie[or]waking up naked in a sorority house with [if bukkake fetish is 1][semen] all over your face[otherwise if artificial enhancements fetish is 1]lipstick tattooed on your face[otherwise]a huge plug in your ass[end if] and a cowbell around your neck[or]sucking off your college room-mate until he comes[in random order]";
	...
	otherwise if the bimbo of the player < 15:[degradation from strangers]
		say "[one of]getting fucked until [if the player is possessing a vagina and pregnancy fetish is 1]you're pregnant[otherwise]you can't walk[end if][or]being pinned down and fucked by muscular men with big hard [manly-penis]s[or]being blindfolded, bound, and stuffed full of dildos[or][if the player is gendered female]arriving at an important meeting and immediately getting slammed on the table and fucked by the majority shareholder[otherwise]making money on porno sets as a cock warmer between scenes[end if][or][if bukkake fetish is 1 and a random number between 1 and 2 is 1]the feeling of thick, warm [semen] rolling down your face[otherwise if watersports fetish is 1 and a random number between 1 and 2 is 1]the feeling of warm, frothy [urine] streaming into your mouth[otherwise if the raw semen taste addiction of the player > 10]the feeling of thick, warm [semen] spurting into your mouth and rolling down your throat[otherwise]the feeling of a warm, hard [manly-penis] in your mouth[end if][in random order]";
	otherwise:[even more degradation from strangers]
		say "[one of]getting gangbanged in the alleyway behind your favourite bar[or][if the player is gendered female]using all that time you wasted in business school to further your career as porn actress[otherwise]becoming a pornographic actress[end if][or]waking up bound, naked, and surrounded by a gang of complete strangers with big hard [manly-penis]s[or]giving a wet, sloppy blowjob to every man that passes you in the street[or]play-testing even more [i]fun[/i] games for Nintendolls[in random order]".
...
To say InstantMasturbationFlav of (O - an object) with (M - a thing) in (C - an object):[We're only doing an introduction here, the rest is handled by the climaxmasturbationflav function; sex addiction here should be raw sex addiction]
	...
	if the player is male:
		...
		if R is 1:
			say "You [if O is vibe-wand]turn on the [ShortDesc of O] and grind your [ShortDesc of penis] against it[otherwise if C is clothing]stroke your [ShortDesc of penis] through your [ShortDesc of C][otherwise]eagerly begin to stroke your [ShortDesc of penis][end if], [if M is a live thing]focusing all your thoughts on [NameDesc of M][otherwise]fantasizing about [PlayerFantasy][end if]. [if A < 5]It's almost embarrassing how much it turns you on[otherwise if A < 10]It's a little surprising how much it turns you on[otherwise]It makes you uncontrollably turned on[end if], and as the pleasure rapidly builds upon itself, you realize you're already about to cum.";
		otherwise if R is 2:
			say "You [if O is vibe-wand]turn on the [ShortDesc of O] and[end if] begin to rub your [ShortDesc of penis] [if C is clothing]through your [ShortDesc of C][end if], closing your eyes as you [if M is a live thing]focus on [NameDesc of M][otherwise]fantasize about [PlayerFantasy][end if]. Nothing more than a moment passes, [if A < 5]and you are immediately ashamed to[otherwise if A < 10]and you tell yourself you should be ashamed to[otherwise]and you feel your muscles tightening in anticipation as you[end if] realize that you're already going to cum.";
		otherwise if R is 3:
