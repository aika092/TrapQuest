...
Check mopping:
	...
	otherwise if debugmode is 0 and the noun is face and the urine-puddle of the location of the player > 0 and the class of the player is not maid and the class of the player is not catgirl:
		if the urine taste addiction of the player < 5 and the player is not broken and the player is not extremely thirsty, say "[if the urine taste addiction of the player > 2][variable custom style]I'd have to be thirstier than this before I'd consider doing that...[roman type][line break][otherwise]You can't bring yourself to do something so disgusting.[end if]" instead;
