...
Check TQeating something:
	...
	if the latex-transformation of the player > 4, say "You are no longer able to eat things.[one of] Though maybe there could be some rare circumstance later where some rare, small object might go down?[or] Though there might be some special exceptions.[or] Unless the pink pill might one day fit inside it again, if your mouth opened up a bit wider?[or][or][or][or][at random]" instead;
