...
To say blush (H - a number):
	...
	if H < 100: [we use this for small amounts of humiliation, that haven't been scaled down]
		...
		say "[if the player is broken][one of]feel nothing[or]don't react[or]feel ambivalent[or]feel bored[in random order][otherwise if the player is not disgraced and H < 50][one of]feel your cheeks warm[or]purse your lips[or]blush a little[or]frown slightly[or]clench a fist[in random order][otherwise if the player is not disgraced][one of]blush profusely[or]feel your lips wobble[or]cringe slightly[or]feel shy[in random order][otherwise][one of]pout playfully[or]wrinkle your nose[or]giggle shyly[or]chuckle nervously[in random order][end if]";
	otherwise:
