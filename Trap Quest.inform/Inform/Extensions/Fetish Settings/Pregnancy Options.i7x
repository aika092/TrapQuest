...
title	subtable	description	toggle
"Pregnancy should be a slow and arduous process like in real life. (+2 points)"	--	--	slow pregnancy lover rule
"The faster my baby grows, the more different pregnancies I can have!"	--	--	fast pregnancy lover rule
"Pregnancies should become full term immediately through magic! (-1 point)"	--	--	superfast pregnancy lover rule
"Pregnancies should always take a long time to be born, but it's fine if they sometimes become full term immediately! (+1 point)"	--	--	superslow pregnancy lover rule
