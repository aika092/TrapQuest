...
This is the christmas content toggle rule:
	...
	if the choice in row 65 of the Table of Player Options < 6, now the choice in row 65 of the Table of Player Options is 6; [this disables it]
	otherwise now the choice in row 65 of the Table of Player Options is 5. [this enables it]
...
This is the halloween content toggle rule:
	if the player is a top donator:
		if the choice in row 80 of the Table of Player Options < 6, now the choice in row 80 of the Table of Player Options is 6; [this disables it]
		otherwise now the choice in row 80 of the Table of Player Options is 5. [this enables it]
