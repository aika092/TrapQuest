...
This is the april fools content toggle rule:
	if the choice in row 67 of the Table of Player Options is 0, now the choice in row 67 of the Table of Player Options is 1;
	otherwise now the choice in row 67 of the Table of Player Options is 0.

This is the halloween content toggle rule:
	if the choice in row 80 of the Table of Player Options is 0, now the choice in row 80 of the Table of Player Options is 1;
	otherwise now the choice in row 80 of the Table of Player Options is 0.
