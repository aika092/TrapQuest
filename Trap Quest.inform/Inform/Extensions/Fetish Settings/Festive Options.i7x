...
This is the christmas content toggle rule:
	...
	if the choice in row 65 of the Table of Player Options < 10, now the choice in row 65 of the Table of Player Options is 10; [this disables it (christmas release reversal)]
	otherwise now the choice in row 65 of the Table of Player Options is 0. [this enables it (christmas release reversal)]
...
To decide which number is christmas content:
	...
	if choice in row 65 of the Table of Player Options < 10, decide on 1; [(christmas release reversal)]
	decide on 0.
