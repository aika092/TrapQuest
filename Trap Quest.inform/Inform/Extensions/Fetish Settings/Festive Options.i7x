...
This is the christmas content toggle rule:
	...
	if the choice in row 65 of the Table of Player Options < 8, now the choice in row 65 of the Table of Player Options is 8; [this usually enables it but currently disables it]
