...
"Secret: You secretly find humiliation kind of exhilarating (up to +10 magic power depending on your (lack of) decency) - [next-secret-cost + humiliation-fetish] points ([if humiliation-fetish is 0]not [otherwise][bold type][end if]chosen[roman type])"	--	--	 humiliation fetish toggle rule
