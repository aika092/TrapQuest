...
"Futanari Content (Can female NPCs have penises? If disabled they'll have strap-ons instead) - [if lady fetish is 2]disabled, since all NPC's are masculine[otherwise if futanari fetish is 1][bold type]enabled[roman type][otherwise]disabled[end if]"	--	--	futanari fetish toggle rule
