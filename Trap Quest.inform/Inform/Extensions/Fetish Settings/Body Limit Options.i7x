...
"Futanari Content (Can female NPCs have penises? If disabled they'll have strapons instead) - [if futanari fetish is 1][bold type]enabled[roman type][otherwise]disabled[end if]"	--	--	futanari fetish toggle rule
