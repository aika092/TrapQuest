...
Check entering podium:
	...
	if the player is a december 2020 top donator and the class of the player is bride and bride-consort is an alive undefeated monster:
		if there is a worn bridal dress or sheer-open-front-skirt is worn:
			...
			say "[speech style of bride-consort]'I must go spread the news of our joy with the others! It will be our wedding night. You know what that means, right? I will be making a woman of you.'[roman type][line break][big he of bride-consort] points to your [vagina].[line break][speech style of bride-consort]'Meet me in the Karma Sutra Penthouse Suite.'[roman type][line break]Before you can reply, [he of bride-consort] has left.";
	...
	otherwise if the player is a december 2020 top donator and floral bridal veil is off-stage and the player is female and the vaginalvirgin of the player is 1 and floral bridal veil is actually summonable:
