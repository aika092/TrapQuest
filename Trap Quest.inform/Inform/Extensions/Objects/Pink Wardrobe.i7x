...
Definition: A container (called I) is immune to change:
	...
	if I is pink wardrobe, decide yes;
	decide no.
...
To add treasure to (X - a pink wardrobe):
	...
	if newbie tips is 1, say "[item style]Newbie tip: Consider this your starting kit. These items will never be blessed, and are sometimes cursed but they're often better than nothing, since going around naked will upset most NPCs. Wearing heels is an interesting but challenging choice because this will make you more vulnerable in the early game but is a great source of damage later on.[roman type][line break]".
