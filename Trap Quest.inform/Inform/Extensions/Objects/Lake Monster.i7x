...
A lake monster is a kind of person.  The description of lake monster is usually "[LakeMonsterDesc]".  There is 1 lake monster.  A lake monster is usually father material.  The printed name of lake monster is usually "[TQlink of item described][input-style]lake monster[shortcut-desc][TQxlink of item described][verb-desc of item described]".  The text-shortcut of lake monster is "lm".  A lake monster has a number called semen-sniffing.  A lake monster is not portable.
...
To LakeMonsterCheck (S - a number):
	...
	if (R * 40 < the semen-sniffing of L) or  (R * 30 < the semen-sniffing of L and the player is a schoolgirl):[if a number between 800 and 1000 is less than L]
