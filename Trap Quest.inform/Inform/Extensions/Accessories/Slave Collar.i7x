...
To say ClothingDesc of (C - a slave collar):
	say "This pink leather collar has the word 'SLAVE' printed on the front in glittery letters.".
To say ShortDesc of (C - a slave collar):
	say "slave collar".

To decide which number is the bartering value of (T - a slave collar) for (M - a wrestler):
	decide on 2.
