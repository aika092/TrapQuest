...
A necktie is a kind of neckwear.  Printed name of necktie is "[TQlink of item described][clothing-title-before]necktie[clothing-title-after][TQxlink of item described][verb-desc of item described]".  Understand "tie" as necktie.  The text-shortcut of necktie is "ne".
...
To decide which figure-name is clothing-image of (C - a necktie):
	decide on figure of necktie.

To say ClothingDesc of (C - a necktie):
	say "A tiny apricot tartan necktie, the perfect completion to any slutty schoolgirl outfit.".

To say ShortDesc of (C - a necktie):
