...
Check pulling a pullstring collar:
	...
	if the player is able to speak and the noun is worn:
		...
		otherwise if R is 3 or monster-puller is monster:
			...
			otherwise:
				if monster-puller is female monster, say "'[if the class of the player is sissy]Pathetic sissies like me need to obey our Mistresses if we want to earn our cummies![otherwise if the player is male]Girls turn me on, but only if they're on top!  I'm not manly enough to try and dominate a woman.'[otherwise]This girl is so sexy... of course I want her to dominate me!'[end if][roman type][line break]";
