	...
	if the player is silently able to manually speak and the noun is worn:
		...
		otherwise if R is 2 or (monster-puller is male monster and a random number between 1 and 2 is 1):
			...
			otherwise if monster-puller is female monster and monster-puller is not neuter monster:
				say "'[if the oral sex addiction of the player < 3]I can't wait to find out what her pussy juices taste like!'[otherwise if the oral sex addiction of the player < 6]I just can't to have her cunt on my face!'[otherwise]Please let me tongue your asshole, Mistress!'[end if][roman type][line break]";
				OralSexAddictUp 1;
			otherwise:
		...
		otherwise if R is 3 or monster-puller is monster:
			...
			otherwise:
				if monster-puller is female monster and monster-puller is not neuter monster, say "'[if the player is a sissy]Pathetic sissies like me love working hard to earn our cummies![otherwise if the player is male]Girls turn me on, especially when they're on top! I'm not manly enough to try and dominate a woman.'[otherwise]This girl is so sexy... I hope she sits on my face!'[end if][roman type][line break]";
