...
To decide which number is the titfuck-addiction-influence of (C - a fuckdoll collar):
	let S be 1;
	decrease S by the magic-modifier of C; [Positive magic = subtracted sex addiction]
	decide on S.
...
To decide which number is the bartering value of (T - a fuckdoll collar) for (M - a wrestler):
	decide on 2.
