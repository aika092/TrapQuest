...
To decide which figure-name is clothing-image of (C - a cow print bikini bottoms):
	decide on figure of bikini bottoms 1.

To say ClothingDesc of (K - a cow print bikini bottoms):
	say "A bottom half of a bikini outfit with a cow print pattern.".
Figure of bikini bottoms 1 is the file "bikinibottoms1.png".

To decide which number is the initial outrage of (C - a cow print bikini bottoms):
	decide on 2.

To decide which object is the unique-upgrade-target of (C - a cow print bikini bottoms):
	decide on nothing.
...
To decide which figure-name is clothing-image of (C - a pink bikini bottoms):
	decide on figure of bikini bottoms 2.

To say ClothingDesc of (K - a pink bikini bottoms):
...
Figure of bikini bottoms 2 is the file "bikinibottoms2.png".

To decide which number is the initial outrage of (C - a pink bikini bottoms):
	decide on 11.

To decide which object is the potential-upgrade-target of (C - a pink bikini bottoms):
...
To decide which figure-name is clothing-image of (C - a white crotchless bikini bottoms):
	decide on figure of bikini bottoms 3.

To say ClothingDesc of (K - a white crotchless bikini bottoms):
...
Figure of bikini bottoms 3 is the file "bikinibottoms3.png".

To decide which number is the initial outrage of (C - a white crotchless bikini bottoms):
	decide on 12.
...
To decide which figure-name is clothing-image of (C - a black crotchless bikini bottoms):
	decide on figure of bikini bottoms 4.

To say ClothingDesc of (K - a black crotchless bikini bottoms):
...
Figure of bikini bottoms 4 is the file "bikinibottoms4.png".

To decide which number is the initial outrage of (C - a black crotchless bikini bottoms):
	decide on 10.

To decide which object is the potential-upgrade-target of (C - a black crotchless bikini bottoms):
...
To decide which figure-name is clothing-image of (C - a red bikini briefs):
...
To decide which object is the potential-upgrade-target of (C - a red bikini briefs):
...
To decide which figure-name is clothing-image of (C - a leopard print bikini bottoms):
...
To decide which number is the initial outrage of (C - a leopard print bikini bottoms):
	decide on 2.

To decide which object is the potential-upgrade-target of (C - a leopard print bikini bottoms):
