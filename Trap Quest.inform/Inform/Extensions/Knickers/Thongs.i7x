...
To decide which number is the vaginal-sex-addiction-influence of (C - a purple thong):
	if C is blessed, decide on 1;
	decide on 2.
To decide which number is the anal-sex-addiction-influence of (C - a purple thong):
	if C is blessed, decide on 1;
	decide on 2.
