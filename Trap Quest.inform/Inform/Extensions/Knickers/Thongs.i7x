...
A thong is a kind of undies. The soak-limit of a thong is usually 7. The text-shortcut of thong is "th". Understand "thong" as a thong.
...
To decide which figure-name is clothing-image of (C - grey-keyhole-thong):
...
To decide which number is the initial outrage of (C - white-thong):
	decide on 7.
...
To decide which number is the anal-sex-addiction-influence of (C - purple-thong):
	if C is blessed, decide on 1;
	decide on 2.
To decide which number is the initial outrage of (C - purple-thong):
	decide on 7.
...
To decide which number is the initial outrage of (C - red-thong):
	decide on 7.
...
grey-keyhole-thong is a thong. grey-keyhole-thong is sheer. The text-shortcut of grey-keyhole-thong is "gkt". Understand "grey", "keyhole" as grey-keyhole-thong.
To say selfexamineuniquetitle of (G - grey-keyhole-thong):
	say "grey keyhole thong".
To say UniqueClothingDesc of (G - grey-keyhole-thong):
