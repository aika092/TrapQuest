...
To decide which figure-name is clothing-image of (C - a white g-string):
	decide on figure of g-string 1.

To decide which figure-name is clothing-image of (C - a pink g-string):
	decide on figure of g-string 2.

To decide which figure-name is clothing-image of (C - a purple g-string):
	decide on figure of g-string 3.

To decide which figure-name is clothing-image of (C - a red g-string):
	decide on figure of g-string 4.

To decide which figure-name is clothing-image of (C - a black g-string):
	decide on figure of g-string 5.

To decide which figure-name is clothing-image of (C - a blue g-string):
	decide on figure of g-string 6.

To decide which figure-name is clothing-image of (C - a silver g-string):
	decide on figure of g-string 7.

To decide which figure-name is clothing-image of (C - a green g-string):
	decide on figure of g-string 8.

To decide which figure-name is clothing-image of (C - a green lace g-string):
	decide on figure of g-string 9.

To decide which figure-name is clothing-image of (C - a pink sequin g-string):
	decide on figure of g-string 10.

To decide which figure-name is clothing-image of (C - a orange g-string):
