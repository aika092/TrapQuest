...
To decide which number is the initial outrage of (C - briefs):
...
To decide which number is the bimbo-influence of (C - white-good girl briefs):
	decide on 1.
...
To decide which number is the initial outrage of (C - pink briefs):
	decide on 6.
...
To decide which number is the sex-addiction-influence of (G - red briefs):
	...
	decide on 2.
To decide which number is the initial outrage of (C - red briefs):
	decide on 6.
...
To decide which number is the sex-addiction-influence of (G - black briefs):
	if G is blessed, decide on 1;
	decide on 2.
To decide which number is the initial outrage of (C - black briefs):
	decide on 6.
...
To decide which number is the sex-addiction-influence of (G - green-briefs):
	if G is blessed, decide on 1;
	decide on 2.
To decide which number is the initial outrage of (C - green-briefs):
	decide on 6.
...
To decide which number is the sex-addiction-influence of (G - grey-briefs):
	if G is blessed, decide on 1;
	decide on 2.
To decide which number is the initial outrage of (C - grey-briefs):
	decide on 6.
...
To decide which number is the initial cringe of (C - pale briefs):
	decide on 4.
Definition: pale briefs (called C) is sissifying:
	decide yes.
...
To decide which number is the initial cringe of (C - red-orange briefs):
	decide on 3.
...
Definition: blue-polka-dot briefs (called C) is heart themed:
	decide yes.
