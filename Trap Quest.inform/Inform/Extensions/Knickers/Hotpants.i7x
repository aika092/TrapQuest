...
To say ClothingDesc of (K - a hotpants):
	say "These [UniqueTitle of K] [if K is not worn]hardly look like they would fit.[otherwise if the size of penis > 3]look even more comical due to the huge bulge your [ShortDesc of penis] makes in the front.[otherwise if the player is possessing a penis]look very comical thanks to the bump your [ShortDesc of penis] makes in the front.[otherwise if the player is not possessing a vagina]cling tightly to your [ShortDesc of hips].[otherwise]cling tightly to your [ShortDesc of hips] and [vagina], giving you a very visible camel-toe.[end if]".
...
Figure of leopard-hotpants is the file "Items/Clothes/Lower/Underwear/Skimpy/hotpants2.png".
