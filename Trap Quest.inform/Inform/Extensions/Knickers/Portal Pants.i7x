...
portal-hotpants is a knickers. portal-hotpants is unique. portal-hotpants is metal. The armour of portal-hotpants is 99. The printed name of portal-hotpants is "[clothing-title-before]portal hotpants[clothing-title-after]". The text-shortcut of portal-hotpants is "pthp". Understand "portal", "pants" as portal-hotpants.
...
To uniquely set up (C - portal-hotpants):
	do nothing.

To set up (C - portal-hotpants):
	do nothing.
