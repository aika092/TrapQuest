...
To decide which figure-name is clothing-image of (H - a bloomers):
...
To decide which number is the initial cringe of (C - a bloomers):
	decide on 8.

Definition: a bloomers (called C) is sissifying:
	decide yes.
...
To set up influence of (C - a crotchless bloomers):
	set up sex-based influence of C.

Definition: a crotchless bloomers is end of transformation chain:
	decide yes.
