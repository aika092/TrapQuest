...
Definition: pouch-panties is sissifying: decide yes.

To decide which object is the unique-upgrade-target of (C - pouch-panties):
	decide on a random off-stage transformation-eligible crotchless-panties.
