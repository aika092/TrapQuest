...
Definition: a panties is rippable:
...
To decide which figure-name is clothing-image of (C - white-panties):
	decide on figure of panties 1.

To decide which figure-name is clothing-image of (C - white-breed-panties):
	decide on figure of panties special 1.

To decide which figure-name is clothing-image of (C - pink-panties):
	decide on figure of panties 2.

To decide which figure-name is clothing-image of (C - purple-panties):
	decide on figure of panties 3.

To decide which figure-name is clothing-image of (C - red-panties):
	decide on figure of panties 4.

To decide which figure-name is clothing-image of (C - black-panties):
	decide on figure of panties 5.

To decide which figure-name is clothing-image of (C - black-diagram-panties):
	decide on figure of panties special 5.

To decide which figure-name is clothing-image of (C - black-sucking-cocks-panties):
	decide on figure of panties special 5b.

To decide which figure-name is clothing-image of (C - blue-panties):
	decide on figure of panties 6.

To decide which figure-name is clothing-image of (C - silver-panties):
	decide on figure of panties 7.

To decide which figure-name is clothing-image of (C - green-panties):
...
To say UniqueClothingDesc of (G - red-panties):
	say "This pair of red panties says 'Daddy's little girl' in capital letters on the [if wonderfuller clothing is 1]front[otherwise]back[end if], which tells everyone that [if G is worn]you are[otherwise]the wearer is[end if] no stranger to being treated as a [if diaper quest is 1]child[otherwise]dedicated submissive[end if].".
Understand "daddy", "daddy's", "little", "girl", "red" as red-panties.
To decide which number is the strength-influence of (C - red-panties):
	let S be -1;
...
To say UniqueClothingDesc of (G - black-sucking-cocks-panties):
	say "A pair of comfy black panties with the large pink words 'I LOVE SUCKING COCKS' on the [if wonderfuller clothing is 1]front[otherwise]back[end if].".
...
To say UniqueClothingDesc of (G - green-panties):
	say "This pair of green panties says 'SURE THING' in capitals on the [if wonderfuller clothing is 1]front[otherwise]back[end if], which makes it clear that [if G is worn]you are[otherwise]the wearer is[end if] up for sex with absolutely anyone.".
Understand "sure", "thing", "green" as green-panties.
