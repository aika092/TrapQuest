...
To say ShortDesc of (K - a crotch rope):
	say "crotch rope".

To decide which number is the initial outrage of (C - a crotch rope):
	decide on 12.
	
To uniquely set up (C - a crotch rope):
	set up magic state of C.

To set up influence of (C - a crotch rope):
