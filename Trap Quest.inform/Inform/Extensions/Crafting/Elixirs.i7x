	...
	if life-elixir-timer > 0:
		...
		if the remainder after dividing time-earnings by 12 < time-seconds:
			...
			otherwise if the soreness of asshole > the soreness of vagina:
				say "Your [asshole] feels [if the openness of asshole < 6]a bit less sore[otherwise][line break][second custom style]ready for more[roman type][line break][end if]!";
				heal asshole times 1;
			otherwise if the soreness of vagina > 0:
				say "Your [vagina] feels [if the openness of vagina < 6]a bit less sore[otherwise][line break][second custom style]ready for more[roman type][line break][end if]!";
				heal vagina times 1;
...
An elixir of invigoration is a kind of elixir. The printed name of elixir of invigoration is "[TQlink of item described]elixir of invigoration[shortcut-desc][TQxlink of item described][verb-desc of item described]". The printed plural name of elixir of invigoration is "[TQlink of item described]elixirs of invigoration[shortcut-desc][TQxlink of item described][verb-desc of item described]". The text-shortcut of elixir of invigoration is "ei". The description of elixir of invigoration is "A small glass flask filled with a small dose of shimmering [if the bimbo of the player < 6]creamy[otherwise][line break][second custom style][semen]-like[roman type][line break][end if] liquid. It looks like it could do something useful if you drank it, but who knows when it would be appropriate to drink, and if there are any side effects...". There are 3 elixir of invigoration.
