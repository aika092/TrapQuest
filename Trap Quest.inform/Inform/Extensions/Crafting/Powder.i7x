...
Carry Out PowderRubbing a powder of identification on a thing:
	...
	say "It is a [second noun][if the raw-magic-modifier of the second noun is 0 and the second noun is bland and the second noun is blandness].  [variable custom style]Hmm, how underwhelming[end if].[roman type][line break]";
...
Carry Out PowderRubbing a powder of resistance on a thing:
	...
	if the noun is cursed:
		...
		increase the transform-attempts of the noun by 2;
