...
Definition: a womb diagram tattoo (called T) is drawable:
	...
	decide no.
Definition: a womb diagram tattoo (called T) is eligible:
	if the noun is maternity bra or the noun is maternity dress or the noun is baby's bottle or the noun is cock pacifier, decide yes;
	decide no.
...
[!<TheWombDiagramTattooPussySlutRule>+

Makes vaginal sex more likely.

+!]
This is the womb diagram tattoo pussy slut rule:
	if there is a worn womb diagram tattoo, increase the desirability of vagina by 5.
