...
Definition: a worthless cunt tattoo (called A) is drawable:
	...
	decide yes.
Definition: a worthless cunt tattoo (called T) is eligible:	
	if the noun is cum dump's undergarment, decide yes;
	decide no.
To say tattoo-desc of (T - a worthless cunt tattoo):
	if images visible is 1, display figure of worthless cunt tattoo;
