...
Definition: a spank my kitty tattoo (called A) is drawable:
	...
	decide yes.
Definition: a spank my kitty tattoo (called B) is eligible:	
	if the player is male, decide no;
	if the noun is buttockless pants or the noun is super-short clothing or the noun is short clothing or the noun is focus band or the noun is cat themed or the noun is hotpants or the noun is cutoffs or the noun is clubbing dress or the noun is schoolgirl outfit, decide yes;
	decide no.
...
To decide which number is the strength-influence of (T - a spank my kitty tattoo):
	...
	decide on 0.
To decide which number is the bimbo-influence of (T - a spank my kitty tattoo):
	if vagina is lewdly exposed or diaper quest is 1, decide on 1;
	decide on 0.
To decide which number is the initial outrage of (T - a spank my kitty tattoo):
	decide on 10.
To decide which number is the initial cringe of (T - a spank my kitty tattoo):
	decide on 10.
