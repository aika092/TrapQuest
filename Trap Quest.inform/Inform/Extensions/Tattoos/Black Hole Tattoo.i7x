Black Hole Tattoo by Tattoos begins here.

black hole tattoo is a kind of body tattoo. There is 1 black hole tattoo.
Definition: a black hole tattoo (called T) is drawable:
	if T is worn, decide no;
	if diaper quest is 1, decide no;
	if there is a worn virgin void tattoo, decide no;
	if T is eligible, decide yes;
	decide no.
Definition: a black hole tattoo (called T) is eligible:
	if the noun is food, decide yes;
	if the noun is clothing and interracial fetish is 1 and the player is female and the noun is interracial related, decide yes;
	decide no.
To say tattoo-desc of (T - a black hole tattoo):
...
To decide which object is the concealer of (T - a black hole tattoo):
