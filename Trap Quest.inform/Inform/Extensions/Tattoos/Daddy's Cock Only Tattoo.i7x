...
Definition: a daddy's cock only tattoo (called T) is eligible:	
	...
	decide no.
Definition: a daddy's cock only tattoo (called A) is drawable:
	if there is a worn asshole tattoo, decide no;
	if diaper quest is 1, decide no;
	if there is a mating male monster, decide yes;
	decide no.
To say tattoo-desc of (T - a daddy's cock only tattoo):
	if images visible is 1, display figure of daddy's cock only tattoo;
	say "The words 'daddy[']s cock only' are permanently inked around your [asshole].".

Daddy's Cock Only Tattoo ends here.
