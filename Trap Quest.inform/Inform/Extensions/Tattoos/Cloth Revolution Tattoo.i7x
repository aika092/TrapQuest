...
Definition: a cloth revolution tattoo (called T) is eligible:
	...
	decide no.
To say tattoo-desc of (T - a cloth revolution tattoo):
	if images visible is 1, display figure of cloth revolution tattoo;
	say "A drawing of a blue cloth diaper with the phrase 'cloth revolution' is tattooed on your right wrist. You can feel it increasing your love of diapers.".
To decide which object is the concealer of (T - a cloth revolution tattoo):
	decide on a random worn actually dense arm covering clothing.
To decide which number is the diaper-addiction-influence of (T - a cloth revolution tattoo):
	decide on 3.
