...
no-panties tattoo is a kind of crotch tattoo. Figure of no-panties tattoo is the file "Items/Tats/tattoo10.png". There is 1 no-panties tattoo.
Definition: a no-panties tattoo (called T) is drawable:
	if there is a worn crotch tattoo, decide no;
	if diaper lover >= 1, decide no;
	decide yes.
Definition: a no-panties tattoo (called T) is eligible:	
	if the noun is crotch covering no protection clothing or the noun is undies, decide yes;
	decide no.
To say tattoo-desc of (T - a no-panties tattoo):
	if images visible is 1, display figure of no-panties tattoo;
	say "The words 'no panties' are tattooed in small handwriting on your hip near your crotch.".
To decide which number is the initial outrage of (T - a no-panties tattoo):
	decide on 8.
