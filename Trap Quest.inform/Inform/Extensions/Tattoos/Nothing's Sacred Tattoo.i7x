...
Definition: a nothing's sacred tattoo (called T) is eligible:
	...
	decide no.
To say tattoo-desc of (T - a nothing's sacred tattoo):
...
To decide which number is the strength-influence of (C - a nothing's sacred tattoo):
	decide on 2.
To compute periodic effect of (C - a nothing's sacred tattoo):
	increase the soul-charge of C by 1;
	if the soul-charge of C > 50 and the player is not soulless:
		now the soul-charge of C is 0;
		humiliate 500.
To decide which object is the concealer of (T - a nothing's sacred tattoo):
