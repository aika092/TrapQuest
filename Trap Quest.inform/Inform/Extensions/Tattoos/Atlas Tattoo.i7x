...
Definition: an Atlas tattoo (called T) is drawable:
	...
	decide yes.
Definition: an Atlas tattoo (called T) is eligible:
	if the noun is bra, decide yes;
	decide no.
To say tattoo-desc of (T - an Atlas tattoo):
	if images visible is 1, display figure of Atlas tattoo;
...
To decide which number is the initial outrage of (T - an Atlas tattoo):
	decide on 4.

Atlas Tattoo ends here.
