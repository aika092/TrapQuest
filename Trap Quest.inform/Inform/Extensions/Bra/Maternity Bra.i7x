...
Definition: an maternity bra (called C) is pregnancy related:
	decide yes.
...
To decide which number is the initial outrage of (C - a maternity bra):
	if the player is female, decide on 0;
	decide on 2.

To decide which object is the potential-upgrade-target of (C - a maternity bra):
