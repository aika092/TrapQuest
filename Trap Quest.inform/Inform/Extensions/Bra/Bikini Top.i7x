...
A string bikini top is a kind of bikini top. The soak-limit of a string bikini top is 2. The min size of a string bikini top is usually 20. The max size of a string bikini top is usually 20. The support of a string bikini top is usually 0. A string bikini top is usually ridiculously low cut. A string bikini top is usually transformation-rare. [Essentially a string bikini top comes in one size fits all]
