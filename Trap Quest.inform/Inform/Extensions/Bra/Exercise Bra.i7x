...
To decide which object is the potential-upgrade-target of (C - a sexy exercise bra):
	if the number of worn breast covering clothing > 1, decide on a random off-stage sheer bra;
