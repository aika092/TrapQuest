...
A ribbon bra is a kind of bra. Figure of ribbon bra is the file "Items/Clothes/Upper/Bras/ribbonbra1.png". A ribbon bra is usually normally-nipple-exposing. A ribbon bra is ridiculously low cut. A ribbon bra is usually optional-top-displacable. The soak-limit of a ribbon bra is usually 9. A ribbon bra is usually unique.
...
To decide which object is the potential-upgrade-target of (C - a ribbon bra):
...
Definition: a ribbon bra (called C) is bow themed:
	decide yes.
