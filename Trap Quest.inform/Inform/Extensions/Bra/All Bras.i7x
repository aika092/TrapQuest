...
To say selfexaminetitle of (B - a training bra):
	say "small cream training bra".

To decide which figure-name is the clothing-image of (B - a training bra):
	decide on figure of training bra.

To say ClothingDesc of (C - a training bra):
...
To decide which figure-name is icarus-clothing-image of (C - a greyish exercise bra):
...
To say ShortDesc of (B - a sexy exercise bra):
	say "sexy exercise bra".

To say selfexaminetitle of (B - an exercise bra):
	say "beige exercise bra".

To say selfexaminetitle of (B - a greyish exercise bra):
	say "greyish exercise bra".
...
To say ClothingDesc of (C - a greyish exercise bra):
...
To decide which number is the initial outrage of (C - an exercise bra):
	decide on 0.

To decide which number is the initial outrage of (C - a greyish exercise bra):
	decide on 2.
...
A cupless bra is a kind of bra. Figure of cupless bra is the file "Items/Clothes/Upper/Bras/cuplessbra1.png". A cupless bra is usually transformation-rare. [Cupless bras are fully exposing, so they can't be top-displacable.]

There is 1 cupless bra. The text-shortcut of cupless bra is "cub".

Definition: a cupless bra is uncovered themed: [Is it something that should not be concealed?]
	decide yes.
...
To compute bra strain of (C - a cupless bra):
	do nothing.

To say CupDesc of (C - a cupless bra):
	say "".

Definition: a cupless bra is black themed: decide yes.
...
To say CupDesc of (C - a pasties):
	say "".

To decide which number is the bartering value of (T - a pasties) for (M - a robobellboy):
	decide on 4.
