...
Carry out unwrapping:
	...
	if R is 1:
		now X is a random off-stage fetish appropriate tincture;
	if R is 2:
		now X is a random off-stage fetish appropriate elixir;
	if R is 3:
		now X is a random off-stage fetish appropriate potion;
	if R is 4:
		now X is a random off-stage fetish appropriate salve;
	if R is 5:
		now X is a random off-stage fetish appropriate powder;
	if R is 6:
