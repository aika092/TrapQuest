...
clitoris piercing is a piercing. The printed name of clitoris piercing is "[TQlink of item described][item style][if the bimbo of the player > 10]clit[otherwise]clitoris[end if] piercing[clothing-title-after][TQxlink of item described][verb-desc of item described]". The text-shortcut of clitoris piercing is "clp". Understand "clit" as clitoris piercing. Figure of clitoris piercing is the file "Items\Accessories\Piercings\clitpiercing1.png". clitoris piercing is vaginal-sex-addiction-influencing.

To decide which figure-name is the clothing-image of (C - clitoris piercing):
	decide on figure of clitoris piercing.

To say ClothingDesc of (C - clitoris piercing):
...
To say ShortDesc of (C - clitoris piercing):
	say "jewelled vertical clitoris hood piercing".

To decide which number is the vaginal sensitivity influence of (C - clitoris piercing):
	if C is cursed, decide on 3;
	if C is blessed, decide on -2;
	decide on 1.

To decide which number is the delicateness-influence of (C - clitoris piercing):
	decide on 1.

To decide which number is the initial outrage of (C - clitoris piercing):
	decide on 13.

To say PiercingFlav of (P - clitoris piercing):
...
To decide which object is the concealer of (C - clitoris piercing):
...
Definition: clitoris piercing (called P) is eligible:
	if the player is male or P is worn or the player is pussy protected, decide no;
	decide yes.
