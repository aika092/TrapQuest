...
The printed name of small nose piercing is "[TQlink of item described][item style][if the intelligence of the player > 6]septum[otherwise]nose[end if] piercing[clothing-title-after][TQxlink of item described][verb-desc of item described]".
...
Definition: a small nose piercing (called C) is untransformable:
	decide no.
...
The printed name of ugly nose piercing is "[TQlink of item described][item style]ugly [if the intelligence of the player > 6]septum[otherwise]nose[end if] piercing[clothing-title-after][TQxlink of item described][verb-desc of item described]".
...
Definition: an ugly nose piercing (called P) is eligible:
	decide no.
