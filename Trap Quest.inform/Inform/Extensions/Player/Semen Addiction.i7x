...
To say SemenEncounterFlav:
	if highest semen addiction < the semen addiction of the player:
		...
		if the semen addiction of the player is 14, say "[second custom style][if the semen volume of vagina > 0 or the semen volume of belly > 0]Having [semen] in me is making me feel more comforted... and proud[otherwise]I'm going to wear all this cum like a symbol of pride[end if]![roman type][line break]";
