...
To SemenAddictUp (X - a number):
	...
	while X > 0:
		...
		if a random number between 1 and 8 > K:
			if the raw semen addiction of the player < 20 and a random number between 1 and 30 > the raw semen addiction of the player:
...
To say SemenEncounterFlav:
	if highest semen addiction < the semen addiction of the player:
		...
		if the semen addiction of the player is 5, say "[first custom style]Ugh, why is [semen] so bitter and salty?  Why couldn't it at least be sweet?[roman type][line break]";
		...
		if the semen addiction of the player is 8, say "[variable custom style]Hmm, maybe [semen] just has an acquired taste.  Like coffee, or beer..[roman type][line break]";
		if the semen addiction of the player is 9, say "[second custom style]How have I never noticed how nice the smell of [semen] is?[roman type][line break]";
		if the semen addiction of the player is 10, say "[variable custom style]Wow, I'm really starting to find [semen] quite appealing!  This must be the work of the game... but it's not necessarily a BAD thing, right?[roman type][line break]";
		if the semen addiction of the player is 11, say "[variable custom style]I should be thanking them for making me like [semen], they're just helping me enjoy the game as much as possible![roman type][line break]";
		if the semen addiction of the player is 12, say "[second custom style]Wow, I can't believe I used to hate [semen].  I can't get enough of this stuff![roman type][line break]";
		if the semen addiction of the player is 13, say "[second custom style]Aww is that all?  I was kind of hoping there would be more.[roman type][line break]";
		if the semen addiction of the player is 14, say "[variable custom style]This is getting out of hand, I'm really getting addicted to this stuff!  Soon I'm not going to be able to bring myself to drink anything else![roman type][line break]";
		if the semen addiction of the player is 15, say "[second custom style][if the sex addiction of the player > 14]I like it better when I'm full of [semen].  It helps remind me what I'm to be used for.[otherwise]This world is great, it's basically making sure I always have [semen] on tap![end if][roman type][line break]";
	...
	otherwise if semen-encountered is 0:
		now semen-encountered is 1;
		say "[if the semen addiction of the player < 6][first custom style][one of]Fuck[or]Shit[or]No no no[purely at random]![otherwise if the semen addiction of the player < 9][variable custom style][one of]Gross[or]Eew[or]Grr[stopping].[otherwise if the semen addiction of the player < 12][otherwise if the semen addiction of the player < 15][second custom style]Ooh, yummy![otherwise if the bimbo of the player < 17][second custom style]I want more![otherwise][second custom style][NameBimbo][one of] wants more[or] needs more[or][']s not full yet[then at random]![end if][roman type][line break]".
