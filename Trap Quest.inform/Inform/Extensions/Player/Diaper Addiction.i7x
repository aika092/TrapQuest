...
An advance counters rule (this is the diapers affect adult babies rule):
	if the player is actually an adult baby:
		if adult-baby-class is 0:
			...
			say "[bold type][one of]Now that you are wearing [if the number of worn baby themed wearthing > 2]so many things that only an actual diaper fetishist would ever wear[otherwise]this headwear[end if], it's clear to anyone that looks at you will believe that you are[or]You realise that you are once again dressed as[stopping] an adult baby.[roman type][line break]";
