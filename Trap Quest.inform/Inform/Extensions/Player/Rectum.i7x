...
A grossed out player tends to refuse to rest and can't be horny.
			...
			if the player is reverse bimbo consenting:
				...
				otherwise:
					...
					if the implant of ultimate-lesson-mess is 1:
						say "Magic ripples through your belly as the curse you got from [NameDesc of lesson-teacher of ultimate-lesson] activates. Your belly bulges as the bulk inside grows to massive proportions!";
