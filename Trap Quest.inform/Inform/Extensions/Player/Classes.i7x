...
This is the human toilet class rule:
	if WC hood is worn:
		...
		if meat-toilet-panties is worn:
			...
			if the used condoms of meat-toilet-panties > 0, now player-class is "meat toilet trashcan";
		rule succeeds.
...
a later time based rule (this is the explaining human toilet rule):
	if toiletExplained is false and the class of the player is human toilet:
		...
		say "[bold type]Now that you have become the [']human toilet['] class, you sense that aggressors are more likely to choose to piss on you, and also you will be stronger the more [urine] there is inside your stomach.[roman type][line break]";
	otherwise if toiletExplained is true and the class of the player is not human toilet:
		now toiletExplained is false;
		say "[bold type]Now that you are no longer the [']human toilet['] class, you sense that aggressors are less likely to choose to piss on you, and you are no longer stronger when you have [urine] in your stomach.[roman type][line break]".
...
This is the bride class rule:
	if a bridal veil is worn:
		...
		now player-class is "[T]";
		if bridal garter is worn, now player-class is "condom collector [T]";
		rule succeeds.
...
Definition: a text (called T) is cumdumpster:
	if T matches the text "cumdump" or T is "sinful priestess" or T matches the text "condom" or T matches the text "fucktoy" or T is "fraternity's bicycle" or T matches the text "meat" or T is "cum collector" or T is "porn star", decide yes;
	decide no.
...
This is the condom collector class rule:
	if there is a worn condom collector hat:
		if cumdumpster condom hat is worn or meat-toilet-panties is worn:
			...
			otherwise now the player-class is "cum collector";
		otherwise if rubber condom hat is worn:
			now the player-class is "walking condom";
		otherwise if WC collar is worn:
			now the player-class is "toilet trashcan";
		otherwise:
			now the player-class is "condom collector";
		rule succeeds.
...
Definition: a text (called T) is condom collector:
	if T matches the text "condom" or T is "sinful priestess" or T matches the text "collector" or T matches the text "trash", decide yes;
	decide no.

condomCollectorExplained is initially false.
a later time based rule (this is the explaining condom collector rule):
...
This is the stripper class rule:
	if stripper-ears is worn:
		...
		if porn-star-suspenders is worn or porn star tube top is worn, now the player-class is "porn star";
		rule succeeds.
The stripper class rule is listed first in the player class rules.
Definition: a text (called T) is stripper:
	if T matches the text "stripper" or T is "porn star", decide yes;
	decide no..
...
Definition: a text (called T) is worshipper:
	if T matches the text "demon", decide yes;
	decide no.
