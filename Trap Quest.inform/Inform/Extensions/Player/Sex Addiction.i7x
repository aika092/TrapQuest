...
[!<DecideWhichNumberIsTheSexAddictionInfluenceOfDominanceClothing>+

REQUIRES COMMENTING

+!]
To decide which number is the sex-addiction-influence of (C - a dominance clothing):
	let S be 4;
...
+!]
To RandomAddictUp (X - a number):[###Should this have a chance at increasing titfuck addiction as well?]
	while X > 0:
...
*@!]
The player has a number called fucked-count. The fucked-count of the player is 0.
