...
To check for arousal change:
	...
	if P < previous-horny:
		...
		if previous-horny is 2:
			...
			otherwise:
				say "[bold type][one of]A fresh new wave of horniness suddenly washes over you,[or]Another wave of horniness hits you[stopping] and your [if the player is possessing a penis]testicles[otherwise if the player is not possessing a vagina]body[otherwise][vagina][end if] [one of]feel[unless the player is possessing a penis]s[end if] desperate to[or][if the player is possessing a penis]cry[otherwise]cries[end if] out for another[stopping] orgasm[one of]. As your blood starts pumping even faster, you feel yourself getting even faster, but your mind also starts to cloud over with thoughts of [if diaper quest is 1]orgasms[otherwise]sex[end if], making it more difficult to concentrate on the tasks at hand. [or]. Your smarts are dulled and your dexterity further improved until you orgasm.[or]. [stopping][roman type][line break]";
