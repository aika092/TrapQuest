...
To HairUp (X - a number):
	...
	otherwise:
		...
		if hair-fail is 0 or hair-fail is 1:
			...
			if the largeness of hair is 10, say "You watch your hair grow until it reaches your crotch. [if the thickness of hips > 6 and the player is upright]You feel the hair start to bunch up and settle on top of your [HipDesc]. [end if][one of][if the bimbo of the player < 10][first custom style]Not only do I now look like some kind of sheltered maiden, but if it grows much further I'll end up tripping over it![otherwise][second custom style]I feel like some kind of glamorous model![end if][or][stopping][roman type][line break]";
			if the largeness of hair is 11, say "Your hair continues to grow right in front of your eyes, until it reaches your [ShortDesc of thighs]. [if the semen coating of thighs > 2 and the player is upright]It starts to stick to the [semen] on the insides of your [ShortDesc of thighs]. [end if][if the thickness of hips > 5 and the player is upright]Behind you, it flows gracefully over your [HipDesc]. [end if][one of][if the sex addiction of the player < 10 and the semen coating of thighs > 2][first custom style]Oh man, that's just gross.  And I have to walk around like this?[otherwise if the bimbo of the player < 10][first custom style]My hair is so long it's making my head feel awkwardly heavy![otherwise][second custom style]I wish I could see myself in a mirror, I bet my hair looks amazing![end if][or][stopping][roman type][line break]";
			if the largeness of hair is 12, say "Your hair continues to grow right in front of your eyes, until it reaches your knees. [if the thickness of hips > 5 and the player is upright]You feel it continue to flow over your [HipDesc]. [end if][one of][if the bimbo of the player < 12][first custom style]Please stop growing now...[otherwise][second custom style]I have the best hair in the world![end if][or][if the bimbo of the player > 12][second custom style]This is the perfect hair length, I think.[end if][stopping][roman type][line break]";
