...
[This is the too much dignity to present face rule:
	if the humiliation of the player < HUMILIATION-PROUD + 2000 and debugmode < 1:
		if (the virgin of the player is 0 and the player is possessing a vagina) or (the analvirgin of the player is 0 and the player is not possessing a vagina): [virgins can always attempt to preserve their virginity]
