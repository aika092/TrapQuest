...
To say enema floor declaration of (M - a monster):
	say "[variable custom style]'[if player-squatting is 1 and the humiliation of the player < HUMILIATION-MODEST + 4000][purposeful shameful enema floor declaration of M][otherwise if the humiliation of the player < HUMILIATION-MODEST + 4000][shameful enema floor declaration of M][otherwise if player-squatting is 1 and humiliation of the player < HUMILIATION-SHAMELESS - 2000][purposeful apathetic enema floor declaration of M][otherwise if the humiliation of the player < HUMILIATION-SHAMELESS - 2000][apathetic enema floor declaration of M][otherwise if player-squatting is 1][purposeful shameless enema floor declaration of M][otherwise][shameless enema floor declaration of M][end if][roman type][line break]".
...
To say enema declaration of (M - a monster) into (C - a clothing):
	say "[variable custom style]'[if player-squatting is 1 and the humiliation of the player < HUMILIATION-MODEST + 4000][purposeful shameful enema declaration of M into C][otherwise if the humiliation of the player < HUMILIATION-MODEST + 4000][shameful enema declaration of M into C][otherwise if player-squatting is 1 and the humiliation of the player < HUMILIATION-SHAMELESS - 2000][purposeful apathetic enema declaration of M into C][otherwise if the humiliation of the player < HUMILIATION-SHAMELESS - 2000][apathetic enema declaration of M into C][otherwise if player-squatting is 1][purposeful shameless enema declaration of M into C][otherwise][shameless enema declaration of M into C][end if][roman type][line break]".
