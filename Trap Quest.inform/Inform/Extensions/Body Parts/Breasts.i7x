...
@!]
breasts is a flesh. breasts is everywhere. Understand "tits", "titties", "jugs", "udders", "breast", "boobs", "cleavage", "bust", "funbags", "boobies", "bosom" as breasts. Understand "chest" as breasts when the number of treasure chests in the location of the player is 0. The text-shortcut of breasts is "breasts".
