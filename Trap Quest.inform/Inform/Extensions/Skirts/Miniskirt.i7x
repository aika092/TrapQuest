Miniskirt by Skirts begins here.

A miniskirt is a kind of skirt.  A miniskirt is usually short.  

A lace miniskirt is a kind of miniskirt.  There is 1 mesh lace miniskirt.  Printed name of lace miniskirt is "[TQlink of item described][clothing-title-before]sheer miniskirt[clothing-title-after][TQxlink of item described][verb-desc of item described]".  The text-shortcut of lace miniskirt is "sms".  Figure of lace miniskirt is the file "miniskirt1.png".  Understand "sheer" as lace miniskirt.
...
A tartan miniskirt is a kind of miniskirt.  There is 1 tartan miniskirt.  Printed name of tartan miniskirt is "[TQlink of item described][clothing-title-before]tartan miniskirt[clothing-title-after][TQxlink of item described][verb-desc of item described]".  The text-shortcut of tartan miniskirt is "tm".  Figure of tartan miniskirt is the file "miniskirt2.png".
...
To decide which object is the potential-upgrade-target of (C - a miniskirt):
	if diaper quest is 1 and there is an off-stage babydoll microskirt, decide on a random off-stage babydoll microskirt;
	decide on a random off-stage pink microskirt.
