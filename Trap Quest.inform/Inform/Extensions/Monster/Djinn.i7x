...
To compute failed dominance punishment of (M - djinn):
	if player-fucker is face:
		say "[line break][speech style of M]'Alright, mortal, I'm going to level with you. When I grant a wish I'm supposed to twist your words and humiliate you, but can I do that if you don't give me anything to work with? Lets not waste each other's time, alright?'[roman type][line break][BigNameDesc of M] loses interest.";
		moderateHumiliate;
		calm M;
		Bore M;
