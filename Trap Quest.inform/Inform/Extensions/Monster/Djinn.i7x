...
A djinn is a kind of monster. A djinn is usually intelligent. The leftover-type of a djinn is usually 113. A djinn has a number called wish history. A djinn is usually airborne. The description of a djinn is usually "[DjinnDesc]". A djinn is male.

Definition: a djinn (called M) is father material:
	decide yes.
	
Definition: a djinn (called M) is dark skinned:
	decide yes.

Definition: A djinn (called M) is woods dwelling:
	decide yes.

Definition: a djinn (called M) is raunchy:
	decide yes.
...
To say DiaperReaction of (M - a djinn):
	say "The [M] smirks and looks directly at your dampening crotch. [line break][speech style of M]'You mortals are so pitiful.'[roman type][line break]";
...
To say DjinnDisappointedBefore:
	say "The djinn narrows his eyes. [line break][first custom style]'Fine, so be it.'[roman type][line break]".

To compute DjinnDisappointedAfter of (M - a monster):
	if M is alive:
		say "The djinn claps his hands and starts to disappear. [line break][first custom style]'You should hope that we don't meet again.'[roman type][line break]";
		regionally place M;
		permanently anger M;
...
To say CondomPieFlav of (M - a djinn) in (F - a fuckhole):
	say "Miraculously, it seems to hold, and the [M] laughs as he pulls out and carefully peels it off. [line break][speech style of M]'I am surprised your mortal condom could hold my seed!'[roman type][line break]".
...
To say PresentAcceptanceFlav of (M - a djinn):
	say "The [M] laughs at your request. [line break][speech style of M]'Indeed, an excellent choice.'[roman type][line break]".

To say PresentRejectionFlav of (M - a djinn):
	say "The [M] laughs at your request. [line break][speech style of M]'Why would I care about the feelings of a mere mortal such as yourself?'[roman type][line break]".
...
To compute damage of (M - a djinn):
	if the health of M > 0:
		if M is uninterested or M is friendly:
			say "The [M] bellows with anger. [line break][speech style of M]'You dare challenge me to a duel?  Do you not know who I am?!'[roman type][line break]";
			anger M;
			now M is interested;
		otherwise:
			anger M;
