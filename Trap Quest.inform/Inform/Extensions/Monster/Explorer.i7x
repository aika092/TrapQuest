	...
	if M is in the location of the player:
		...
		if the explorer-bimbo of M >= 2 and there is a hotel bed in the location of M and (VIP-card is held by P or R is ring):
			...
			if pimp is alive and pimp is undefeated and the number of rings held by M > 1:
				...
				destroy SR;
		otherwise:
			say "[big he of P] whispers something into [his of M] ear. [BigNameDesc of M] [if the explorer-bimbo of M >= 2]smiles and[otherwise]turns right red, but[end if] nods. [big he of M] takes [NameDesc of P][']s [manly-penis] into [his of M] hands and starts giving [him of P] a handjob. [big he of M] [if the explorer-bimbo of M >= 2]gives you a cheeky wink[otherwise]is clearly rather embarrassed about the fact that you're watching, and purposefully avoids eye contact with you[end if]. A short while later, [NameDesc of P] is painting the floor with [his of P] [semen]. You spot [NameDesc of M] biting [his of M] bottom lip as [he of M] watches the puddle of [semen] start to form. [BigNameDesc of P] takes [his of P] leave, leaving you and [NameDesc of M] standing there awkwardly, with the evidence of the aftermath on the floor in between you.";
			SemenPuddleUp (the semen load of P) in (the location of M);
	otherwise:
		SemenPuddleUp (the semen load of P) in (the location of M).
