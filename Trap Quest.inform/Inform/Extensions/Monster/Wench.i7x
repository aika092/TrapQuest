...
To decide which figure-name is the monster-image of (M - a kidnapped wench):
...
To say MonsterDesc of (M - a wench):
	...
	if M is horny-wench:
		...
		otherwise:
			if lady fetish is 2, say "This [man of M] has a glazed look in [his of M] eye, a tiny, useless penis, and one hand between [his of M] legs. [big he of M] is wearing a white blouse, which is completely soaked and appears to have been rather forcefully unbuttoned. [big his of M] long, beach blonde hair is plastered around [his of M] face, and thick, pearly [semen] is visibly leaking from [his of M] asshole.";
			otherwise say "This [man of M] has a glazed look in [his of M] eye, a voluptuous figure, and both hands buried in [his of M] crotch. [big he of M] is wearing a white blouse, which is completely soaked and appears to have been rather forcefully unbuttoned. [big his of M] beach blonde hair is plastered around [his of M] face, and thick, pearly [semen] is visibly leaking from both of [his of M] holes.";
	otherwise if M is kidnapped wench:
		if bukkake fetish is 1:
			if lady fetish is 2, say "This twink is completely naked and plastered with [semen], [if K is clothing]aside from [his of M] stolen [ShortDesc of K][otherwise]and if the bright pink cage locked around [his of M] cock is any indication, [he of M] doesn't normally get to be on top[end if]. [big his of M] skin is [one of]pale[or]a pale brown[sticky random], and [his of M] beach blonde hair is unkempt and messy. [big he of M] wears a look on [his of M] face that says 'Please be gentle!', although the [semen] freely dribbling out of [his of M] asshole and [if K is clothing]soaking through [his of M] stolen [ShortDesc of K][otherwise]down [his of M] legs[end if] makes it pretty clear [he of M] tends to get it pretty rough. The words 'SISSY CUMDUMP' are tattooed across his left ass cheek.";
			otherwise say "This [man of M] is completely naked and plastered with [semen]. If the purple bruises on [his of M] wrists and ankles are any indication, [he of M]'s probably spent most of [his of M] time here cooped up in chains. [big his of M] skin is [one of]pale[or]a pale brown[sticky random], and [his of M] beach blonde hair is unkempt and messy. [big he of M] wears a look on [his of M] face that says 'Please be gentle!', although the [semen] freely dribbling out of both [his of M] holes and [if K is clothing]soaking through [his of M] stolen [ShortDesc of K][otherwise]down [his of M] legs[end if] makes it pretty clear [he of M] tends to get it rough. A small tattoo across the small of [his of M] back reads 'PROPERTY'.";
		otherwise:
			if lady fetish is 2, say "This twink is completely naked, [if K is clothing]aside from [his of M] stolen [ShortDesc of K][otherwise]and if the bright pink cage locked around [his of M] cock is any indication, [he of M] doesn't normally get to be on top[end if]. [big he of M] has pale skin, long, beach blonde hair and a look on [his of M] face somewhere between excitement and total exhaustion. The words 'SISSY CUMDUMP' are tattooed across [his of M] left ass cheek, and [semen] is dribbling freely out of [his of M] asshole.";
			otherwise say "This [man of M] is [if K is clothing]almost [end if]completely naked, and if the purple bruises on [his of M] wrists and ankles are any indication, [he of M]'s probably spent most of [his of M] time here cooped up in chains. [big he of M] has pale skin, beach blonde hair and a look on [his of M] face somewhere between excitement and total exhaustion. [if K is clothing]There is a small tattoo across the small of [his of M] back, which is partially obscured by the [ShortDesc of K] [he of M] 'received' from you[otherwise]A small tattoo across the small of [his of M] back reads 'PROPERTY', and [semen] is dribbling freely out of both of [his of M] holes[end if].";
	otherwise if M is lost wench:
		if bukkake fetish is 1:
			if lady fetish is 2, say "This [man of M] is plastered with cum from head to toe, [if K is clothing]wearing stolen [ShortDesc of K] and a white blouse, both of which are as soaked as [he of M] is[otherwise]completely naked except for a white blouse, which is just as soaked as [he of M] is[end if]. [big his of M] lips are caked with a mixture of smudged purple lipstick and [semen], and [his of M] eyes are framed by runny, streaked eye shadow. [big he of M] has pale white skin, a beach blonde ponytail, and a look of genuine defeat and exhaustion on [his of M] face.";
			otherwise say "This [man of M] is plastered with cum from head to toe, [if K is clothing]wearing stolen [ShortDesc of K] and a white blouse, both of which are as soaked as [he of M] is[otherwise]completely naked except for a white blouse, which is just as soaked as [he of M] is[end if]. [big his of M] lips are caked with a mixture of smudged [one of]gold[or]red[or]pink[or]purple[sticky random] lipstick and [semen], and [his of M] eyes are framed by runny, streaked eye shadow. [big he of M] has pale white skin, a beach blonde ponytail, and a look of genuine defeat and exhaustion on [his of M] face.";
		otherwise:
			if lady fetish is 2, say "This [man of M] is wearing [if K is clothing]a [ShortDesc of K] and [end if]a white blouse, which is totally soaked through. [big his of M] eyes are framed by runny, streaked eye shadow, and [his of M] purple lipstick is unevenly smudged around the corners of [his of M] mouth. [big he of M] has pale white skin, a beach blonde ponytail, and a look of genuine defeat and exhaustion on [his of M] face.";
			otherwise say "This [man of M] is wearing [if K is clothing]a [ShortDesc of K] and [end if]a white blouse, which is totally soaked through. [big his of M] eyes are framed by runny, streaked eye shadow, and [his of M] [one of]gold[or]red[or]pink[or]purple[sticky random] lipstick is unevenly smudged around the corners of [his of M] mouth. [big he of M] has pale white skin, a beach blonde ponytail, and a look of genuine defeat and exhaustion on [his of M] face.";
	otherwise:
		if bukkake fetish is 1:
			if lady fetish is 2, say "This [man of M] is wearing a white blouse with a bra underneath it. [big he of M] is [if K is clothing]also wearing a [ShortDesc of K], which are messy with the pearly white ejaculate covering [him of M] from head to toe[otherwise]otherwise completely naked, leaving you sure there isn't an inch of [his of M] body that's not plastered with pearly white ejaculate[end if]. In fact, if there's a clean part of [his of M] body, it's [his of M] face, which is caked with heavy makeup that's been smudged in only a few places. [big his of M] hair has been drawn back into a beach blonde ponytail, leaving you an impression of a sissy slut on the way back from a night on the town.";
			otherwise say "This [man of M] is wearing a white blouse, which looks like it was pulled open rather roughly to expose [his of M] breasts. [big he of M] is [if K is clothing]also wearing a [ShortDesc of K], which are messy with the pearly white ejaculate covering [him of M] from head to toe[otherwise]otherwise completely naked, leaving you sure that there isn't an inch of [his of M] body that isn't plastered with pearly white ejaculate[end if]. In fact, if there's a clean part of [his of M] body, it's [his of M] face, which is caked with heavy makeup that's been smudged in only a few places. [big his of M] hair has been drawn back into a beach blonde ponytail, and the look on [his of M] face is somewhere between arousal and total exhaustion.";
		otherwise:
			if lady fetish is 2, say "This [man of M] is wearing a white blouse with a bra underneath it. [big he of M] is [if K is clothing]also wearing a [ShortDesc of K], pulled aside[otherwise]otherwise completely naked,[end if] with [semen] dribbling freely from [his of M] exposed [asshole]. [big he of M] has the words 'sissy slut' tattooed across [his of M] cheek. [big his of M] long, beach blonde ponytail and heavily decorated face leave the impression of a sissy slut back from a night on the town.";
...
This is the spawn initial wench rule:
	...
	if the number of alive wenches is 0:
		let M be a random dungeon dwelling wench;
		if M is monster, summon M in the dungeon.
...
To compute unique periodic effect of (M - wench):
	let R be 70;
	if the class of the player is maid, now R is 45;
	if M is horny-wench, decrease R by 20;
	let N be the remainder after dividing the creampieTimer of M by R;
	if the creampieTimer of M > 0, decrease the creampieTimer of M by 1;
	if N is 0:
...
To compute (M - a monster) stomping (N - a wench):
	if M is in the location of the player:
		say "With lightning speed [NameDesc of M] grabs [NameDesc of N] and starts fucking [his of N] ass furiously. [big he of N] screams in both pleasure and terror and [he of M] starts coming inside [his of N] within seconds. [his of N] belly expands in front of [his of N] as [he of M] fills [his of N] up. After [he of N] is full, [NameDesc of M] tosses [him of N] to the ground, where [he of N] promptly faints.";
...
This is the wench obeys guard rule:
	...
	if there is an awake royal guard in the location of the player and the health of N < the maxhealth of N and the class of the player is not the princess:
		if the guard-obedience of N is 1:
			...
			otherwise:
				...
				otherwise if a random number from 1 to 2 is 1 and M is penetrating a fuckhole:
					...
					otherwise:
						say "[speech style of M]'You! Ride [his of the player] face.'[roman type][line break][BigNameDesc of M] barks the order and [NameDesc of N] obeys, getting on [his of N] knees facing away from you and pushing [his of N] ass into your face.";
		...
		rule succeeds;
	otherwise if the guard-obedience of N is 1:
...
To say SpitroastPrep of (M - a monster) with (O - a wench) in (F - vagina):
	...
	otherwise say "The [O] grabs your legs and pushes them nice and wide as [NameDesc of M] moves into position.".
...
To say SpitroastPrep of (M - a monster) with (O - a wench) in (F - asshole):
	...
	otherwise say "The [O] pulls your leg out of the way as [NameDesc of M] moves into position.";
...
To say FoursomePrep of (M - a monster) with (N - a monster) and (O - a wench) in (F - asshole):
	...
	otherwise say "The [O] grabs one of your legs, pulling it towards [him of O] as [NameDesc of M] moves into position.".
...
To compute unique death of (M - a wench):
	...
	if the health of M <= 0:
		if white-bodice is off-stage:
			now white-bodice is in the location of the player;
			if M is horny-wench:
				if bukkake fetish is 1, now the semen-soak of white-bodice is 10;
				otherwise now the water-soak of white-bodice is 10;
			otherwise:
			...
			say "[big he of M] [if M is awake]drops to the ground, dead[otherwise]stops breathing[end if]. [big his of M] body disappears, leaving the [white-bodice] [he of M] was wearing.";
			compute autotaking white-bodice;
		otherwise:
			say "[big he of M] [if M is awake]drops to the ground, dead[otherwise]stops breathing[end if]. [big his of M] body disappears.";
			loot M.
...
To say DominationReaction of (M - a wench) to (N - a monster):
	...
	otherwise:
		if M is unfriendly:
			say "[line break][speech style of M]'Uh, I just remembered something. Lets hash things out later.'[roman type][line break][BigNameDesc of M] turns to walk away.";
			Bore M;
			now the scared of M is 30;
		otherwise:
...
To compute failed dominance punishment of (M - a wench):
	if (the size of penis is 0 or the saved appearance of the player >= 8) and M is not objectifying the player and the times-dominated of M < a random number between 1 and 3:
		...
		if a random number between 1 and 2 is 1:
			...
			Calm M;
		otherwise:
			say "[speech style of M]'Ugh. Just stay away from me or I'm going to make you fucking regret it.'[roman type][line break][BigNameDesc of M] kicks you hard in the ribs and leaves you alone.";
			PainUp 1;
			FavourDown M by 3;
			Bore M;
...
To suggestFucker (F - a body part) for (M - a wench):
	if F is penis:
		if watersports fetish is 1 and the player is desperate to pee:
			say "Do you want to give [him of M] a mouthful of urine?";
			if the player is consenting:
				now player-fucker is F;
				now player-fuckchoice is FUCK-WATERSPORTS;
		if player-fucker is face:
			say "Do you want to fuck [his of M] [unless lady fetish is 2][vagina][otherwise][asshole][end if]? It might not be easy...";
			if the player is consenting:
				now player-fucker is F;
				now player-fuckchoice is FUCK-PENETRATION;
		if player-fucker is face:
			let S be a random worn strapon-panties;
			say "Do you want to see if you can make [him of M] suck your [if S is clothing][S][otherwise][player-penis][end if]?";
			if the player is consenting:
				now player-fucker is F;
	...
	otherwise if F is a fuckhole:
		if F is vagina and watersports fetish is 1 and the player is desperate to pee:
			say "Do you want to give [him of M] a golden shower?";
			if the player is consenting:
				now player-fucker is F;
				now player-fuckchoice is FUCK-WATERSPORTS;
...
To oral dominate (M - a wench):
	...
	otherwise if sexual-penis-length > 6:
		...
		if player-fuckchoice is FUCK-WATERSPORTS:
			...
			SportsGet;
		otherwise:
			say "Pleasure explodes up your [SexShaft] as tiny movements of [his of M] tongue push you to the brink of orgasm in no-time-flat. You barely manage to grunt before you go over the edge, involuntarily bucking your hips as you unload straight down [his of M] throat. [if the throatskill of the player is 1][big he of M]'s clearly had a lot more practice than you have, because [end if][big he of M]'s able to hold the position for the full duration of your orgasm, sitting up gracefully as your softening [sexual-player-penis] slips out of [his of M] mouth.";
			BlowGet;
			orgasm;
			slightDignify;
...
To say AfterDominationComment (N - a number) of (M - a wench):
	...
	otherwise if N is 1:
		say "[speech style of M]'[one of]FUCK that was good[or]That was actually kind of great[or]That felt so fucking good. Wow[in random order]...maybe I'll give you some space next time I see you.'[roman type][line break]";
	otherwise if N is 2:
	...
	otherwise if N is 4:
		say "[speech style of M]'[one of]Now, you can tell everybody we had sex[or]Now you can at least say you came inside me[or]Now its almost like we had sex[in random order]! FYI, I only did this because I pity you. I don't plan on doing that next time.'[roman type][line break]";
	otherwise if N is 5:[in this case, your penis is probably huge, so she's probably not aggressive]
		say "[speech style of M]'[one of]...We both know you're in charge.'[or]...You don't have to be so rough, you know.'[or]...At least be a little gentler next time.'[in random order][roman type][line break]";
	otherwise if N is 6:
...
To say AssistanceRejected of (M - a wench) with (N - a monster):
	...
	otherwise:
		if the size of penis > 8 and M is friendly:
			say "[speech style of M]'[one of]Haha, a dick that big and its still useless!'[or]Donkey dick and you're still getting fucked. Haha wow.'[at random][roman type][line break]";
			alwayscutshow figure of wench interact 9 for M;
		otherwise:
...
To say TauntAccepted of (M - a wench):
	if the size of penis <= 3 and the player is male:
		say "[speech style of M]'Nevermind! I don't wanna be humiliated again![roman type][line break][BigNameDesc of M] begins to run away!";
...
To compute desperate drinking to (M - a wench):
	say "[if M is uninterested]You spot a [M]! [otherwise]You look at [NameDesc of M] hungrily. [end if]Your thirst combined with your new found love of the taste of [semen] means you can't help but go up to the girl, get on your knees and start licking at [his of M] crotch. You are rewarded by [his of M] sighs of pleasure, and a flood of girlcum and [semen]! You gulp it down greedily.";
	alwayscutshow figure of wench interact 8 for M;
...
To set up (M - a workaholic wench):
	reset M;
	now the monstersetup of M is 1;
	now the difficulty of M is 10;
	now the creampieTimer of M is 300;
	now the health of M is the maxhealth of M;
	if the player is not an april 2019 top donator, now M is off-stage.

Definition: A workaholic wench is dungeon dwelling:
	decide no.

Definition: A workaholic wench is hotel dwelling:
...
To say MonsterDesc of (M - workaholic wench):
	let K be a random knickers retained by M;
	if bukkake fetish is 1:
		say "This [man of M] has dozens of hatch marks next to [his of M] mouth, [if lady fetish is 2]and [asshole][otherwise][asshole], and [vagina][end if], and from [his of M] [if lady fetish is 2]effeminate[otherwise]voluptuous[end if], jizz-coated figure, its not hard to guess how [he of M] might have earned them. [big he of M]'s wearing a cum-soaked white blouse[if K is clothing] with a [printed name of K][end if], and you can see the words 'Free Ride' tattooed across [his of M] right cheek. [big he of M] looks a little exhausted.";
	otherwise:
		say "This [man of M] has dozens of hatch marks next to [his of M] mouth, [if lady fetish is 2]and [asshole][otherwise][asshole], and [vagina][end if], and from the way [semen] is leaking from [if lady fetish is 1][his of M] hole[otherwise][his of M] holes[end if], its not hard to guess their significance. [big he of M]'s wearing a soaking wet white blouse[if K is clothing] with a [printed name of K][end if], and you can see the words 'Free Ride' tattooed across [his of M] right cheek. [big he of M] looks a little exhausted.".

To say WhereAnswer of (M - workaholic wench):
	say "[speech style of M]'[if the class of the player is hotel employment]Our place of work. The boss is a real asshole.'[otherwise]My place of work. Its true, there are no benefits, and the customers treat you like dog shit, but somebody's gotta turn the tricks around here. Might as well be us, right?'[end if][roman type][line break]";
	alwayscutshow figure of wench interact 5 for M.

To say WhoAnswer of (M - workaholic wench):
	say "[speech style of M]'[if the class of the player is hotel employment]Well, on the employment papers it says I'm a maid, but who am I kidding? There's only one thing wusses are useful for.'[otherwise]My name's Dee, [please]d to meet you.'[end if][roman type][line break]";
	alwayscutshow figure of wench interact 7 for M.
...
To say AdviceAnswer of (M - workaholic wench):
	say "[speech style of M]'[one of]Depending on what you're wearing, you can earn more when you're servicing customers.'[or]You know that pimp that shows up after your first couple tricks? Well, he doesn't actually work here. Don't be afraid to kick his ass.'[or]Condoms are unreliable sometimes, but they're usually better than going without.'[or]That wrestler doesn't really care too much about winning or losing. She just wants to have fun.'[or]Customers hate it when you don't play along. Even if you feel like you're not in the mood for a gangbang, you should probably just let it happen. You make more money that way, you know?'[or]You know the mechanic? I think [he of mechanic]'s hiding something.'[at random][roman type][line break]";
	alwayscutshow figure of wench interact 2 for M.
