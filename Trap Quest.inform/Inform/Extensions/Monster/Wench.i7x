...
To say DiaperReaction of (M - a wench):
	if there is a currently visible diaper or the player is shameless:
		...
		otherwise:
			...
			FavourDown M by 1;
		if the player is modest, say "[variable custom style][if the player is able to speak]'This doesn't usually happen, I swear!'[otherwise]I can't even tell her that this isn't what I usually wear![end if][roman type][line break]";
...
To compute kneeling reaction of (M - a wench):
	if the guard-obedience of M is 0:
		say "[one of][BigNameDesc of M] walks over to you, momentarily stopping the flow of cum out of [his of M] [HoleDesc of M] by cupping a hand to her entrance.[or][BigNameDesc of M] gently fingers herself as [he of M] strides over to you, grinning as [semen] slowly leaks through [his of M] fingers.[or]A grin spreads across [NameDesc of M]'s plastered face as [he of M] cups [his of M] hand to [his of M] [HoleDesc of M], stopping the flow of [semen] down [his of M] legs.[or][BigNameDesc of M] grins, pointing at the thick glob of [semen] rolling down [his of M] leg, and then at you.[or][BigNameDesc of M] looms over you, [his of M] cum dripping [HoleDesc of M] level with your head. She leers down at you, grinning.[in random order]";
...
To compute unique death of (M - a wench):
	...
	if the health of M <= 0:
		if white-bodice is off-stage:
			...
			say "[big he of M] [if M is awake]drops to the ground, dead[otherwise]stops breathing[end if]. [big his of M] body disappears, leaving the [white-bodice] she was wearing.";
...
To female dominate (M - a wench):
	...
	otherwise:
		...
		otherwise:
			...
			otherwise:
				say "Pulling your [AssDesc] apart, you position your [vagina] over her mouth and your [asshole] over her nose, cutting off her airflow. She squirms petulantly, weakly clawing at your thighs to try and make you get up, but fails because she is weakened from the preceding fight. Reluctantly, she opens her mouth and pushes her tongue into your folds. You take the opportunity to play with her breasts, pinching and rubbing her nipples until they are tight and red. She doesn't forget about your clit, gently pushing it back and forth in hopes of making you orgasm. It feels good, but eventually you grow bored and climb to your feet.";
				slightDignify;
		say AfterDominationComment 9 of M;
	LickGet.
...
To say TauntAccepted of (M - a wench):
	if the size of penis <= 3 and the player is possessing a penis:
...
To say TauntRejected of (M - a wench):
	if the size of penis <= 3 and the player is possessing a penis and penis is lewdly exposed and the player is feeling dominant and the player is gendered male:
