...
To set up (M - a wench):
	...
	[#LXorDD If the Game Hates You, there's a 1 in 20 chance a wench will have a dick-detaching portal ring hidden in her mouth (let's say, tucked into her cheek). But there will only ever be max-wench-detachers of such wenches. Currently 1. Note that wenches never know how to reattach a dick.]
	if tough-shit is 1 and max-wench-detachers > 0 and a random number between 1 and 1 is 1:
		say "Uh-oh, ####Selkie forgot to change 1 back to 20: now you're in trouble!";
...
To blowjob dominate (M - a wench):
	if sexual-penis-length > 8:
		...
		otherwise:
			...
			otherwise:
				say "forward, a silvery cock ring lewdly centered in [his of M] gaping wide mouth. Kinky! For a moment you wonder what it might be, ";
				compute detach-players-dick by M using 1 instead;
