...
To say MonsterDesc of (M - a wench):
	...
	otherwise:
		...
		otherwise:
			say "This woman is wearing a white blouse, which looks like it was pulled open rather roughly to expose her breasts. She is [if K is clothing]also wearing a [ShortDesc of K], pulled aside[otherwise]otherwise completely naked,[end if] with [semen] dribbling freely from her exposed [vagina] and [asshole]. Her hair has been drawn back into a [HairColour of M] ponytail, and the look on her heavily decorated face is somewhere between arousal and total exhaustion.";
...
To say HairColour of (M - a wench):
	say "bleach blonde".
...
To say DominanceSuccess of (M - a wench):[TODO: eventual penetration]
	if the size of penis > 8:
		...
		otherwise:
			say "You force [NameDesc of M] to her knees. She [if the times-dominated of M > 0]lazily opens her mouth, staring at your [manly-penis] and fondling her breasts as she robotically licks her lips. Her expression slowly changes to one of fear[otherwise]tentatively opens her mouth and begins to fondle her breasts, eyeing your [manly-penis] as if it were rare breed of venomous snake. Her expression grows even more uncertain[end if] as your [ShortDesc of penis] reaches its full size, and she backs away a bit as your erection nears her lips. She's silent for a moment, [if M is horny-wench]before grabbing it with both hands and eagerly guiding[otherwise]then slowly reaches out with one hand, guiding[end if] your [manly-penis] into her mouth. You feel her tongue move skilfully over the underside of your shaft, gently lubricating it as it reaches down her throat. She does such it with such precision and control that you can't bear the thought of interrupting, [run paragraph on]";
	...
	otherwise if the size of penis > 3:
		...
		say "[AfterDominationComment 1 of M]";
	otherwise if the size of penis > 0:
		say "[if the player is a bit horny]You force [NameDesc of M] to her knees, pushing your fully erect [ShortDesc of penis] into her face.[otherwise]You force [NameDesc of M] to her knees, stroking your [ShortDesc of penis] to a full, unimpressive erection.[end if]";
		if the player is desperate to pee and watersports fetish is 1:
