...
To say MonsterDesc of (M - supporter-ai):
	say "This [man of M] looks like the epitome of a blonde bimbo. [big he of M]'s completely naked, [if lady fetish is 2]aside from a neon-pink chastity cage around [his of M] [sissy-penis][otherwise][his of M] giant M-cup tits somehow not sagging as much as they should, either thanks to implants or magic[end if]. [big his of M] huge, visibly enhanced cock-suckling lips are coloured a deep shade of pink and two hoops with hears in the centre hang from [his of M] earlobes. [big his of M] medium length blonde hair is kept in a ponytail by a tight pink scrunchie.".
...
To say SelectionFrustrated of (M - supporter-critchett): [The NPC has got tired of waiting!]
	say "[BigNameDesc of M]'s eyes widen vastly. [big he of M] heaves a lengthy, spent moan as [his of M] diaper brings [him of M] to cum way too hard this time.[line break][speech style of M]'Ugh, well. Maybe I'll find you later on when I've warmed back up...'[roman type][line break]";
	bore M.
...
To say ClothesPeeReaction of (M - supporter-critchett):
	if M is friendly:
		...
		FavourDown M by 2;
		if M is unfriendly, say "[big he of M] sizes you up before coming to a decision.[line break][speech style of M]'It's too late for you to be a big [boy of the player] any more. I'm going to have to show you what a diaper is for, missy!'[roman type][line break]";
	otherwise:
...
To say BecomesAggressive of (M - supporter-teagan):
	say "[speech style of M]'[one of] ! You better drink it, slut!'[or]Gawd, my tits are, like, so full! I can't take it any more!'[in random order][roman type][line break][big he of M] assumes an aggressive stance!";
