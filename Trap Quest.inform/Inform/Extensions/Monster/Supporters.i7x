...
To say MonsterDesc of (M - supporter-aika):
	say "A terrifying blonde [man of M] stands before you. [big he of M]'s wearing medieval metal bracers on [his of M] arms and legs, and wields a barbaric-looking shortsword[if lady fetish < 2]. [big his of M] huge H-cup breasts are completely bare and sit heavily on [his of M] chest, hanging away from each other in a way that lets you know they're almost certainly natural[end if]. [big his of M] tiny grey loincloth does nothing to hide the [LongDickDesc of M] and balls hanging from [his of M] crotch, swaying gently as [he of M] moves. A metal warlord's mask covers [his of M] face, preventing you from seeing [his of M] features or expression.".
...
To say DamageReactHealthy of (M - supporter-aika):
	say "[BigNameDesc of M] hums merrily to [himself of M] as she fights.".
...
To say CurtseyReactionFlav of (M - supporter-misako):
	...
	otherwise say "[BigNameDesc of M] wrinkles [his of M] nose.[line break][speech style of M]'Yes, I get it, you can play with yourself whenever you want. Please don't taunt me!'[roman type][line break]".
