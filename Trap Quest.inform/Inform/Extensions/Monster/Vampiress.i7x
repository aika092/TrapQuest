...
vampiress is a monster. vampiress is intelligent. vampiress is male. The poison-status of vampiress is -1.

Definition: vampiress (called M) is willing to do vaginal:
	decide no.

Definition: vampiress (called M) is willing to do titfucks:
	decide no.

Definition: vampiress (called M) is raunchy:
	decide yes.
...
Definition: a vampiress (called M) is always-feminine:
	decide yes.
...
To say MonsterDesc of (M - vampiress):
	if lady fetish is 2, say "A monstrous, seductive looking man with flowing golden brown hair and sharp fangs. He's wearing a cape and a linen loincloth. The look in his eyes suggests he's outrageously turned on.";
	otherwise say "A monstrous, seductive looking woman with flowing, golden brown hair and sharp fangs. She's wearing a skirted black and red corset. The look in her eyes suggests that she's outrageously turned on.".
...
Definition: vampiress (called M) is able to remove cursed plugs:
	decide yes.
...
To decide which number is the semen load of (M - vampiress):
	decide on 3.

Definition: vampiress (called M) is human:
	decide yes.
...
To say MercyReaction of (M - vampiress):
...
To say SexSubmissionFlav of (M - vampiress):
	if M is penetrating face:
		...
		otherwise if the oral sex addiction of the player < 4:
			say "[one of]You slowly move your head back and forth, ashamed of what you've become and yet, for some reason, enjoying this action against your will.[or]You reluctantly suckle the vampiress's pulsating [DickDesc of M], amazingly finding the experience disturbingly delightful.[or]You bob your head back and forth, trying glare upward defiantly. Somehow, your body translates this into staring up lovingly.[or]You reluctantly but passionately suck the vampiress's [DickDesc of M], cheeks red with shame.[in random order]";
		otherwise if the oral sex addiction of the player < 7:
			say "[one of]You finger the vampiress's slit as you joyously suckle [his of M] [DickDesc of M].[or]You fellate the vampiress with restrained enthusiasm, getting more into this than you thought possible.[or]You bob your head back and forth, trying to convince yourself you're not enjoying it. Even you can't begin to believe your lies.[or]You slowly and obediently stroke the vampiress's [DickDesc of M] as you pull back and tease it with your tongue.[or]You move your head back and forth, dragging your tongue along the bottom of [his of M] [DickDesc of M].[in random order]";
		otherwise:
			say "[one of]You passionately pump the vampiress's [DickDesc of M] as you bob your head back and forth.[or]You fellate the vampiress with unrestrained enthusiasm.[or]You suck the vampiress's [DickDesc of M] like the hungry cumslut you are.[or]You aggressively fellate the vampiress, emitting muffled moans of contentment.[or]You gaze up at the vampiress lovingly as you eagerly pleasure her [DickDesc of M].[or]You enthusiastically pleasure the vampiress with your mouth and tongue.[or]You pucker your lips and finger her [vagina] as you hungrily suckle her [DickDesc of M].[in random order]";
	otherwise:
...
To say big he of (M - vampiress):
	say "She".

To say he of (M - vampiress):
	say "she".

To say him of (M - vampiress):
	say "her".

To say big his of (M - vampiress):
	say "Her".

To say his of (M - vampiress):
	say "her".

To say himself of (M - vampiress):
	say "herself".
...
To say LongDickDesc of (M - a vampiress):
	if futanari fetish is 0, say "large, gem-encrusted strapon";
...
To say TwosomePrep of (M - vampiress) in (F - asshole):
	if there is a worn chastity cage:
		say "[BigNameDesc of M] smiles, gently pulling your hips up against [his of M] body. [big he of M] [if the times-fucked of M < 1]pulls out a [LongDickDesc of M] from in-between [his of M] legs and pushes it between your cheeks[otherwise]places her [DickDesc of M] between your cheeks[end if], gently rubbing your belly as [his of M] hand moves to your waist.[line break]";
	otherwise:
		say "[BigNameDesc of M] smiles, gently pulling your hips up against [his of M] body. [big he of M] [if the times-fucked of M < 1]pulls out a [LongDickDesc of M] from in-between [his of M] legs and pushes it between your cheeks[otherwise]places [his of M] hard length between your cheeks[end if], gently [if the player is female]pushing [his of M] soft, nimble fingers into your [vagina][otherwise if the size of penis > 4]wrapping [his of M] soft, nimble fingers around your [ShortDesc of penis][otherwise]tracing around your [ShortDesc of penis] with [his of M] nimble fingertips[end if] as [his of M] hand grabs your waist.[line break]".
...
To say PrepTaunt of (M - vampiress) in (F - a fuckhole):
	if the times-fucked of M < 1:
		...
		otherwise say "[speech style of M]'Yes... To answer the question that is most certainly on your mind, in addition to a [vagina], I have a [manly-penis]. I suppose you are about to become a lot more well acquainted with it, aren't you?'[roman type][line break]";
...
To compute unprotected climax of (M - vampiress) in (F - a fuckhole):
...
To compute (M - vampiress) entering mouth:
...
To say MouthPenetrationFlav of (M - vampiress):[TODO: subfunctions]
	if presented-orifice is face:
		say FriendlyMouthPenetrationFlav of M;
	otherwise if there is a worn ringagged clothing:
		say "[one of][BigNameDesc of M] puts [his of M] hand on the back of your head, guiding [his of M] [LongDickDesc of M] through your gag and into your mouth.[or][BigNameDesc of M] slides [his of M] [LongDickDesc of M] through your gag. With no way of resisting[if the relevant sex addiction of M > 12], and no motivation,[end if] you have to sit there and take it as [he of M] begins to aggressively fuck your face.[or][if the relevant sex addiction of M < 7][BigNameDesc of M] slides [his of M] [LongDickDesc of M] through your gag. You emit a muffled grunt of indignation as [he of M] begins to thrust.[otherwise if the relevant sex addiction of M < 10][BigNameDesc of M] slides [his of M] [LongDickDesc of M] through your gag. You emit a muffled grunt as [he of M] begins to thrust.[otherwise]Your eyes roll back in your head as [NameDesc of M] slides [his of M] [LongDickDesc of M] through your gag and into your mouth.[end if][or][if the relevant sex addiction of M < 8]Your eyes widen in horror as [NameDesc of M] slides [his of M] [LongDickDesc of M] through your gag and into your mouth.[otherwise if the relevant sex addiction of M < 13]Your eyes widen with excitement as [NameDesc of M] slides [his of M] [LongDickDesc of M] through your gag and into your mouth.[otherwise][BigNameDesc of M] slides [his of M] [LongDickDesc of M] through your gag. You emit a muffled sigh of satisfaction as [he of M] begins to thrust.[end if][in random order]";
...
To say sexSubmitReflectFlav of (M - vampiress) in (O - an orifice):
	say "[if the relevant sex addiction of M < 6][BigNameDesc of M] plows [his of M] [DickDesc of M] in and out of your [variable O]. It's extra humiliating because you can actually feel yourself enjoying it![otherwise if the relevant sex addiction of M < 10][BigNameDesc of M] slams [his of M] [DickDesc of M] in and out of your [variable O], panting heavily. You tell yourself you're only enjoying it because she's in your head, but [line break][first custom style]both of us know that's not true.[roman type][line break][otherwise][BigNameDesc of M] fucks your [variable O] with fast, hard thrusts. You close your eyes, losing yourself in the pleasure.[end if]".

To say sexSubmitEmbarrassFlav of (M - vampiress) in (O - an orifice):
	say "[if the relevant sex addiction of M < 7]A persistent image of an [variable O] hangs in your mind, being fiercely pounded in time with [NameDesc of M]'s strokes. You don't want to admit it. You [i]want[/i] to deny it...but both of you know who that hole belongs to.[otherwise if the humiliation of the player < 15000]A persistent image of your own [variable O] hangs in your mind, forcing you to watch as [NameDesc of M] gives it the hard fucking [line break][second custom style]it's always deserved.[roman type][line break][otherwise if the relevant sex addiction of M < 10]A persistent image of your own [variable O] hangs in your mind, forcing you to watch as [NameDesc of M] gives it the hard fucking it deserves. The [line break][second custom style]best[roman type][line break]is that you never imagined it would look so good.[otherwise]A persistent image of your own [variable O] hangs in your mind, allowing you to watch as [NameDesc of M] gives your [variable O] the hard fucking it deserves.[end if]";
...
To say sexSubmitSplitFlav of (M - vampiress) in (O - an orifice):
	...
	otherwise if the player is male:
		say "[if the size of penis < 4 and tg fetish >= 1][BigNameDesc of M] ruts you like a [line break][second custom style]QUEEN[roman type][line break]. You can practically feel your manhood slipping away.[otherwise if the size of penis < 4 and the size of penis > 0 and the bimbo of the player < 14][BigNameDesc of M] pounds your [asshole] hard and fast. You can't help feeling a little embarrassed by how [line break][second custom style]cute[roman type][line break]your [ShortDesc of penis] compares to [his of M].[otherwise if the size of penis < 4 and the size of penis > 0][BigNameDesc of M] pounds your [asshole] hard and fast. You feel proud of how [line break][second custom style]cute[roman type][line break]your [ShortDesc of penis] is compared to [his of M].[otherwise if the bimbo of the player < 3][BigNameDesc of M]'s balls repeatedly slap your taint as [his of M] dick pistons in and out of your [asshole], as if to remind you how [line break][second custom style]pointless[roman type][line break]it would be [him of M].[otherwise if the bimbo of the player < 5]Shocks of pleasure ripple through your [manly-penis] as [he of M] pounds your [asshole]. And you thought it was humiliating [i]before[/i]...[otherwise if the bimbo of the player < 7][BigNameDesc of M]'s [DickDesc of M] relentlessly pounds your sensitive prostate, reminding you how humiliating it is to get fucked like a common sex toy.[otherwise if the bimbo of the player < 9]Shocks of pleasure ripple through your [ShortDesc of penis] as [he of M] pounds your [asshole]. It's difficult to resist when it feels this good.[otherwise if the bimbo of the player < 10][BigNameDesc of M]'s [DickDesc of M] relentlessly pounds your sensitive prostate, reminding you that you're a [line break][second custom style]yummy[roman type][line break]faggot for enjoying this.[otherwise if the bimbo of the player < 12]As [NameDesc of M] pistons in and out of your [asshole], [his of M] balls repeatedly slap your taint, as if to remind you how much you [line break][second custom style]obviously[roman type][line break]love getting railed.[otherwise if the bimbo of the player < 14]As [NameDesc of M] pistons in and out of your [asshole], [his of M] balls repeatedly slap your taint, as if to remind you how much you LOVE getting fucked.[otherwise]Shocks of pleasure ripple through your [ShortDesc of penis] as [he of M] pounds your [asshole]. Phew, [he of M] sure knows how to show a girl a good time![end if]";
	otherwise:
		say "[if the player is horny and the relevant sex addiction of M < 10][BigNameDesc of M] fucks your [variable O] hard and fast, knowing without a shred of doubt how desperately wet you are.[otherwise if the player is horny][BigNameDesc of M] fucks your [asshole] hard and fast. [big he of M] pumps [his of M] fingers in and out of your [vagina], ensuring there's no hiding how wet you really are.[otherwise if the openness of vagina > 3][BigNameDesc of M] plunges [his of M] fingers in and out of your [vagina] as [he of M] pounds your [asshole].[otherwise][BigNameDesc of M] gently pumps [his of M] fingers in and out of your [vagina], skilfully stimulating your most intimate reaches as [he of M] fiercely plows your [asshole].[end if]".
...
To say (M - vampiress) mercy sex (N - a number):
	...
	if N is 2:
		say "Everything around you and [NameDesc of M] seems to slow down a bit, dampening yet intensifying the intensity of [his of M] thrusts.";
	if N is 3:
		say "[BigNameDesc of M] slowly plows your [variable O], somehow lowering the intensity without losing any speed or force.";
	if N is 4:
...
To say DamageReaction (N - a number) of (M - vampiress):
...
To compute talk option (N - 1) to (M - vampiress):
...
To say UnfriendlyGreeting of (M - vampiress):
...
To say UnfriendlyResponse of (M - vampiress): 
...
[To say DominantGreeting of (M - vampiress):]
	
[To say SubmissiveResponse of (M - vampiress):]

To say SubmissiveGreeting of (M - vampiress):
...
To say DominantResponse of (M - vampiress):
	if M is friendly:
...
To say midDominanceGreeting of (M - vampiress):
...
To say midDominanceResponse of (M - vampiress):
