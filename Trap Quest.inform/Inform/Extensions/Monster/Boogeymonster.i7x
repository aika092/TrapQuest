...
To compute punishment of (N - boogeymonster-nightmare-magic-marker):
	...
	otherwise:
		...
		say "You open your eyes. You are lying on your back in the [location of the player], but you now have a [change-self tattoo][if cum-when-messing tattoo is worn] and a [cum-when-messing tattoo][end if]! [BigNameDesc of M] is nowhere to be seen.";
	if TG fetish is 2:
