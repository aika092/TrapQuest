...
To compute punishment of (N - boogeymonster-nightmare-courtroom):
	...
	let M be current-monster;
	say "[NightmareStartFlav]";
	say "[first custom style]'[NameBimbo], you stand accused of being a baby unfit for big girl pants. How do you plead?'[roman type][line break]You open your eyes as you hear these words. You find yourself standing at the defence table in a courtroom, the judge, jury, prosecution, bailiff, and audience all staring at you. Before you can fully take in your situation, you instinctively yell [line break][variable custom style]'Not guilty!'[roman type][line break]The judge rolls his eyes and sighs, before ordering the bailiff to take [line break][first custom style]'Our little defendant'[roman type][line break]to the stand. You start to walk towards the witness stand, but immediately stop in your tracks as you finally take in your attire. Not only is your ability to walk heavily impaired by a gigantic diaper around your waist, around it is a pink straitjacket onesie, leaving your arms completely inoperable. Distracted by your clothing, you allow the bailiff to strap you into a giant baby stroller, the court apparently not trusting you to walk your way to the stand. Despite the short distance, the trip to the stand seems impossibly long as you watch the eyes of every member of the jury follow you, knowing that they are all silently judging you - their verdict likely already decided.";
