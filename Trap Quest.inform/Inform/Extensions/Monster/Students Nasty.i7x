...
To say WhereAnswer of (M - student-abbi):
	say "[speech style of M]'[if the rank of the player is 1]Are you literally braindead?'[otherwise]Someone as stupid as you is going to have to guzzle a LOT of cum to make it anywhere in here.'[end if][roman type][line break]".
...
To say WhereAnswer of (M - a nasty student):
	say "[speech style of M]'[if the rank of the player is 1]A place where ugly bitches like you get turned into cute girls like me.'[otherwise]Are you asking for ways to cheat?  You're a real piece of work, aren't you?'[end if][roman type][line break]".
