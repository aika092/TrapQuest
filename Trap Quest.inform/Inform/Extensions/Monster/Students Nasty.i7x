...
student-abbi is a tq-only nasty student.
...
student-katya is a tq-only nasty student.
...
The max-rank of student-katya is 4.
...
To compute appearance assessment of (M - student-katya):
	if the current-rank of M < 4:
		if diaper quest is 1, compute dq bullying of M;
		otherwise compute tq bullying of M;
	otherwise:
...
student-darla is a tq-only nasty student.
...
student-hiroko is a tq-only nasty student.
...
To say MonsterDesc of (M - student-hiroko):
	say "This beautiful Asian [man of M] is wearing nothing but an outfit made out of thin black straps that cover absolutely nothing but [his of M] pussy - [his of M] breasts are on full display. [big he of M] looks at you with unconcealed disgust.".

The current-rank of student-hiroko is 3.
The max-rank of student-hiroko is 5.
