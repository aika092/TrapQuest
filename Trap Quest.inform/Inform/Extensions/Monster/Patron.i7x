...
To say MonsterDesc of (M - a patron): [TODO: change for lady fetish]
...
To compute DQ perception of (M - a patron):
	...
	if there are worn messed knickers:
		say "[speech style of M]'Oh gosh, that smell!  Err, I'll come back later.'[roman type][line break][BigNameDesc of M] leaves the way he came.";
		destroy M;
	otherwise:
...
To say SexSubmissionFlav of (M - a patron):
	...
	otherwise if the number of patrons penetrating a body part is 1:
		if M is penetrating face:
			say "[if the oral sex addiction of the player < 3][one of]You keep your body as still as you can, and reluctantly hold your mouth open. [BigNameDesc of M] thrusts in and out at a slow but steady pace.[or]You take absolutely no pleasure in holding your mouth open and allowing [NameDesc of M] to continue to use it as a masturbatory aid.[or]You remain silent and try to think about other things as [NameDesc of M] continues to fuck your open mouth.[or]You try not to gag as the tip of [NameDesc of M]'s [manly-penis] keeps prodding your tonsils.[or]You hesitantly allow your tongue to gently touch the underside of [NameDesc of M]'s [manly-penis] as he slides in and out of your mouth.[in random order][otherwise if the oral sex addiction of the player < 7][one of]You whimper gently around [NameDesc of M]'s [manly-penis] as he fucks your face.[or]You skilfully caress [NameDesc of M]'s [manly-penis] with your tongue, telling yourself that it's to make sure this is over as quickly as possible.[or]You massage the head of [NameDesc of M]'s [manly-penis] with your lips whilst milking his shaft with your hands. You know you're giving into what the game wants, but also at least this way it won't take too long for him to climax.[or]You take [NameDesc of M] as deep into your mouth as you can manage without gagging. You watch him shiver with glee.[or]You form a perfect O with your lips around [NameDesc of M]'s shaft and hold still in order to allow him to fuck your face steadily.[in random order][otherwise][one of]You move your head back and forth as fast as you can go, whilst massaging [NameDesc of M]'s balls with your hand, trying to coax him to orgasm as powerfully as possible.[or]You guide [NameDesc of M]'s hands to the back of your head, and encourage him to push your head back and forth as roughly as you can master. You love being treated this way![or]You hum gently around [NameDesc of M]'s [manly-penis], trying to please him as much as possible.[or]You gobble down [NameDesc of M]'s [manly-penis], as far down your throat as you can manage. You giggle happily around his member as you watch him shudder with pleasure.[or]You find yourself grinding your crotch against the bed in an attempt to stimulate yourself as you messily massage [NameDesc of M]'s [manly-penis] with your tongue.[or]You maintain constant eye contact with [NameDesc of M] as you pull his [manly-penis] out of your mouth for a moment, and stroke it passionately whilst forcing his entire scrotum into your mouth. You hum happily as you massage his balls with your tongue.[in random order][end if]";
		otherwise if M is penetrating a fuckhole:
			let F be a random fuckhole penetrated by M;
			say "[if the relevant sex addiction of M < 7][one of]You don't want to get any more sore than you already are, so you hold still and try and take it like a champ.[or]You don't want to anger [NameDesc of M], so you just stay completely still and try to relax and let it happen.[or]You cry internally but remain silent and still, trying not to let [NameDesc of M] see your pain.[or]You try not to make a sound as [NameDesc of M] thrusts in and out of your poor [variable F].[or]You grip the bed-sheets as tightly as you can and grit your teeth, as you try to endure the fucking without crying.[in random order][otherwise if the relevant sex addiction of M < 14][one of]You relax your [variable F], convincing yourself that this is fine, because it's just a game.[or]You slightly hesitantly push back against [NameDesc of M], trying to keep him happy.[or]You push your face into the pillow and groan gently. You know you're giving into what the game wants, but also at least this way it won't take too long for him to climax.[or]You find yourself quietly moaning with each thrust of [NameDesc of M]'s [manly-penis] into your [variable F].[or]You allow [NameDesc of M] to guide your hips with his hands, and soon you have fallen into a steady rhythm.[in random order][otherwise][one of]You sigh loudly and push back at [NameDesc of M], encouraging him to keep going.[or]You guide [NameDesc of M]'s hands to your [ShortDesc of hair], and encourage him to roughly hold your head up like this. You love being treated this way![or]You moan lewdly as [NameDesc of M]'s [manly-penis] continues to roughly plunder your [variable F].[or]You hold yourself still and try to unclench your opening as much as possible, to make sure [NameDesc of M] can get balls deep inside.[or]You find yourself gyrating your hips sluttily in an attempt to please [NameDesc of M] even further as he plows his [manly-penis] in and out of your [variable F].[or]You pull forward until just the tiniest bit of the tip of [NameDesc of M]'s [manly-penis] is still inside your [variable F], then suddenly throw your hips backwards so that the entire length of [NameDesc of M]'s [manly-penis] brutally rushes inside. From the sound that [NameDesc of M] makes in reaction, you guess that he almost came instantly from the sensation. You smirk inwardly.[in random order][end if]";
	otherwise if the number of patrons penetrating a body part is 2:
		if there is a patron penetrating vagina and there is a patron penetrating asshole:
			say "[if the relevant sex addiction of M < 7][one of]You find yourself stunned into submission as [NameDesc of M] and his friend use both your [vagina] and [asshole] at the same time.[or]You don't dare more an inch as the intense feelings of being powerfully plowed in both the [vagina] and [asshole] at the same time threaten to overwhelm you.[or]You overcome your temptation to lash out against [NameDesc of M] and his friend, and instead hold perfectly still and pray that your double penetration session will be over soon.[or]Your mind reels as you try to deal with the intensity of having both your lower orifices fucked at the same time. As one pushes in the other pulls out, giving you absolutely no time to mentally steel yourself for the next thrusts.[or]Your legs twitch uncontrollably as you try to hold your hips as still as possible in order to not get seriously injured from this brutal double penetration.[in random order][otherwise if the relevant sex addiction of M < 14][one of]Partially terrified of getting hurt and partially from pleasure, you find yourself not resisting [NameDesc of M] and his friend as they make good use of both of your fuckholes, with no evident concern for your feelings.[or]You slightly hesitantly push back against [NameDesc of M] and his friend, trying to keep them happy.[or]You push your face into the pillow and groan loudly. You know you're giving into what the game wants, but also at least this way it won't take too long for them to climax.[or]You find yourself lewdly yelping with each thrust of [NameDesc of M] and his friend's [manly-penis]s into your [vagina] and [asshole].[or]You allow [NameDesc of M] and his friend to guide your hips with their hands, and soon you have fallen into a steady rhythm.[in random order][otherwise][one of]You mewl lewdly and push back against [NameDesc of M] and his friend, encouraging them to keep going.[or]You squeal submissively as you are overpowered and doubly bred by the two strong men. You love being treated this way![or]You moan lewdly as [NameDesc of M] and his friend's [manly-penis]s continue to roughly plunder your fuckholes.[or]You let out a guttural moan of pure bliss as [NameDesc of M] and his friend suddenly change their rhythm, pushing both of their [manly-penis]s into you as deep as they can go at the same time. You feel impossibly full, and you love it.[or]You find yourself vocally encouraging the patrons as they destroy your holes and frazzle your brain with their brutal fucking.[or]You skilfully move your ass up and down in rhythm with the men, to assist their alternative fucking. One [manly-penis] smoothly slides into your [vagina] as the other slides out of your [asshole], and then vice versa. You shiver with pleasure.[in random order][end if]";
head.[or]You gag loudly as you try to fight against the [manly-penis] in your mouth in vain.[or]You push against [NameDesc of M]'s thighs, trying to get him to slow down.[or]You make offended whines as [NameDesc of M] slams in and out of your mouth, trying to convince both him and yourself that you aren't an enthusiastic cocksucker.[in random order][otherwise][one of]You playfully push against [NameDesc of M]'s thighs, pretending that you're struggling to cope with his girth, to make him feel good.[or]You pretend to try and fight back, just in case anyone running the game is watching.[or]You playfully slap [NameDesc of M]'s butt cheek, as if telling him off for being so rough.[or]You make a show of whimpering and gagging around his [manly-penis], putting your hands on [NameDesc of M]'s stomach and pretending that you can't take any more[or]You playfully graze [NameDesc of M]'s [manly-penis] with your teeth, warning him that he shouldn't be too rough.[or]You give [NameDesc of M] a middle finger and a wink as he fucks your face.[in random order][end if]";
		otherwise if M is penetrating a fuckhole:
			let F be a random fuckhole penetrated by M;
			say "[if the relevant sex addiction of M < 7][one of]You desperately do everything you can to get the [manly-penis] out of your [variable F], but [NameDesc of M] holds you in place.[or]You don't care if [NameDesc of M] gets angry, you refuse to let him cum in your [variable F] without putting up a fight![or]You cry out loud in pain and anger, and try to somehow shake [NameDesc of M] out of your [variable F]. But your attempts are so fruitless he doesn't even realise you're resisting![or]You claw at the bed-sheets, trying to get some grip to pull yourself away from [NameDesc of M], but you can't get enough traction.[or]You try and kick [NameDesc of M] away, but he catches your foot and forces it back down onto the bed.[in random order][otherwise if the relevant sex addiction of M < 14][one of]You fight against [NameDesc of M], trying to ignore the feeling of his throbbing [manly-penis] thrusting in and out of your [variable F].[or]You try and wriggle your way out of [NameDesc of M]'s grip, but it's difficult when your [variable F] is full of his [manly-penis]![or]You clamp your mouth shut, refusing to let [NameDesc of M] hear you moan in pleasure.[or]You growl at [NameDesc of M]. [line break][variable custom style]Oooh!  I am not enjoying this. I am not enjoying this. I am not enjoying this.[roman type][line break][or]You do everything you can to remove the [manly-penis] lodged up your [variable F], but its owner continues to be very insistent that it says firmly inside.[in random order][otherwise][one of]You mewl lewdly and pull away from [NameDesc of M], provoking him into pushing all the way back in with a single powerful thrust.[or]You yelp in pain, pretending to [NameDesc of M] that you're not enjoying the feeling of his [manly-penis] destroying your [variable F].[or]You bend your neck to turn and face [NameDesc of M], and give him a wink as you playfully kick him in the thigh with one leg.[or]You push your shoulders up so that they are above your [HipDesc], giving [NameDesc of M] a much more difficult angle to thrust at. You grin inwardly as he grabs your head and forces it back down onto the bed.[or]You shake your head wildly, pulling against [NameDesc of M]'s grip on your hair. As he pulls your hair back tight in response, you find yourself tingling with pleasure as well as pain.[or]You pull forward until just the tiniest bit of the tip of [NameDesc of M]'s [manly-penis] is still inside your [variable F], then stop. He moves a step forward and the entire length his [manly-penis] brutally back rushes inside your [variable F]. You can't help but shudder in pleasure.[in random order][end if]";
	otherwise if the number of patrons penetrating a body part is 2:
		if there is a patron penetrating vagina and there is a patron penetrating asshole:
			say "[if the relevant sex addiction of M < 7][one of]You thrash around as much as you can, but you can't stop [NameDesc of M] and his friend using both your [vagina] and [asshole] at the same time.[or]You fight against the intense feelings of being powerfully plowed in both the [vagina] and [asshole] at the same time, refusing to lay still.[or]You lash out against [NameDesc of M] and his friend with your arms and legs, but they hold you in place strongly and continue to pump away at your two fuckholes.[or]You gnash your teeth and growl at [NameDesc of M] and his friend but that is all you can manage given your situation. As one pushes in the other pulls out, giving you absolutely no time to mentally steel yourself for the next thrusts.[or]You push against [NameDesc of M]'s face with your hands, desperately trying to escape this brutal double penetration.[in random order][otherwise if the relevant sex addiction of M < 14][one of]You whimper and timidly try to push [NameDesc of M] and his friend away as they make good use of both of your fuckholes, with no evident concern for your feelings.[or]You refuse to push back against [NameDesc of M] and his friend, unconcerned with keeping them happy.[or][BigNameDesc of M] tries to push your face into the pillow but you wrestle against his hold on your neck, as fiercely as you can considering his friend has a firm grip on your wrists.[or]You screech angrily with each thrust of [NameDesc of M] and his friend's [manly-penis]s into your [vagina] and [asshole].[or]You erratically throw your body weight around, trying to prevent them from falling into a steady rhythm.[in random order][otherwise][one of]You shake your body, irritating the patrons trying to use your holes, and earn yourself a stern slap on the cheek. You can't help but grin wildly.[or]You play fight back as you are overpowered and doubly bred by the two strong men. You love being treated this way![or]You scratch and growl playfully as [NameDesc of M] and his friend's [manly-penis]s continue to roughly plunder your fuckholes.[or]You yawn, pretending that you are bored, to try and wind the men up. You are then forced to let out a guttural moan of pure bliss as [NameDesc of M] and his friend suddenly change their rhythm, pushing both of their [manly-penis]s into you as deep as they can go at the same time. You feel impossibly full, and you love it.[or]You move your hips around, trying to interrupt their rhythm and piss them off. [BigNameDesc of M] holds you down harder and spits on your face. This just makes you even more turned on.[in random order][end if]";
		otherwise if there is a patron penetrating a fuckhole and there is a patron penetrating face:
...
To compute SelectionWaiting of (M - a patron):
	...
	otherwise if the sex-length of M > 0:
		if the wanking-target of M is arms or the wanking-target of M is belly, say "You continue to [if the player is not a pervert or the reaction of the player is 0]reluctantly [end if][one of]stroke[or]pump[or]wank[or]jerk off[at random] [NameDesc of M]'s [manly-penis] with your [wanking version of the wanking-target of M].";
		otherwise say "[BigNameDesc of M] continues to [if the player is not a pervert]masturbate[otherwise]get himself off[end if], rubbing the head of his [manly-penis] up against your [wanking version of the wanking-target of M].";
		decrease the sex-length of M by a random number between 0 and 1;
	otherwise:
		say "Suddenly you hear [NameDesc of M] groaning as he explodes [if the wanking-target of M is arms or the wanking-target of M is belly]inside your[otherwise]onto your[end if] [wanking version of the wanking-target of M]. ";
...
To compute facial dodging of (M - a patron):
	...
	otherwise:
		say "Due to the other patron[if the number of patrons penetrating a body part > 2]s[end if] using your body, you are completely unable to do anything to stop [NameDesc of M] as he pulls out and points his [manly-penis] at your [ShortDesc of face].";
...
To say CondomPieFlav of (M - a patron) in (F - a fuckhole):
	say "[one of]The [if C is clothing][printed name of C]keeps your [ShortDesc of breasts] pushed together around [NameDesc of M]'s[otherwise][M] keeps your [ShortDesc of breasts] pushed together around his[end if] [manly-penis] as he thrusts between them.[or][BigNameDesc of M] seems a bit frustrated as he continues to powerfully thrust between your [ShortDesc of breasts]![or]Your [ShortDesc of breasts] jiggle[if the largeness of breasts > 10] obscenely[end if] as [NameDesc of M] continues thrusting between them![or][BigNameDesc of M] grunts with annoyance as [he of M] roughly thrusts between your breasts.[or][BigNameDesc of M] holds you by the wrists, keeping your [ShortDesc of breasts] wrapped around [his of M] [manly-penis] as [he of M] thrusts between them.[in random order]".

To say TitfuckReceiveFlav of (M - a patron):
	say "[one of][BigNameDesc of M] continues to enthusiastically thrust in between your [ShortDesc of breasts]![or]You [if the titfuck addiction of the player < 4]hesitantly[otherwise]eagerly[end if] continue pumping his [manly-penis] with your [ShortDesc of breasts].[or]You continue to massage his [manly-penis] with your [ShortDesc of breasts].[or]You stare at [his of M] [manly-penis] [if the titfuck addiction of the player < 5]with undisguised disgust[otherwise if the titfuck addiction of the player < 10]with what you decide is curiosity[otherwise]with barely contained hunger[end if] as it thrusts between your [ShortDesc of breasts].[or][BigNameDesc of M]'s [manly-penis] gently bumps your chin as he enthusiastically thrusts it between your [ShortDesc of breasts].[or]You [if the titfuck addiction of the player < 5]dejectedly[otherwise]happily[end if] massage the [if the bimbo of the player < 7][line break][first custom style]gross[roman type][line break][otherwise]firm, hard[end if] penis between your [if the largeness of breasts > 10]wobbling[otherwise]jiggling[end if] breasts.[in random order]";
...
To say SpitroastPrep of (M - a patron) with (O - a monster) in (F - asshole):
	say "[BigNameDesc of M] smiles, pulling your hips up against [his of M] body and places [his of M] length between your cheeks. [big he of M] gives your ass a firm squeeze.".

To say ThreesomePrep of (M - a patron) with (N - a patron) in (F - asshole):
	say "The [N] grabs your arm, flipping you over so you're face to face. He grabs your waist, pulling you over onto his stomach as [NameDesc of M] pulls apart your asscheeks. You can feel the tip of the new [manly-penis] poised to enter your unguarded hole.".

To say ThreesomePrep of (M - a patron) with (N - a monster) in (F - asshole):
	say "[BigNameDesc of M] flips you onto your side, so you're facing the [N]. The [N] continues to fuck your [vagina] as [NameDesc of M] spreads apart your asscheeks, positioning his [manly-penis] at your unguarded hole.".

To say FoursomePrep of (M - a patron) with (N - a monster) and (O - a monster) in (F - asshole):
	if N is patron, say Threesomeprep of M with N in F;
	otherwise say "[BigNameDesc of M] flips you onto your side, so you're facing the [N]. The [N] and [O] work together to fuck your [vagina] and mouth as [NameDesc of M] spreads apart your asscheeks, positioning [his of M] [manly-penis] at your unguarded hole."

To say TwosomePrep of (M - a patron) in (F - asshole):
	say "[BigNameDesc of M] smiles, shoving you face down onto the bed and pulling your hips up against [his of M] body. [big he of M] squeezes your ass with one hand, placing [his of M] length between your cheeks.".

To say PrepTaunt of (M - an inexperienced patron) in (F - asshole):
	say "[speech style of M]'[one of]I can[']t believe I[']m really going to get to fuck your butthole!'[or]My [manly-penis][']s about to go in, I hope you[']re ready!'[or]I[']ve always wanted to try it Greek style!'[in random order][roman type][line break]".
...
To say PrepTaunt of (M - an experienced patron) in (F - asshole):
	say "[speech style of M]'[one of]I'm going to assume this isn[']t your first rodeo.'[or]The quality of whores in this establishment is declining. Let me teach you how to take a [manly-penis] up here properly.'[or]Look, I don[']t really have all day.'[in random order][roman type][line break]".

To say PrepTaunt of (M - a patron) in (F - asshole):
...
To say LessTightAssholePenetrationFlav of (M - a patron):
	...
	say "[one of]Your [asshole] so loose that [his of M] [manly-penis] is already in you and thrusting by the time you think to resist. [if O is monster]You sigh and return to servicing the [O],[otherwise]Knowing you weren[']t going to try very hard anyway,[end if] you sit back and try to find a way to enjoy it.[or]You try not to moan as [his of M] penis slides into your [asshole], [if O is monster]shameful noises escaping through the space between your lips and the [O]'s[manly-penis][otherwise]cooing shamefully[end if] as [he of M] smacks your [AssDesc] and begins to thrust.[or]You force yourself to resist, but it doesn[']t matter. Your [asshole] is just too loose. [BigNameDesc of M] grabs your waist as [his of M] balls smack your taint, tightening [his of M] grip and beginning to thrust.[at random]".
...
To say SpitroastPrep of (M - a patron) with (O - a monster) in (F - vagina):
	say "[BigNameDesc of M] smiles, pulling your hips up against [his of M] body. You can feel the shape of [his of M] [manly-penis] against your [vagina] as [he of M] squeezes your [HipDesc] with one hand.".

To say ThreesomePrep of (M - a patron) with (N - a patron) in (F - vagina):
	say "The [N] links [his of M] arms around your waist, pulling you over onto [his of M] stomach. [big his of M] hands migrate to your [BreastDesc] as [NameDesc of M] climbs on top of you, [his of M] [manly-penis] poised to enter your unguarded hole.".
To say ThreesomePrep of (M - a patron) with (N - a monster) in (F - vagina):
	say "The [N] flips you onto your side, so you're facing [NameDesc of M]. The [N] continues to fuck your [asshole] as the newcomer spreads your legs, positioning his [manly-penis] at your unguarded hole.".

To say FoursomePrep of (M - a patron) with (N - a patron) and (O - a monster) in (F - vagina):
	say "The [N] links [his of M] arms around your waist, pulling you off the floor. [big he of N] continues thrusting as [NameDesc of M] kneels down in front of you, brandishing a stiff, hard [manly-penis].".
...
To say TwosomePrep of (M - a patron) in (F - vagina):
	say "[BigNameDesc of M] smiles, shoving you face down onto the bed and pulling your hips up against [his of M] body. You can feel the shape of [his of M] [manly-penis] against your [vagina] as [he of M] squeezes your [HipDesc] with one hand.".

To say PrepTaunt of (M - a patron) in (F - vagina):
...
To say LessTightVaginaPenetrationFlav of (M - a patron):
	say "[if the vaginal sex addiction of the player < 4]You stifle a moan of pleasure as [NameDesc of M]'s [manly-penis] slides into your defenceless hole. He places his hands on your hips, driving inch after awful inch of his [manly-penis] through your labia lips. His grip tightens as he bottoms out, assuring you that he won't let you get away, no matter how much you try.[otherwise if the vaginal sex addiction of the player < 7]You moan in pleasure, fighting the urge to push back against him as [NameDesc of M]'s [manly-penis] slides into your waiting hole. He places his hands on your hips, driving inch after throbbing inch of his big [manly-penis] through your labia lips. His grip tightens as he bottoms out, assuring you that you're in for a good, rough fuck.[otherwise]You moan as loudly as you can, pushing back against him as [NameDesc of M]'s perfectly sized [manly-penis] sinks into your waiting hole. He places his hands on your hips, driving inch after wonderful inch of his [manly-penis] through your labia lips. His grip tightens as he bottoms out, reassuring you that you're in for the good, rough fuck you so desperately want.[end if]".

To say LessLooseVaginaPenetrationFlav of (M - a patron):
	say "[if the vaginal sex addiction of the player < 4]You let out a completely involuntary moan as [NameDesc of M] slides in like a knife through butter, grunting as he bottoms out. He grins as you look over your shoulder, [one of]horrified[or]mortified[purely at random] at the sound that just came out of your mouth. Strong hands grab your hips tightly, removing all hope of escape.[otherwise if the vaginal sex addiction of the player < 7]You let out a somewhat involuntary moan of pleasure as [NameDesc of M] slides in like a knife through butter, grunting as he bottoms out. He grins as you look over your shoulder, embarrassed at how good that felt, but still hungry for more. Strong hands grab your hips tightly, assuring you that your hunger will be sated.[otherwise]His other hand is used to hold the base of his shaft as you guide it into your [vagina]. You shamelessly moan in pleasure as [NameDesc of M] slides in like a knife through butter, grunting as he bottoms out. He grins as you look over your shoulder, licking your lips in hopes that he'll give you the roughest fucking he can. Strong hands grab your hips tightly, assuring you that you'll get the sex you so desperately, desperately need.[end if]".
...
To say MasturbationStartFlav of (M - a patron):
	say "[BigNameDesc of M] leads you to lie on the bed on your back, with your head comfortably on the pillow. He places one hand lovingly on your [if the largeness of breasts > 2][BreastDesc][otherwise]tummy[end if] and [his of M] other hand over [if there is a worn diaper]the crotch of your diaper[otherwise if the player is female]your [vagina][otherwise]your [ShortDesc of penis][end if]!".
	
To say DiaperMasturbationFlav of (M - a patron):
	let D be a random worn diaper;
	say "[BigNameDesc of M] [one of]pushes his fist into the front of your [D], letting you feel the bumps of his knuckles through the padding[or]swirls two fingers around the the front of your [D], as if it was a vagina[or]lightly spanks your [genitals] through the padding of your [D][or]rubs his entire hand in circles over the front of your [D][at random]. [if the player is able to get horny][one of]It feels amazing[or]You can feel yourself getting more and more aroused[or]You shiver with shameful pleasure[in random order].".
...
To say SpankingMercyRejectionFlav of (M - a patron):
	say "[speech style of M]'[if M is pissed off]There's no chance of that, you little brat!'[otherwise]No no baby, I'm determined to get my money's worth today. You'll take what you're given.'[end if][roman type]  [BigNameDesc of M] has an evil smile on his face.".

To say SoftSpankingFlav of (M - a patron):
	say "[BigNameDesc of M]'s resolve weakens, and then he delivers just a few weak blows to your [buttcheeks] with [his of M] hand. [if there is a worn diaper]Your [random worn diaper] softens the blows even further, so that they just feel like gentle pats. [end if][line break][speech style of M]'Well I guess I'll let you off this time, but that was really boring.'[roman type][line break][BigNameDesc of M] lets you go.";
	now M is pissed off;
	compute payment of M.

To say SpankingFlav of (M - a patron):
	say "[BigNameDesc of M] [one of]clearly knows what he's doing, and [or][stopping]delivers [one of]four[or]three[or]five[as decreasingly likely outcomes] well-targeted open-palmed slaps to your [buttcheeks]. [if there is a worn diaper][DiaperSoftenFlav of M][end if]".
...
To compute death of (M - a patron): [Overrides main death function]
	say "[BigNameDesc of M] turns tail and quickly runs out of the room the way he came!";
	loot M;
	say "[BigNameDesc of M] drops a[if dropped-item is emerald]n[end if] [dropped-item][one of] and in his haste to leave he doesn't stop to pick it back up[or][stopping].";
