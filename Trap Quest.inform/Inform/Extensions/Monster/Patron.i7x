...
To compute patronMeeting of (M - toilet) with (P - a patron):
	...
	if patronBarter is 0:
		say "[he of P] whips out [his of P] [DickDesc of P] and [one of]takes an impressively long[or]takes a quick[or]sighs as [he of P] takes a[purely at random] piss into [if the human-toilet-scene of woman-barbara > 1][NameDesc of woman-barbara][']s[otherwise]the poor human toilet's[end if] mouth. [big he of woman-barbara] gargles weakly as [he of woman-barbara] is forced to swallow gulp after gulp after gulp of the hot [urine]. [big his of woman-barbara] belly audibly groans as it is forced to stretch even further.";
...
To say AfterDominationComment (N - a number) of (M - a gross patron):
	...
	otherwise if N is 9:
		if X > 0:
			say "[line break][speech style of M]'Don't go easy on [him of the player]!'[roman type][line break]";
		otherwise:
