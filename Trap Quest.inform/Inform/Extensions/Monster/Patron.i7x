...
To compute patronMeeting of (M - toilet) with (P - a patron):
	...
	if toilet-key is in Holding Pen and the human-toilet-scene of woman-barbara > 1 and the player is able to speak:[###Selkie: what about if I(we?) modify this to use some humiliating begging charade text on Barbara's behalf, for the case where the player can't speak?]
		say "[BigNameDesc of P] wanders into the room! You see [him of P] toying with the key for the toilet bondage in one of [his of P] hands. Do you beg him for the key? ";
...
To compute patronMeeting of (M - a wrestler) with (P - a patron):
	...
	if R is 1 and watersports fetish is 0, now R is 2;
	if M is in the location of the player:
		say "A [MediumDesc of P] walks into the room and makes a beeline for [NameDesc of M]. [big he of M] immediately drops to [his of M] knees, pushing up [his of M] [ChestDesc of M] and eagerly lolling out [his of M] tongue[if R is 1] as [Namedesc of P] showers [him of M] with [urine][otherwise]ejaculates all over [NameDesc of M]'s face[end if].";
	if R is 1 and watersports fetish is 1, UrinePuddleUp 2 in the location of M;
...
To say InstantAnalMasturbationFlav of (O - an object) with (M - a patron) in (C - an object):
	...
	otherwise:
		...
		otherwise:[vaginal]
			say "You reach back[if O is insertable object], pushing the [printed name of O] into your [asshole] and eagerly beginning to fuck yourself[otherwise]and eagerly push your fingers into your [asshole][end if]. All you can think about is how good [NameDesc of V] feels inside you, and you find yourself submitting to him completely as the pleasure builds and builds. It only takes a moment for you realize you're about to cum.".
...
To compute SelectionWaiting of (M - a patron):
	...
	otherwise if the sex-length of M > 0:
		...
		otherwise say "[BigNameDesc of M] continues to [if the player is not a pervert]masturbate[otherwise]get himself off[end if], rubbing the head of [his of M] [DickDesc of M] up against your [wanking version of the wanking-target of M].";
...
To say VeryTightAssholePenetrationFlav of (M - a patron):
	say "Pulling your [AssDesc] apart, [he of M] pushes forward. You arch your back, groaning in pain as [he of M] forces open your sphincter. [if the anal sex addiction of the player < 7]You don't dare to look at him, staring straight downwards as [he of M] forcefully slides [his of M] throbbing [DickDesc of M] into your [asshole]. [big he of M] pushes in painfully slowly, each inch hurting worse than the last until [his of M] [DickDesc of M] is fully embedded within you.[otherwise]You uncontrollably moan in a mixture of pain and pleasure as your [asshole] slowly parts to receive [his of M] hard length. You push back, silently begging him to finish entering you, staring straight downwards as [he of M] forcefully slides [his of M] throbbing [DickDesc of M] into your [asshole]. [big he of M] ignores you and pushes in painfully slowly, each inch hurting even more than the last until [his of M] [DickDesc of M] is fully embedded within you. [big he of M] places [his of M] hands on your hips, holding you tightly in preparation for a brutal, rough fucking.[end if]".
...
To say AfterDominationComment (N - a number) of (M - an inexperienced patron):
	let X be the number of unleashed patrons in the location of the player;
	if N is 1:
		say "[line break][speech style of M]'I can't believe you [if player-fucker is asshole]let me go ass to mouth[otherwise]made me cum that hard[end if]! Here, take this!'[roman type][line break][big he of M] pulls out a piece of jewellery and drops it at your feet.";
		loot M;
...
To say AfterDominationComment (N - a number) of (M - a gross patron):
	let X be the number of unleashed patrons in the location of the player;
	if N < 4:
		say "[line break][speech style of M]'I can't believe you [if player-fucker is asshole]let me go ass to mouth[otherwise]let me creampie your special hole[end if]! Here, take this!'[roman type][line break][big he of M] pulls out a piece of jewellery and drops it at your feet.";
		loot M;
		now M is not pissed off;
	otherwise if N is 7:
