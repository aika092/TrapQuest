...
To compute SelectionWaiting of (M - a patron):
	...
	otherwise if the sex-length of M > 0:
		if the wanking-target of M is arms or the wanking-target of M is belly, say "You continue to [if the player is not a pervert or the reaction of the player is 0]reluctantly [end if][one of]stroke[or]pump[or]wank[or]jerk off[at random] the [M]'s [manly-penis] with your [wanking version of the wanking-target of M].";
		otherwise say "The [M] continues to [if the player is not a pervert]masturbate[otherwise]get himself off[end if], rubbing the head of his [manly-penis] up against your [wanking version of the wanking-target of M].";
...
To say AssholePenetrationFlav of (M - a patron):[TODO: break up using new set of PenetrationFlav functions]
