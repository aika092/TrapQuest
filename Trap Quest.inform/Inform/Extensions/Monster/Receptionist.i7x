...
receptionist is in School01. The description of receptionist is "[ReceptionistDesc]". The text-shortcut of receptionist is "rcp".
...
[To compute unique death of (M - receptionist):
	say "[BigNameDesc of M] drops to the ground, dead. After a couple of seconds, [his of M] body disappears[if armband is off-stage], leaving behind an [printed name of armband][end if].";
