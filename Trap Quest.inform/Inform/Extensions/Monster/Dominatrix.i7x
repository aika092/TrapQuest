...
To say MonsterDesc of (M - dominatrix):
	say "This brunette woman is standing aggressively and it doesn't look like [he of M] messes around. Your eyes can't help but look down past [his of M] black latex outfit to [his of M] crotch, where [he of M] is sporting [StrapOnDesc of M].[line break]".
...
To say SummoningFlav of (M - dominatrix):
	if M is in the location of the player:
		say "The teleportation pad emits a definitive sounding hum, and light fills the room as an imposing looking woman materializes on top of it. [BigNameDesc of M] hums to [him of M]self adjusting [his of M] [LongDickDesc of M] as [he of M] steps off the pad.";
	otherwise:
...
Definition: dominatrix (called M) is objectifying the player:
	...
	if the times-submitted of M > 3 and the blue-balls of M < 1, decide yes;
...
To compute perception of (M - dominatrix):
	...
	otherwise:
		...
		otherwise if the times-submitted of M > 3 and the blue-balls of M < 1:
	...
	if M is grabbing the player:
		...
		otherwise if the number of patrons in the location of the player > 0 and the sex-length of M > 0:
			repeat with N running through patrons in the location of the player:
				...
				otherwise:
					say "[BigNameDesc of N] keeps [his of N] eyes locked with you, stroking [him of N]self steadily.";
		otherwise:
			repeat with N running through patrons in the location of the player:
				if N is penetrating face:
...
To compute facial sex of (M - dominatrix):
	if M is friendly-fucking:
		say "[one of][BigNameDesc of M] aggressively fucks your throat with her [LongDickDesc of M].[or][BigNameDesc of M]'s hips slam into your face, her [LongDickDesc of M] repeatedly striking the back of your throat.[or][BigNameDesc of M] slams her [LongDickDesc of M] in and out of your mouth, forcing you to make a lewd gagging noise with every thrust.[or][BigNameDesc of M] wears a wide grin, mercilessly ramming her [LongDickDesc of M] down your throat.[or]You can[']t help making a lot of noise as [NameDesc of M] slams her [LongDickDesc of M] into the back of your throat.[in random order]";
		let I be 0;
...
To compute unique climax of (M - dominatrix) in (F - asshole):
	say "[BigNameDesc of M][if M is not friendly-fucking], satisfied,[end if] slowly removes her [DickDesc of M] from your [ShortDesc of asshole].";
...
To compute (M - dominatrix) considering (T - a plentiful accessory):
	...
	otherwise:
		...
		if the times-submitted of M > 0 and the blue-balls of M < 1:
...
To compute unique death of (M - dominatrix):
	...
	otherwise:
		say "[big his of M] body disappears[if X is clothing], leaving behind the strap-on she was wearing[end if].";
	if X is clothing:
...
To suggestFucker (F - a body part) for (M - dominatrix):
	if F is penis:
		...
		if player-fucker is face:
			...
			otherwise:
				say "Your [SexDesc of penis] isn't big enough to fuck her properly...";
...
To oral dominate (M - dominatrix):
	...
	if L >= 4:
		...
		if bukkake fetish is 1 and player-fuckchoice is not FUCK-WATERSPORTS:
			say "Satisfied, you shove [him of M] away and wipe your softening [sexual-player-penis] on [his of M] face. [if the times-dominated of M is 0][big he of M] clearly has very little experience being put in [his of M] proper place, but as [he of M] shivers at your feet, trying to catch [his of M] breath, you know [he of M] won't soon forget how it felt to be treated this way[otherwise if the times-dominated of M < 3][big he of M] definitely has a lot more to learn about [his of M] proper place, but as [he of M] rests against the wall with your [load] clinging to [his of M] cheeks, you know [he of M] [']ll definitely be taking a lesson from the experience[otherwise][big he of M] doesn[']t hold onto any pretense of dominance, fingering [him of M]self desperately as [he of M] tries to catch [his of M] breath[end if].";
	otherwise:
...
To anal dominate (M - dominatrix):
	...
	otherwise:
		say "You glance down, at [his of M] unprotected [asshole], and shoot [him of M] a look that says 'Yes, that's exactly where its going.' [run paragraph on]";
	if G < 4:[putting the dildo up the butt]
		say "You pull the dildo out of [his of M] mouth and slide it into [his of M] [asshole], relishing the feeling of slowly fucking her [if the times-submitted of M > 2]with the same toy [he of M] used on you[otherwise]with the same toy you *know* [he of M] was planning to use on you[end if]. [big he of M] endures silently, staring up at you coldly until you begin to lose interest.[line break]";
		increase D by 40;
	otherwise if G < 6:
...
To say PartnerGreeting to (M - dominatrix):
	...
	otherwise:
		...
		otherwise:
			...
			otherwise:
				say "[second custom style]'[one of]Can't you hurry?'[or]You made your point! Now hurry up!'[or]Come on, why are you taking so long? Its not like you can cum with that thing.'[or]Hurry uuuuup!'[at random][roman type][line break]";
