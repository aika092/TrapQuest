...
To say MonsterComment of (M - dominatrix):
	if the strap-on girth of M < 4:
		...
		otherwise:
			say "[second custom style][one of]I[']ll give anyone a blowjob, even a girl![or]I prefer guys, but that strapon looks almost as good as the real thing![or]All [manly-penis]s make [if the size of penis < 1]horny[otherwise]hard[end if], even fake ones![if the size of penis < 1]Between us, there[']s only one penis, but [he of M] probably deserves it way more![otherwise if the size of penis < 8]So that[']s what a real penis looks like. Well, it's plastic, but it's certainly realer than mine. I[']m the girl and [he of M][']s the man! Tee hee![otherwise]My penis is bigger than [his of M] strapon, but hers matters more, since it feels better when I cum with my asshole.[end if][in random order]";
...
To suggestFucker (F - a body part) for (M - dominatrix):
	if F is penis:
		...
		if player-fucker is face:
			...
			otherwise:
				say "Your [SexDesc of penis] isn't big enough to fuck [him of M] properly...";
...
To oral dominate (M - dominatrix):
	...
	if L >= 4:
		...
		if bukkake fetish is 1 and player-fuckchoice is not FUCK-WATERSPORTS:
			say "Satisfied, you shove [him of M] away and wipe your softening [sexual-player-penis] on [his of M] face. [if the times-dominated of M is 0][big he of M] clearly has very little experience being put in [his of M] proper place, but as [he of M] shivers at your feet, trying to catch [his of M] breath, you know [he of M] won't soon forget how it felt to be treated this way[otherwise if the times-dominated of M < 3][big he of M] definitely has a lot more to learn about [his of M] proper place, but as [he of M] rests against the wall with your [load] clinging to [his of M] cheeks, you know [he of M] [']ll definitely be taking a lesson from the experience[otherwise][big he of M] doesn[']t hold onto any pretense of dominance, fingering [himself of M] desperately as [he of M] tries to catch [his of M] breath[end if].";
	otherwise:
...
To anal dominate (M - dominatrix):
	...
	if G < 4:[putting the dildo up the butt]
		say "You pull the dildo out of [his of M] mouth and slide it into [his of M] [asshole], relishing the feeling of slowly fucking [him of M] [if the times-submitted of M > 2]with the same toy [he of M] used on you[otherwise]with the same toy you *know* [he of M] was planning to use on you[end if]. [big he of M] endures silently, staring up at you coldly until you begin to lose interest.[line break]";
		increase D by 40;
	otherwise if G < 6:
