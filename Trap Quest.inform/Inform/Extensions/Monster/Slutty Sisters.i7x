...
Definition: a slutty sister is presenting as male: decide no.
...
To say MonsterDesc of (M - a slutty sister):
	...
	if M is futanari slutty sister:
		say "However, [if futanari fetish is 0]you're pretty sure the foot long, mega thick strapon dildo dangling between [his of M] legs wasn't there before.[otherwise]you're pretty sure that in real life [he of M] didn't have a foot long, mega thick [cock of M] dangling between [his of M] legs.[end if]";
...
To compute kneeling reaction of (M - a futanari slutty sister):
	say "[BigNameDesc of M] stands over you, [his of M] [cock of M] swaying gently like a pendulum. [line break][second custom style]'It's business time.'[roman type][line break]";
	humiliate 75.

To compute kneeling reaction of (M - a bulging slutty sister):
	say "[BigNameDesc of M] shoves two fingers inside [his of M] cunt, and begins to frig [himself of M] gently. [line break][second custom style]'It's dinner time.'[roman type][line break]";
	humiliate 75.
...
To say StrikingSuccessFlav of (M - a futanari slutty sister) on (B - a body part):
	say "[BigNameDesc of M] spins rapidly, thwacking you [TargetName of B] with [his of M] [cock of M]!".
...
To compute (M - a bulging slutty sister) entering mouth:
	...
	say "Facing your forehead, [he of M] covers your nose with the top of [his of M] vagina, and your mouth with [his of M] taint, giving you access to both [his of M] creampied pussy and cum-filled asshole, and cutting off your ability to breathe.[line break][second custom style]'[one of][if the belly contents of M > 10]You've got two options slut, try to swallow it all out of me, or faint trying.'[otherwise]You've got two options slut, bring me to orgasm, or faint trying.'[end if][or]Deja vu, bitch. You know the drill by now. Best of luck this time!'[stopping][roman type][line break]";
	if bukkake fetish is 1:
		say "[big his of M] [semen] starts to seep out of both [his of M] holes and [if the semen coating of face is 0]mess up[otherwise]add to the mess on[end if] your face.[if the semen addiction of the player < 7][line break][first custom style]Fucking hell! Yuck.[roman type][line break][end if][line break]";
...
To say FacesitSubmissionResponse of (M - bulging slutty sister):
	...
	otherwise:
		say "You [one of]flick your tongue along [NameDesc of M]'s clit, causing a squeak of satisfaction from the girl above.[or]give the outside of [NameDesc of M]'s asshole a passionate French kiss, which makes [him of M] writhe around on top of you with pleasure.[or]force your tongue as far as it can go into [NameDesc of M]'s asshole, and [he of M] responds by shuddering in pleasure.[or]You explore the depths of [NameDesc of M]'s pussy with your tongue, pushing it in as deep as you can. [big he of M] groans with pleasure.[in random order]".

To say NearingClimaxFacesit of (M - bulging slutty sister):
	say FacesitSubmissionResponse of M;
	say "[big his of M] pussy spasms rapidly. [big he of M]'s getting close!".
...
To compute facesit climax of (M - a wench):
...
To compute unique climax of (M - a futanari slutty sister) in (F - asshole):
	...
	if delayed fainting is 0, say "[second custom style]'Ugh, you win... I'm done. Phew...'[roman type] [BigNameDesc of M] collapses onto [his of M] ass, [his of M] [cock of M] quickly going limp as [he of M] pulls out.".
...
To compute damage of (M - a futanari slutty sister):
	if the health of M > 0:
		if M is awake:
			...
			otherwise say "[one of][BigNameDesc of M]'s growl is definitely getting weaker. But [his of M] [manly-penis] is just throbbing even harder![or][BigNameDesc of M] grunts with pain.[stopping]";
		otherwise:
			anger M;
			now M is interested;
			now the sleep of M is 0;
			say "Suddenly, [NameDesc of M]'s [cock of M] springs back to a full erection! [big he of M] looks very angry. [line break][variable custom style]Maybe that wasn't such a good idea...[roman type][line break]";
	otherwise:
		compute death of M.
