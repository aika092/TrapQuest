...
A wrestler is a kind of monster. A wrestler is usually intelligent. A wrestler has a number called fingers. The favour of a wrestler is usually 7. The leftover-type of a wrestler is usually 120. A wrestler has a number called excitement. The excitement of a wrestler is usually 0.
...
To say ToiletPeeReaction of (M - a wrestler):
	say "The [M] licks her lips. [line break][speech style of M]'[if watersports fetish is 1]You know, it's unusual getting to watch someone else pee without me being on my knees underneath them[otherwise]Is the big girl trying to prove she doesn't need diapers?  How adorable[end if]!'[roman type][line break]".
...
To say LandingTaunt of (M - a wrestler):
	say "The [M] giggles. [line break][second custom style]'That's it, come here [if weight gain fetish is 1]fatty[otherwise][bitch][end if]...'[roman type][line break]";
	humiliate 50.
...
This is the wrestler monster fucked taunting rule:
	say "[one of][line break][second custom style]'I can't wait until it's my turn!'[roman type][line break]The [current-monster] is getting impatient.[or][or][or][or][in random order]";
	rule succeeds.
...
To compute successful dominance of (M - a wrestler):[She doesn't increase her difficulty until later]
	...
	now the excitement of M is -1;
	say "[line break]The [M] crawls away as soon as she has the strength.[line break]You feel more [if the player is male]manly[otherwise]dominant[end if]!".
