...
This is the spawn initial wrestler rule:
	if the number of alive wrestlers is 0 and diaper quest is 0:
...
To IdentifiablePosterReaction of (M - a wrestler):
	say "[BigNameDesc of M] looks at you, blinks, then looks back to the banner. Upon realising that it is you, she grins widely and gives you a sly wink.";
...
To compute kneeling reaction of (M - a wrestler):
	say "[one of][BigNameDesc of M] stands over you, a smug grin clearly visible through her latex hood. [or][BigNameDesc of M] stands over you, her eyes shining with glee through the holes in her latex hood. [or]You hear an excited chuckle escape her lips. [or][BigNameDesc of M] looms over you. She leers down at you, grinning. [in random order]";
...
To compute (M - a wrestler) diving into (F - a fuckhole):
	...
	otherwise if the fingers of M is 5:
		say "[BigNameDesc of M] slides all four of her fingers [italic type]and[roman type] her thumb into your [variable F], all the way up to her knuckles. She can't manage to push it in any further than that!";
		if image cutscenes is 1 and the player is female, display figure of wrestler fingers 5;
	otherwise:
		say "[BigNameDesc of M] slides all four of her fingers [italic type]and[roman type] her thumb into your [variable F], all the way up to her knuckles. She keeps pushing with all her might, and all of a sudden, her whole fist slides in!";
		if image cutscenes is 1:
	...
	if the fingers of M > old-fingers:
		if the fingers of M is 6:
			...
			if image cutscenes is 1:
				...
				otherwise display figure of wrestler fingers 6;
		otherwise:
			say "[BigNameDesc of M], having loosened you up, finds room for another finger!  She now has [fingers of M] fingers inside your [variable F]. She continues her furious thrusting!";
			if image cutscenes is 1:
...
To say StrikingFlav of (M - a wrestler) on (B - a body part):
	say "[BigNameDesc of M] grapples you, gripping your [if B is breasts][BreastDesc][otherwise]waist[end if] tightly!  She throws you into the close-by wall!  Oof. ".
...
To say OralSubmissionResponse of (M - a wrestler):[This is only called if the player is not currently getting fucked by a patron.]
	if the size of penis > 6:
		say "[one of][BigNameDesc of M] slurps away at your [ShortDesc of penis], moaning to herself as her tongue strokes your throbbing length.[or][BigNameDesc of M] eases your [ShortDesc of penis] into her throat, pleasuring you with expert movements of her tongue and neck.[or][BigNameDesc of M] makes noisy slurping noises as she works your shaft from below.[or][BigNameDesc of M] sucks your [manly-penis] with unbridled enthusiasm.[or][BigNameDesc of M]'s nose bumps your sack as she works your [manly-penis], stimulating it with expert movements of her tongue and throat.[at random]";
	otherwise if the size of penis > 2:
		say "[one of][BigNameDesc of M] slurps away at your [Shortdesc of penis], teasing your most sensitive parts with her tongue.[or][BigNameDesc of M] keeps her lips firmly sealed to the base of your [manly-penis], mercilessly pleasuring you with her tongue.[or][BigNameDesc of M] sucks relentlessly, practically torturing you with expert stimulation from her lips and tongue.[or][BigNameDesc of M] hums as she suckles your [ShortDesc of penis], having no issue at all driving you insane with pleasure.[or][BigNameDesc of M] pleasures you mercilessly, swirling her tongue around your tip as she steadily works you over with her lips.[at random]";
	...
	if the player is diaper focused:
		...
		if watersports fetish is 1:
			...
			otherwise:
				...
				say "[BigNameDesc of M] pulls up the rear of the waistband of your [D] and squats over your back. She starts peeing!";
				PissSoak 6 on D;
...
To say DominanceSuccess of (M - a wrestler):
	...
	otherwise if the size of penis > 0:
		...
		if watersports fetish is 1 and the player is desperate to pee:
			say "You immediately release your hold on your bladder, allowing a shudder of relief to pass through your body as you douse [NameDesc of M] in a stream of golden [urine]. She pushes her breasts together enticingly as she captures it in her mouth, making a show of swallowing it in one huge gulp as she suddenly gets up and kisses you square on the lips. Wow!";
			if image cutscenes is 1, display figure of wrestler cutscene 2;
			Dignify 10;
			now the bladder of the player is 0;
...
To compute friendly drink of (M - a wrestler):
	if the player is prone and watersports fetish is 1:
		say "[BigNameDesc of M]'s eyes light up. [line break][second custom style]'One Toilet Special, coming right up!'[roman type][line break][BigNameDesc of M] doesn't give you a chance to ask what that means before she has unzipped her crotch and starting pissing straight at you!  [variable custom style][if the urine taste addiction of the player < 6]Shit shit shit![otherwise if the urine taste addiction of the player < 13]That's not what I meant...[otherwise]Ooh, yum![end if]";
		FacePiss from M;
	otherwise:
