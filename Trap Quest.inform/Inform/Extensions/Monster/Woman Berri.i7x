...
Definition: woman-player is soggy if the woman-diaper-state of it > 0 and diaper messing < 6.
Definition: woman-player is messy if the woman-diaper-state of it > 0 and diaper messing >= 6.
...
To compute basic greeting to (M - woman-player):
	...
	otherwise if M is angered:
		say "[speech style of M]'Why yes I would like to [if the woman-bimbo of the player < 5]fight[otherwise]play[end if].'[roman type][line break]";
