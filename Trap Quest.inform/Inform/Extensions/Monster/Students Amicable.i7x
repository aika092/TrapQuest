...
An amicable student is a kind of student.
...
student-rachel is a tq-only amicable student.
...
The min-rank of student-rachel is 2.
The max-rank of student-rachel is 3.
...
student-jessica is a dq-only amicable student.
...
To say MonsterDesc of (M - student-jessica):
...
The max-rank of student-jessica is 3.

To update name of (M - student-jessica):
	if the current-rank of M is 1:
		now the student-name of M is "Jessica";
		now the student-print of M is "lovable lass";
	otherwise if the current-rank of M is 2:
		now the student-name of M is "Jess";
		now the student-print of M is "bubbly babygirl";
	otherwise:
		now the student-name of M is "Jessie";
