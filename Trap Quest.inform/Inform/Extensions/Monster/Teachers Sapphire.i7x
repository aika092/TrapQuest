...
To compute teaching of (L - dress-lesson):
	let M be the lesson-teacher of L;
	say "[speech style of M]'Today's lesson is on the proper purpose of skirts.'[roman type][line break][NameDesc of M] stands at the front of the room and motions at [his of M] own dress with [his of M] hands as she speaks.";
