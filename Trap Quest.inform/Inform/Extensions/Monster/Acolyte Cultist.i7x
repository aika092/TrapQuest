...
To compute kneeling reaction of (M - clairvoyant acolyte):
	...
	say "[speech style of M][one of]The blessed seed of the [great one]s will fertilise your mind...'[or]When you have tasted their seed, your mind will grow open for the [great one]s...'[or]The [great one]s blessed me with their seed... this is my responsibility...'[at random][roman type]";
	humiliate 75.
...
To compute facial sex of (M - clairvoyant acolyte):
	...
	otherwise:
		...
		otherwise if there is a worn diaper:
			say "[BigNameDesc of M] lovingly rubs your diaper[one of] from [his of M] advantageous position[or][stopping]. [line break][speech style of M]'[one of]What's this? Why are you wearing a nappy, [honey of M]? Are you having potty problems?'[or][DiaperHumiliation of M][stopping][roman type][line break]";
			humiliate 200;
			arouse 300;]
