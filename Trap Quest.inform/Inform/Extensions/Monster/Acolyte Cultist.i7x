...
The description of acolyte is usually "[AcolyteDesc]".
...
To say ClothesPeeReaction of (M - an acolyte):
	if M is interested, say "You feel like you know that the [M] is smirking under [his of M] veil, but you can't actually see it.";
...
To compute perception of (M - a mindless acolyte):
	if M is released:
		say "The [M] notices you! [line break][second custom style]'Nonbeliever...'[roman type][line break]";
		now M is interested;
		anger M;
	otherwise:
...
To compute perception of (M - an acolyte):
	now M is interested;
	say "The [M] notices you![line break]";
...
To compute perception of (M - a clairvoyant acolyte):
	if doomed is 5 and the class of the player is not cultist:
		say "[speech style of M]'[one of]THE HERALD IS HERE! YOU ARE TOO LATE, NON-BELIEVER!'[or]I see servitude in your NEAR future, non-believer...'[stopping][roman type][line break]The [M] cackles deliriously and assumes an aggressive stance!";
		anger M;
	otherwise:
	...
	otherwise if the class of the player is not cultist and the pregnancy of the player is 0:
		...
		if delayed stand is 0:
			if the location of the player is the target-room of M:
				say "The [M] forces you onto the altar! [line break][first custom style]'[if M is intelligent]I envy you for the pure fulfilment you will achieve when the [great one] fills you with seed.'[otherwise]The [great one]s...'[end if][roman type][line break]";
...
To say MummyChant of (M - an acolyte):
	...
	otherwise:
		say "The [M] kneels in front of the [printed name of mysterious-mummy], facing you. [big he of M] completes a short chant as she places another candle around the ring at the mummy's feet. You realize something feels really different as the cultist returns to her feet.";
...
To compute annoyance of (M - an acolyte):
	...
	otherwise if M is unfriendly:
		say "The [M] ignores your question. [line break][first custom style]'Quiet, worm!'[roman type][line break]";
	otherwise:
...
To compute desperate drinking to (M - an acolyte):
	...
	otherwise:
		say "[if M is uninterested]You spot a [M]!  You beg her[otherwise]You can't control yourself - you beg the [M][end if] to give you something to drink. [big he of M] nods and pulls out a small cup of amber liquid. You snatch it from her and down it in one. You feel much less thirsty, but you somehow feel empty inside. The cultist nods at you and turns away.";
		humiliate MODERATE-HUMILIATION;
		StomachUp 2;
...
To say DominanceFailure of (M - an acolyte):
	say "You grab the [M] and try to force [him of M] to [his of M] knees. [big he of M] places [his of M] hand on your forehead, uttering a harsh word under [his of M] breath as every muscle in your body suddenly goes limp, causing you to crumple helplessly at [his of M] feet. [line break][speech style of M]'[one of]Your dominance goes against the will of the [great one]s, non-believer...'[or]Non-believer, your dominance goes against the will of the [great one]s...'[or]This body exists only for the [great one]s, non-believer...[or]My body exists only as a conduit to the will of the [great one]s...'[at random][roman type][line break]";
...
To compute failed dominance punishment of (M - a mindless acolyte):
	...
	if the player is male:
		...
		otherwise if the size of penis > min penis size:[reduce penis size by the number of mindless acolytes]
			say "[speech style of H]'[one of]FYI, nothing can stand before the might of Azacocks. Asshole.'[or]Your dick is, um, totally beneath the might of Azacocks, jerk!'[or]Your dick will bend to the will of Azacocks and stuff.'[at random][roman type][line break]The smoke converges on your [ShortDesc of penis], covering it.";
			now P is 0;
...
To compute failed dominance punishment of (M - an acolyte):
	...
	otherwise if R is 1 or the player is female:[She summons a ghost]
		...
		say "The [M] resumes her chanting, but its rhythm is now different. An incredibly uneasy feeling settles over you as the cultist theatrically fondles [his of M] breasts and plunges a pair of fingers in and out of [his of M] mouth, as if to put on a show for some unseen audience. [run paragraph on]";
		if G is ghost:
			set up G;
			now G is in the location of the player;
			say "The atmosphere grows more intense the more perverted [he of M] makes [his of M] display, and you can hear the drop in the air as a pinprick of light appears in front of [him of M], dripping bright green, glowing fluid as it slowly transforms into a [printed name of G]. The [M] quickly wraps a hand around it, running [his of M] tongue along its shaft as its light continues to intensify, [if bukkake fetish is 1]angling it towards you as its veins bulge with greater and greater definition. You can only look on helplessly as it ejaculates, covering you in a cascade of slime, which adheres to your skin in an instant. The [M] leaves you to your fate.[otherwise]slurping loudly as a sickly green glow spreads over your surroundings. [big he of M] freezes when the light reaches its most intense point, and with [one of]unexpected[or]unnerving[stopping] speed bolts from the room just as the [printed name of G] releases a violent pulse of energy, which magically fastens you to the floor!";
...
To compute failed dominance punishment of (M - an clairvoyant acolyte):
	...
	if B is clothing:
		say "The [M] pulls out your ballgag, chanting under [his of M] breath as [his of M] creampied [vagina] looms over you.";
		now B is in holding pen;
		now M is retaining B;
		dislodge B;
	otherwise:
		say "The [M] chants under [his of M] breath, color creeping back into [his of M] cheeks as [his of M] creampied [vagina] looms over you.";
	now another-turn is 1.

To say DominanceSuccess of (M - a mindless acolyte):[vaginal sex only]
	say "You grab the [M] and quickly force [him of M] to [his of M] knees. [big his of M] head jerks toward you, and she utters a harsh word under her breath as her robe instantly tears itself to shreds, leaving only her hood. [line break][speech style of M]'[one of]Defile, non-believer...'[or]Ruin, non-believer...'[or]Feed with ruination, non-believer.[or]Defile, non-believer. Ruin everything.'[at random][roman type][line break]";
...
This is the seer monster convinced rule:
	...
	if presented-orifice is face:
		say "The [M] sees your request and smiles calmly. [line break][speech style of M]'You will make a fine servant of the [great one]s.'[roman type][line break]";
		now the chosen-orifice of current-monster is face;
		rule succeeds;
	otherwise if presented-orifice is not nothing:
		say "The [M] sees your request and shakes her head. [line break][speech style of M]'I will use your body in no such manner. You are to serve the [great one]s, and them alone.'[roman type][line break]".
