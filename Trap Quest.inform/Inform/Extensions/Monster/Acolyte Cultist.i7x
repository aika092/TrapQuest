...
To say MonsterDesc of (M - a mindless acolyte):
	...
	otherwise:
		say "A veiled [man of M] in a sheer black robe. While you cannot clearly see [his of M] eyes, [his of M] mouth gapes vacantly and the cords of drool running from it betray how empty [his of M] mind must be[if pregnancy fetish is 1]. [big he of M] is massively pregnant, and [his of M] only motion is to absently rub [his of M] belly every so often[end if].".
...
To say MonsterDesc of (M - clairvoyant acolyte):
	...
	otherwise:
		say "A veiled [man of M] in a sheer black robe. While you cannot clearly see [his of M] eyes, there is a noticeably blank look on [his of M] face, as if [he of M] were thinking of... nothing at all. [if bukkake fetish is 1 and the location of the player is Mansion02][big his of M] entire body is coated in [semen], especially [his of M] crotch and chin, which are very clearly leaking onto the bedspread beneath [him of M][otherwise if the location of the player is Mansion02][big his of M] body is pale, almost green compared to the bedspread beneath [him of M][otherwise if bukkake fetish is 1][big his of M] entire body is coated in [semen], especially [his of M] [HoleDesc of M] and chin, but [he of M] doesn't seem to mind[otherwise][big his of M] body is pale, almost green, but it almost seems like [he of M]'s... stronger for it[end if]. [if pregnancy fetish is 1]You can't be certain, but it looks like [he of M] has a bit of a baby bump.[end if]";
