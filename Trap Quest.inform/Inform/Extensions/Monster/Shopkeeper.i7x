...
To say MonsterDesc of (M - shopkeeper):
	if M is diaper-enslaved:
		say "This tall black [man of M] has had [his of M] hair grown out and tied up with a large pink bow. [big his of M] sensible outfit has been replaced by some kind of purple martial arts themed baby dress, with a tiny tutu sewn into the waist rather than a proper skirt. This fully exposes [his of M] big thick pale purple diaper which pushes [his of M] legs wide apart and forces [him of M] to waddle. Purple medieval themed baby booties and fingerless mittens complete the ensemble, which overall means that [his of M] air of dominance has been completely erased and replaced with an air of pathetic helplessness.";
...
To compute shopkeeperDiscount of (M - shopkeeper):
	...
	otherwise:
		say "[second custom style]'[one of]Is there anything a [boy of the player] can do to get a discount around here?[or]So, what would I have to do for a discount?'[or]I'm dying to get into some of these clothes, but I just don't have the money for it right now. Oh well...'[or]Is there something I can do to lower some of these prices?[if the bimbo of the player > 12] With my body, maybe?'[otherwise]'[end if][at random][roman type][line break]";
