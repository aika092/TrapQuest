...
shopkeeper is a monster. shopkeeper is male. shopkeeper is intelligent. The leftover-type of shopkeeper is 108.

Definition: shopkeeper (called M) is willing to urinate:
	decide yes.

Definition: shopkeeper (called M) is dark skinned:
	decide yes.

Definition: shopkeeper (called M) is raunchy:
	decide yes.

Definition: shopkeeper (called M) is wenchy:
	[if the player is a february 2018 top donator, decide yes;
	decide no.]
	decide yes.
...
To decide which number is the semen load of (M - shopkeeper):
	decide on 3.
...
Definition: shopkeeper (called M) is human:
	decide yes.
...
To say FloorPeeReaction of (M - shopkeeper):
...
To say DiaperReaction of (M - shopkeeper):
	if M is interested, say "[BigNameDesc of M] frowns as [he of M] watches you. It's very clear that [he of M] can tell what is happening. [line break][variable custom style][if the humiliation of the player < 17000]Why did this have to happen to me?![otherwise if the humiliation of the player < 25000]If [he of M] was kind, [he of M] would look away![otherwise]Yep that's right Sir, I'm going right now in my nappy![end if][roman type][line break]";
	otherwise say "[BigNameDesc of M] doesn't look at you directly or say anything, so it's hard to gauge [if the humiliation of the player < 31000]if [he of M] saw[otherwise][his of M] reaction[end if].".
...
To compute (M - a monster) stomping (N - shopkeeper):
	if diaper quest is 1:
		if M is in the location of the player, say "[BigNameDesc of M] leaps into the air and lands on the [N], who disappears underneath the monster. There's a scream, but it's not from beneath the beast, it's from above you - the [N] has somehow appeared above you, hog-tied and suspended from the ceiling, with a large sagging diaper, a tight blindfold and a large ballgag. It doesn't look like he'll be getting down any time soon.";
...
To decide which number is the aggro limit of (M - shopkeeper): [The number at which they turn unfriendly]
...
To compute perception of (M - shopkeeper):
	...
	otherwise say "[BigNameDesc of M] notices you[if the player is sluttily dressed], grinning at how you're dressed[one of] even though [he of M] is completely naked [him of M]self[or][stopping].[otherwise]![end if]";
	now M is interested;
	...
	if newbie tips is 1, say "[one of][item style]Newbie tip: The shopkeeper is pretty tough, so unless you're looking for a rough [if diaper quest is 1]punishment[otherwise]fucking[end if] I wouldn't mess with [him of M]!  You can buy stuff from [him of M] by picking it up and then typing 'pay'. It's also definitely worth asking [him of M] a question - sometimes he'll be in a good mood and teach you a new skill![roman type][line break][or][stopping]".
...
To compute motion of (M - shopkeeper):
	if M is not in Dungeon41: [If the shopkeeper is not interested in chasing the player, [he of M] just returns to the Dungeon Shop.]
...
To compute kneeling reaction of (M - shopkeeper):
	say "[BigNameDesc of M] continues to keep [his of M] guard up, even as you kneel before [him of M]. The sheer size of the man is something he's ready to use if you try to run, and given how many muscles he's sporting, it wouldn't be the best idea. Simply kneeling is enough to coax a good laugh from [NameDesc of M] as [he of M] closes the gap between you and [him of M], [his of M] [manly-penis] springing to life between [his of M] legs in a matter of seconds. [his of M] gaze fixates on you, as if he's waiting for you to make the first move.";
	humiliate 75.

To compute delay of (M - shopkeeper):
	say "The shopkeeper stands there, clearly expecting you to present yourself to [him of M]. [if the humiliation of the player < 23000]As if [he of M] deserves anything from you![otherwise if the bimbo of the player < 14]Not that you'd have a problem doing so, of course.[otherwise][line break][second custom style][big he of M] is the man, after all, and deserves a good show~![roman type][line break][end if]".
...
To say DeepthroatCreampie of (M - shopkeeper):
	...
	otherwise:
		if a random number between 1 and 2 is 1, say "[one of][BigNameDesc of M] doesn't even waver as [he of M] reaches [his of M] peak and shoves your head into [his of M] lap, [his of M] booming groan filling the room as [his of M] [tasted-semen] rockets down your throat, filling your belly quite nicely.[or][big his of M] [manly-penis] throbs without restraint as [he of M] shoves your nose into [his of M] pubis, burying [his of M] rather large [manly-penis] in your throat. It doesn't take much long after that before he's firing off volley after volley of hot [semen] down your oesophagus. [or][BigNameDesc of M] keeps your head pinned against [his of M] hips as [he of M] moans with obvious delight. Before long [his of M] creamy [semen] is being shot directly into your stomach, making you strain against [his of M] lap for air.[or][BigNameDesc of M] keeps your head still as [he of M] thrusts forward, [his of M] balls slapping your chin as [he of M] buries [his of M] [manly-penis] in your oesophagus. Thankfully [he of M] doesn't take long after to erupt, [his of M] thick [semen] rushing down your throat to fill your stomach quickly. [big he of M] pulls out before long, making you cough and sputter, breaking the little strands of spit still connecting your lips to [his of M] length.[or]You barely have time to react before [NameDesc of M] buries [his of M] [manly-penis] as far into your mouth as it will go, [his of M] balls soon resting on your chin and your nose digging against [his of M] pubis. Jet after jet of hot, thick [semen] rockets down your throat to greet your stomach, your cheeks soon burning red with embarrassment. [big he of M] removes [his of M] length before long and lets out a hearty chuckle of victory, quickly losing interest again.[or][BigNameDesc of M] forces [him of M]self down your throat once more, groaning as [he of M] fills your belly with quite sizeable load. Wave after wave of [semen] rushes to fill you up, and before long you feel much more bloated than before, even as [he of M] removes [his of M] [manly-penis] and wipes the tip off on your cheek.[or][BigNameDesc of M] forces [his of M] [manly-penis] all the way to the hilt, letting out a booming groan of satisfaction in the process. With such a tight grip on your skull, you can do nothing but wait helplessly with your cheeks puffed out as [he of M] pumps shot after shot of disgustingly thick [semen] directly into your belly. After finishing, [he of M] pulls [him of M]self out and wipes [his of M] tip on your cheek, making sure you get every last bit of [his of M] [semen] in or on you.[in random order]";
		otherwise say "[one of][if the semen taste addiction of the player < 10][BigNameDesc of M] crams your head into [his of M] lap, gritting [his of M] teeth as [he of M] pumps [his of M] hips a few more times. You feel completely helpless as [he of M] shoots [his of M] [semen] directly into your stomach, [his of M] soft hissing the only thing you can focus on besides the massive pain in your throat.[otherwise if the semen taste addiction of the player < 13][BigNameDesc of M] crams your head into [his of M] lap, gritting [his of M] teeth as [he of M] pumps [his of M] hips a few more times. You obediently swallow as [his of M] [manly-penis] fires rope after rope of thick [semen] directly into your stomach. For some odd reason you feel slightly disappointed that you didn't get to taste it...[otherwise][BigNameDesc of M] crams your head into [his of M] lap, gritting [his of M] teeth as [he of M] pumps [his of M] hips a few more times. If your mouth wasn't so full you're sure you'd giggle as [he of M] fires volley after volley of thick, chunky [semen] directly down your throat, a coarse moan coming from you as you stay still to accept every drop with a struggled smile.[end if][or][if the semen taste addiction of the player < 9][BigNameDesc of M] forces [his of M] [manly-penis] further and further down your throat until [his of M] balls rest happily on your chin. Your eyes go wide as you realize just how long [he of M] really is, that thick, veiny [manly-penis] throbbing against your inner walls. With burning cheeks you accept [his of M] thick and virile load, shutting your eyes and trying to imagine yourself somewhere other than here right after.[otherwise if the semen taste addiction of the player < 12][BigNameDesc of M] forces [his of M] [manly-penis] further and further down your throat until [his of M] balls rest happily on your chin. Your eyelids fall halfway down as your pupils vibrate, your focus less on [his of M] lap and more on the pain in your throat. As [he of M] fills your stomach with [his of M] hot and creamy load, you can't help but feel somehow proud that you were able to coax so much out of [him of M].[otherwise][BigNameDesc of M] forces [his of M] [manly-penis] further and further down your throat until [his of M] balls rest happily on your chin. Your eyes roll back in their sockets as tears stream down your cheeks, the heat of [his of M] lap finally starting to wear you down- not to mention the burning sensation in your throat. [his of M] sheer size is enough to make you emit muffled little moans of content as [his of M] soothing [semen] rushes down your throat to fill your belly, something that leaves you utterly satisfied and ready for more.[end if][in random order]".
...
To compute post climax effect of (M - shopkeeper) in (F - a fuckhole):
	...
	otherwise say "[line break][unless M is objectifying the player]'Feel free to return to the shop, but don't you dare leave without paying again.'  [end if][roman type][BigNameDesc of M] pulls out and leaves you alone to recover.";
...
To compute anal sex of (M - shopkeeper):
	compute fuckhole sex of M.

To compute vaginal sex of (M - shopkeeper):
	compute fuckhole sex of M.

To say FriendlyAssholePenetrationFlav of (M - shopkeeper):
	say FriendlyFuckholePenetrationFlav of M.

To say FriendlyVaginaPenetrationFlav of (M - shopkeeper):
	say FriendlyFuckholePenetrationFlav of M.

To say FriendlyFuckholePenetrationFlav of (M - shopkeeper):
	say "[BigNameDesc of M] [one of]growls powerfully[or]bends over and smells your hair[or]grips your hips tightly[or]roughly gropes your right breast[or]roughly tweaks your left nipple[or]repeatedly slaps your ass cheeks[at random] as [he of M] thrusts [his of M] [one of]massive [or]huge [or]thick [or][or][or][or][at random][manly-penis] in and out of your [if chosen-orifice of M is asshole][asshole][otherwise][vagina][end if].";
...
This is the shopkeeper cockslaps the player rule:
	...
	say "[if bukkake fetish is 1 and the semen coating of face is 0][BigNameDesc of M] takes this opportunity to smack your face with [his of M] [manly-penis]. After slapping each cheek a couple of times, [he of M] wipes some of [his of M] precum from the tip of [his of M] penis onto your face, in between your eyes.[otherwise][BigNameDesc of M] toys with your face with [his of M] [manly-penis], waiting for [his of M] turn.[end if]";
...
To say BreastsPenetrationFlav of (M - shopkeeper):
	if the class of the player is living sex doll:
		...
		say "The next moment, [he of M] shoves you down so your face presses into [his of M] chest while each hand grabs one of your [BreastDesc], and without any problem, trapping [his of M] engorged cock between then. Moments later, he's thrusting you up and down and you feel [his of M] rod pistoning between your orbs, squeaking like a rubber toy. The vibration caused by the squeaking rubber seems to really be getting [him of M] off![line break][speech style of M]'Oh, yeah, baby, that's go-oo-ood!  Keep that up, little Momma!'[roman type][line break]";
...
To say VaginaPenetrationFlav of (M - shopkeeper):
	if the class of the player is living sex doll:
		...
		say "[big he of M] nods, like [he of M] expected all that to happen, and then [his of M] hand is bending down to your face, [his of M] eyes apparently hypnotised by your lush, puckered-open lips. [his of M] mouth locks over your bright red lower lip, gently biting it in a way that has you terrified [he of M] might bite down hard enough to puncture you - and there where would you be? - and squealing into [his of M] mouth from the shivery thrill of [his of M] lips against yours.";
	...
	otherwise:
		say "[BigNameDesc of M] forces [him of M]self into your [vagina]!". 
...
To compute diaper donating of (M - shopkeeper):
	...
	if D is diaper:
		say "[speech style of M]'Did you really think you could just get away with stealing my shit?  You're going to regret this.'[roman type]  [BigNameDesc of M] kicks you hard in your side!  [line break][variable custom style]Fuck![roman type][line break]";
	otherwise:
		...
		if D is diaper:
			...
			say "[BigNameDesc of M] forces the [D] onto your body, and then begins spanking you roughly through the padding!  [big he of M] is so strong that it still feels very painful. [line break][variable custom style][if the player is able to speak]'[end if]Ow ow ow ow owwwwww![if the player is able to speak]'[end if][roman type][line break]";
...
Definition: shopkeeper (called M) is willing to spank:
	decide yes.

Definition: shopkeeper (called M) is willing to deliver enemas:
	decide yes.

Definition: shopkeeper (called M) is willing to confiscate:
	decide yes.

Definition: shopkeeper (called M) is diaper disciplining:
	decide yes.
...
Definition: shopkeeper (called M) is willing to donate diapers:
	decide yes.
...
To compute damage of (M - shopkeeper):
...
To say DamageReaction (N - a number) of (M - shopkeeper):
...
To compute unique death of (M - shopkeeper):
	say "[big he of M] drops to [his of M] knees, defeated. [big he of M] then fades into nothingness, leaving behind a few valuable gems.";
	loot M;
	loot M;
	loot M;
...
To say UnfriendlyResponse of (M - shopkeeper):
...
To say DominantResponse of (M - shopkeeper):
	if M is mating:
...
To say midDominanceResponse of (M - shopkeeper):
...
To say AsDominantResponse of (M - shopkeeper):
...
To say BimboSeduced of (M - shopkeeper):
	if M is interested and the class of the player is cheerleader and diaper quest is 0:
		say "[BigNameDesc of M] even more turned on by your incessant chattering!";[The chatterbox is [his of M] dream girl!]
	otherwise:
...
[The shopkeeper uses a custom "to question" function, so [he of M] can give us [his of M] all-important discount.]
[To compute talk option (N - 2) to (M - shopkeeper):
...
To compute annoyance of (M - shopkeeper):
	if M is uninterested:
		say "[BigNameDesc of M] doesn't seem to realize that you're talking to [him of M].";
	otherwise if M is unfriendly:
...
To say WhoQuestion of (M - shopkeeper):
	if discount is -1 or discount > 0 or M is uninterested or diaper quest is 1 or M is unfriendly:
		say "[speech style of M]'Who are you?'[roman type][line break]";
		say BoringWhoAnswer of M;
	otherwise:
		compute shopkeeperDiscount of M.

To compute shopkeeperDiscount of (M - shopkeeper):
	...
	if the player consents:
		...
		humiliate 400;
		say "You get on your knees and take [his of M] enormous length in your hands. The giant tool starts to grow even larger as the shopkeeper is aroused with anticipation. [if the bimbo of the player < 7]You close your[otherwise]You stare deeply into his[end if] eyes and open your mouth as you stretch your mouth as wide open as possible in order to get your lips around the head. As you move your face down the first half of the monster, you [if the bimbo of the player < 10]shiver with shame as you feel [his of M] sex organ expand to fill your entire mouth.[otherwise]feel your own arousal build as your mouth fills with [manly-penis].[end if][line break]The next part of the member is a challenge, you have to force the head right to the back of your throat which takes some work, you have to move your head backwards and forwards a few times which causes you to make a lewd gagging sound. You can tell that the shopkeeper is greatly enjoying [him of M]self by [if the bimbo of the player > 6]the look in [his of M] eyes and [end if]the moans [he of M] has started to make. ";
		if the throatskill of the player is 1 or a random number between 0 and 1 < the number of lubricants covering face or the oral sex addiction of the player > a random number between 0 and 10:
			say "[if the throatskill of the player is 1]Using your newly obtained deepthroating techniques[otherwise if there is a lubricant covering face]With the help of the slippery lubricant coating your mouth and throat[otherwise]Licking your lips nervously[end if], you try to open your throat and accept [his of M] length inside it. [if the oral sex addiction of the player < 5]It takes several attempts to mentally steel yourself and allow your throat to relax, but you eventually manage to swallow the entirety of [his of M] [manly-penis].[otherwise]You blank out your mind and find it surprisingly easy to relax your throat muscles. You take [his of M] entire [manly-penis] and allow your throat to pulse around it by repeatedly making a swallowing motion.[end if][line break]Before you can react, whilst [his of M] [manly-penis] is deep in your throat, [he of M] starts to climax. [if the semen taste addiction of the player > 9]Without thinking you stay still and let [him of M] ejaculate directly into your belly. After [he of M] finishes filling your stomach with [his of M] seed, [he of M] slowly deflates, and eventually pulls [his of M] entire length from your throat and mouth.[otherwise]you pull yourself back as fast as possible, but not before you are forced to swallow several strings of [his of M] salty gift.[end if][line break][speech style of M]'Unf, that was incredible. All right, you definitely deserve a discount for that performance. I'm going to give you 4 credits off everything in the store, for a while at least.'[roman type][line break]";
			now discount is 1000;
			StomachSemenUp 4;
		otherwise:
			say "[if the number of lubricants covering face > 0]With the help of the slippery lubricant coating your mouth and throat, you try to open your throat and accept [his of M] length inside it. However, you soon realize it's not enough.[end if]As much as you try, you can't get the last part into your mouth. There's just no room!  Your mouth is already 100% full of [if the bimbo of the player > 7]man meat[otherwise]'meat'[end if] and even though you try bulging out your cheeks, pulling out and pushing back in, and moving your tongue around to different points in your mouth, nothing works. What it does manage to do, though, is cause the shopkeeper to lose control. Before you can react, whilst [his of M] [manly-penis] is as deep in your mouth as it can go, [he of M] starts to climax, and [if the semen taste addiction of the player > 8]without thinking you start gulping it down so that you can continue to breathe. After [he of M] finishes filling your stomach with [his of M] seed, [he of M] slowly deflates, and eventually pulls [his of M] entire length from your mouth.[otherwise]you pull yourself back as fast as possible, but not before you are forced to swallow two or three strings of [his of M] salty gift.[end if]";
...
To say WhoAnswer of (M - shopkeeper):
	say "". [We have had the discount interaction instead!]
	
To say BoringWhoAnswer of (M - shopkeeper):
...
Definition: shopkeeper (called M) is willing to give snacks:
	decide yes.

Section 5 - Dominant Sex

To compute successful dominance of (M - shopkeeper):
...
To vaginal dominate (M - shopkeeper):[The shopkeeper dominant sex is more about [him of M] seducing you. You always get a discount, but its smaller the less of [his of M] cum you dealt with. The more you get seduced, the more you get a discount]
	let V be the vaginal sex addiction of the player * 2 - the dominance of the player;[sex addiction and openness are factored into this check, since its the dominance of the player]
	let Ofit be the openness of vagina - the girth of M;
	now M is penetrating vagina;
	say "You hold [his of M] [manly-penis] firmly, [if Ofit < -1]grunting quietly under your breath[otherwise if Ofit < 2]sighing[otherwise]humming happily[end if] as you guide the first few inches into your [vagina]. Its huge. [if Ofit < -1]Its not that you're tight (You [i]are[/i] tight), its that [he of M]'s hung like an elephant, and[otherwise if Ofit < 2]You're not that tight, but [he of M]'s still hung like an elephant, and pretty[otherwise]You're pretty loose, but you know a big piece of meat when you feel one and this one is not just [i]big[/i], its[end if] excited too.";
	ruin vagina;
	now refactoryperiod is 0;
	if V <= 0:[total dominance]
		say "It would be so easy to give in and worship that monster, but [if Ofit < 2]you're in control[otherwise]you've still had bigger[end if]. You lower your hips, driving inch by inch of big, [if interracial fetish is 1]black[otherwise]throbbing[end if] shaft even deeper inside you. Giving in would be so easy, but you don't. You notice [him of M] starting to get one of [his of M] hand free, and immediately grab it and slam it to the ground. [line break][variable custom style]'[one of]No.'[or]Forgetting who is in charge?'[or]Naughty.'[at random][roman type][line break] You lick your lips, yanking [his of M] other hand out from underneath [him of M] and pinning that too. [big he of M] looks up at you with hints of defiance in [his of M] features, but far more arousal. You resume the movement of your hips, never losing eye contact as you fuck yourself with [his of M] towering [manly-penis]. You relish every moment of control, pleasure, and big ass [manly-penis], moaning shamelessly as you ride your fucktoy right to the edge. [big he of M]'s getting close when you cum, bucking powerfully as you spray [his of M] chiseled belly with feminine juices, but still just far enough from the edge that you're able to satisfy yourself and pull off before [he of M] has a chance to finish. You don't release your grip. [line break][variable custom style]'[one of]Discount. Now, or I leave you like this.'[or]Oh, are you frustrated? I could help you, if you'd drop your prices some.'[or]If you want to cum, you're going to give me a price cut. Now.'[at random][roman type][line break] [big he of M] considers [his of M] options for a moment, then nods. You grin, [if M is wrapped]peeling off the condom[otherwise]releasing [him of M][end if] and wrapping both hands around [his of M] [manly-penis], giving it a tiny kiss on the tip as you pump [him of M] to an explosive orgasm, which splatters liberally over your surroundings.";
		...
		now discount is 50;
		Dignify 100;
	otherwise if V <= 4:[partial dominance]
		say "Its hard not to give in and start worshipping that monster immediately, but [if Ofit < 2]you're still in control[otherwise]you've had bigger[end if]. You lower yourself slowly, [if Ofit < -1]hissing[otherwise if Ofit < 2]groaning[otherwise]moaning[end if] as you cram inch upon inch of big, [if interracial fetish is 1]black[otherwise]hard[end if], shaft deeper and deeper into your hole. [big he of M] slips one hand out from underneath [him of M], [if the largeness of breasts < 3]sensually tweaking your nipples[otherwise]tenderly palming your [ShortDesc of breasts][end if] as [he of M] begins to thrust. You yank [his of M] hand away and pin it on the ground next to [him of M], but the tingle of [his of M] strong fingers on your skin remains. [line break][variable custom style]'[one of]I'm in charge.'[or]S-stop that.'[or]D-don't do that.'[at random][roman type][line break] You realize your own hips are already matching [his of M] pace, and [his of M] other hand slips free as you struggle to regain your composure. [big he of M] speeds up. You pant together, watching each other's chests rise and fall as [his of M] free hand slowly creeps up your outer thigh, sending more tingles up your spine as [he of M] gently squeezes your [AssDesc]. [line break][variable custom style]'[one of]Harder. Harder[or]Fuck me harder[or]Yes! Fuck me harder[at random]![roman type][line break][big he of M] obeys, and so do you, but [he of M] doesn't just fuck you harder, you feel [him of M] getting harder too. You're close too.[line break][variable custom style]'[one of]Shit[or]Fuck[or]Yes! YES-[at random]!'[roman type][line break]Your nails dig into [his of M] shoulders as [he of M] slams [him of M]self home, groaning with pleasure as [he of M] [if M is wrapped]floods the condom[otherwise]paints your inner walls[end if] with wave after wave of fresh, warm [semen]. [big he of M] continues thrusting slowly as girlcum trickles down your thighs, sighing as you slow down and pull off.";
	...
	otherwise:[blacked;my hips are moving on their own!!!1!]
		say "Its hard not to want to be on the bottom, but you[']re still in control. Definitely. You lower yourself slowly, [if Ofit < -1]hissing[otherwise if Ofit < 2]groaning[otherwise]moaning[end if] as you cram inch upon inch of big, [if interracial fetish is 1]black[otherwise]hard[end if], shaft deeper and deeper into your hole. [big he of M] seems to notice that you're distracted, slipping one hand out from under [his of M] body, and casually moving it up your outer thigh, giving your [AssDesc] a firm swat as [he of M] begins to thrust. You realize the sudden shift in power dynamics, but its like [his of M] fingertips are made of electricity. Every movement of [his of M] hands sends a shiver of excitement up your spine, and it doesn't really help that your hips have already begun to match [his of M] pace. You feel [his of M] hands [if the largeness of breasts < 5]palming your [ShortDesc of Breasts][otherwise]roving your [ShortDesc of Breasts][end if], as [he of M] slowly speeds up. You find yourself rubbing your clit, pumping [his of M] dick from the base as you moan loudly and shamelessly. [line break][variable custom style]'[one of]Please fuck me harder[or]Fuck me harder[or]Fuck me! Fuck me harder[at random]![roman type][line break][big his of M] [manly-penis] gets harder. You can feel it throbbing inside you, [his of M] balls tensing as [he of M] gets ready to unload.";
		if M is wrapped:
			say "[big he of M] comes with the force of an avalanche, holding your hips tightly as [he of M] floods the condom with a massive load of [semen], stopping all movement, aside from the twitching of [his of M] shaft, for several long moments.[line break][second custom style]I have to taste it.[roman type][line break]. You pull off [him of M] slowly, savoring the feeling of the warm, stretchy bulge inside you as you kneel down in front of [him of M], one hand buried in your [vagina] as you peel the latex sheath from [his of M] softening [manly-penis] and eagerly dump its contents into your mouth. Its a little hard to swallow all at once, so you still have a good amount of it in your mouth as you go over the edge, girlcum trickling down your thighs as you finish the final gulp. That was fun, but it didn't feel all that dominant.";
			orgasm;
			orgasm M;
			StomachSemenUp the semen load of M;
		otherwise:
			say "[big he of M] comes with the force of an avalanche, holding your hips tightly as [he of M] plants wave after wave of fresh, warm [semen] deep inside your [vagina], stopping all movement, aside from the twitching of [his of M] shaft, for several long moments.[line break][second custom style]I have to taste it.[roman type][line break] You pull off [him of M] slowly, savoring the feeling of warmth running out of you as you kneel down in front of [him of M], one hand buried in your thoroughly creampied [vagina] as you wrap your lips around [his of M] glistening [manly-penis]. Its a little hard to get your mouth around it, but its softening, and you're motivated. You realize exactly how dominant your current position is as you go over the edge, moaning through a mouthful of cockmeat as a mixture of [semen] and girlcum trickle down your thighs. [BigNameDesc of M] sighs as you finish cleaning [him of M] up and release [his of M] [manly-penis] with a *POP*.";
			orgasm;
...
To anal dominate (M - shopkeeper):
	...
	if V <= -2:[total dominance]
		...
		Dignify 100;
	otherwise if V <= 4:[partial dominance]
		say "Its hard not to give in and start worshipping that monster immediately, but you're still supposed to be a guy. You lower yourself slowly, [if Ofit < -1]hissing[otherwise if Ofit < 2]groaning[otherwise]moaning[end if] as you cram inch upon inch of big, [if interracial fetish is 1]black[otherwise]hard[end if], shaft deeper and deeper into your hole. [big he of M] slips one hand out from underneath [him of M], [if the largeness of breasts < 3]sensually tweaking your nipples[otherwise]tenderly palming your [ShortDesc of breasts][end if] before moving down your body, squeezing your ass as [he of M] begins to thrust. You yank [his of M] hand away and pin it on the ground next to [him of M], but you know your hemmoraging control of the situation. [line break][variable custom style]'[one of]D-don't do that again.'[or]I w-won't let you get away with that again.'[or]I don't care how b-big your dick is, you do this my way'[at random][roman type][line break] You realize your own hips are already matching [his of M] pace, and [his of M] other hand slips free as you struggle to regain your composure. [big he of M] speeds up. Your [if there is a worn chastity cage]tiny cage bobs almost tauntingly[otherwise if the size of penis > 4]your rock hard [ShortDesc of penis] periodically thumps [his of M] unhelpfully[otherwise if the size of penis > 0]your rock hard [ShortDesc of penis] bobs pitifully[otherwise]pant, trying not to ogle [his of M] sexy muscles[end if] as you fight off your own desire to let [him of M] flip you over and take you how [he of M] pleases. [line break][variable custom style]'[one of]Faster[or]Fuck me harder[or]Fuck me faster[at random]![roman type][line break][big he of M] obeys, and so do you, but [he of M] doesn't just fuck you harder, you feel [him of M] getting harder too. You feel your prostate tightening up. [big he of M] slips [his of M] hand from your grip, grabbing your waist with both hands as [he of M] fucks you harder and harder, hitting your delicate little sissy button with relentless abandon. Its too much for you, and you feel your anal muscles rapidly tensing and relaxing as [he of M] slams [him of M]self home, groaning with pleasure as [he of M] [if M is wrapped]floods the condom[otherwise]paints your insides[end if] with wave after wave of fresh, warm [semen]. [big he of M] continues thrusting slowly as you [if the size of penis > 4]paint [his of M] tummy with a load of your own[otherwise if the size of penis > 0]drool a tiny load of your own onto [his of M] abs[otherwise]ride through the last of your orgasm[end if], sighing as you slow down and pull off.";
		say AfterDominationComment 2 of M;
		orgasm;
		...
		Dignify 25;
	otherwise:[blacked]
		say "Its hard not to want to be on the bottom, but you[']re still in control. Definitely. You lower yourself slowly, [if Ofit < -1]hissing[otherwise if Ofit < 2]groaning[otherwise]moaning[end if] as you cram inch upon inch of big, [if interracial fetish is 1]black[otherwise]hard[end if], shaft deeper and deeper into your hole. [big he of M] seems to notice that you're distracted, slipping one hand out from under [his of M] body, and casually moving it up your outer thigh, giving your [AssDesc] a firm swat as [he of M] begins to thrust. You realize the sudden shift in power dynamics, but its like [his of M] fingertips are made of electricity. Every movement of [his of M] hands sends a shiver of excitement up your spine, and it doesn't really help that your hips have already begun to match [his of M] pace. [big he of M]'s so big. You feel [his of M] hands [if the largeness of breasts < 5]palming your [ShortDesc of Breasts][otherwise]roving your [ShortDesc of Breasts][end if], as [he of M] slowly speeds up. You [if there is a worn chastity cage]want desperately to touch yourself, pumping [his of M] [manly-penis] with both hands [otherwise if the size of penis < 4 and the size of penis > 0]find yourself rubbing your [ShortDesc of penis] with one hand and pumping [his of M] [manly-penis] from the base[otherwise]find yourself rapidly stroking your [ShortDesc of penis] with both hands[end if] as your ragged panting becomes shameless, full-throated moaning. moan loudly and shamelessly. [line break][variable custom style]'[one of]Please fuck me harder[or]Fuck me harder[or]Fuck me! Fuck me harder[at random]![roman type][line break][big he of M] responds in kind, but [he of M] doesn't just fuck you harder, [he of M]'s actually getting harder too. You can feel it throbbing powerfully and [his of M] ball visible tense up as [he of M] gets ready to unload.";
		let C be 0;
		if there is a worn chastity cage or the size of penis is 0, now C is 1;
		if M is wrapped:
			say "[big he of M] comes with the force of an avalanche, holding your hips tightly as [he of M] floods the condom with a massive load of [semen], your [if there is a worn chastity cage]cage hanging uselessly[otherwise if the size of penis is 0]heart thumping in your chest[otherwise if the size of penis < 4][sissy-penis] hanging uselessly over [his of M] bellys[otherwise]resting uselessly on [his of M] belly[end if] as [his of M] thrusting slows down.[line break][second custom style]I have to taste it.[roman type][line break] You pull off [him of M] slowly, savoring the feeling of the warm, stretchy bulge inside you as you kneel down in front of [him of M], [if C is 1]half-realizing you didn't get to cum[otherwise if the size of penis < 4]rubbing your [sissy-penis] with two fingers[otherwise]pumping away with one hand[end if] as you peel the latex sheath from [his of M] softening [manly-penis] and eagerly dump its contents into your mouth. [if C is 1]You also realize how exactly how dominant it is to top things off like this, but its too hard to swallow everything at once, so you focus on that instead[otherwise]Its a little hard to swallow all at once, so you still have a good amount of it in your mouth as you go over the edge, panting the ground with your [load] as you realize exactly how dominant it was to top it all off with something like this[end if]";
			if C is 0, orgasm;
			otherwise Arouse 3000;[if you're in chastity or you don't have a cock, you don't get to cum]
			orgasm M;
			StomachSemenUp the semen load of M;
		otherwise:	
			say "[big he of M] comes with the force of an avalanche, holding your hips tightly as [he of M] plants wave after wave of fresh, warm [semen] deep inside your [asshole], your [if there is a worn chastity cage]cage hanging uselessly[otherwise if the size of penis is 0]heart thumping in your chest[otherwise if the size of penis < 4][sissy-penis] hanging uselessly over [his of M] belly[otherwise]resting uselessly on [his of M] belly[end if] as [his of M] thrusting slows down.[line break][second custom style]I have to taste it. I have to taste my ass![roman type][line break] You pull off [him of M] slowly, savoring the feeling of the warmth running out of you as you kneel down in front of [him of M], [if C is 1]half-realizing you didn't get to cum[otherwise if the size of penis < 4]rubbing your [sissy-penis] with two fingers[otherwise]pumping away with one hand[end if] as you wrap your lips around [his of M] glistening [manly-penis]. Its a little hard to get your mouth around it, but its softening, and you're motivated. [if C is 1]You have a second realization of how dominant you're acting right now, especially considering the fact that you didn't even cum, but you're far more concerned with making sure to slurp down every last drop of [his of M] leftover cum[otherwise]You realize exactly how dominant your current position is as you go over the edge, moaning through a mouthful of cockmeat as your [load] drips onto the floor[end if]. [BigNameDesc of M] sighs as you finish cleaning [him of M] up and release [his of M] [manly-penis] with a *POP*.";
			if C is 1, orgasm;
			otherwise Arouse 3000;[if you're in chastity or you don't have a cock, you don't get to cum]
		...
		say AfterDominationComment 3 of M;
		Dignify 10;
		if C is 1, FavourUp M by 2;[if you didn't get to cum, you did a better job sucking [his of M] dick after]
		otherwise FavourUp M by 1;
		now discount is 1000;
...
To replace (M - shopkeeper) after domination:
	if the location of M is not Dungeon41:
...
To compute successful dominance of (M - shopkeeper):
	...
	DifficultyUp M by 3;
	[Satisfy M;]
	if the location of M is Dungeon41, say "[line break][BigNameDesc of M] pops a blue pill and hops to [his of M] feet, full of energy.[line break]You feel more dominant!";
	otherwise say "[line break][BigNameDesc of M] slinks away as soon as [he of M] has the strength.[line break]You feel more dominant!". 

To say AfterDominationComment (N - a number) of (M - shopkeeper):
	if N is 1:
		say "[speech style of M]'[one of]Damn, good move, I guess. Choose what you want quick, alright?'[or]At least you didn't steal anything. Choose what you want quickly.'[or]Alright. This is not an extended discount, so be quick.'[at random][roman type][line break]";
	otherwise if N is 2:
		say "[speech style of M]'[one of]Hey, that was pretty fun, right? Tell you what, I'll give you a discount for a little bit.'[or]I admit that was a pretty good fuck. I'll cut my prices for a bit, alright?'[or]Point made, you naughty minx. I'll give you a discount for a while, alright?'[at random][roman type][line break]";
	otherwise:
		say "[speech style of M]'[one of]Wow. You definitely earned a discount with that.'[or]You're one naughty minx. Come back soon, I'm offering you a special discount for that.'[or]If that's what you wanted we didn't need to fight like that. Come back soon, I'm offering you a discount to show I'm not holding on to any hard feelings.'[at random][roman type][line break]".
...
To compute failed dominance punishment of (M - shopkeeper):
	if the number of worn removable stolen clothing  + the number of held stolen clothing > 0:
		...
		repeat with T running through removable clothing:[If you're stolen anything, [he of M] takes EVERYTHING]
	...
	if the class of the player is cheerleader, decrease N by 1;
	if the class of the player is vixen, now N is 3;
	if N is 3:[he summons every guard on the level to gangbang you;vixens always get this]
...
To say DragFlav of (M - shopkeeper) to (R - Dungeon03):[The stone cell]
	say "[speech style of M]'People like you need to know what its like to spend time in a cell.'[roman type][line break]";
...
To say DragFlav of (M - shopkeeper) to (R - Dungeon05):[Storage room]
	say "[speech style of M]'Lets take this someplace private.'[roman type][line break]".
...
To say DragFlav of (M - shopkeeper) to (R - Dungeon08):[Training room]
	say "[speech style of M]'Lets take this somewhere more fun.'[roman type][line break]".
