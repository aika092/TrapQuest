...
A shopkeeper is a kind of monster. A shopkeeper is male. A shopkeeper is usually intelligent. The leftover-type of a shopkeeper is usually 108.

Definition: a shopkeeper (called M) is willing to urinate:
	decide yes.

Definition: a shopkeeper (called M) is dark skinned:
	decide yes.

Definition: a shopkeeper (called M) is raunchy:
	decide yes.

Definition: a shopkeeper (called M) is wenchy:
...
To say MonsterOfferAcceptFlav of (M - a shopkeeper) to (T - a thing):
	if M is unfriendly:
		say "The [M] smirks. [line break][speech style of M]'[if there is stolen clothing]Fair enough. Next time, just pay first, [bitch]. [otherwise]I'm not going to turn that down, I'm not an idiot. But I'm still going to fuck you the next time I see you. [end if]Now get out of here.'[roman type][line break]";
	...
	otherwise:
		say "The [M] seems very touched. [line break][speech style of M]'I was not expecting a gift!  How very decent of you.'[roman type][line break]".
...
To say FloorPeeReaction of (M - a shopkeeper):
	if the player is in Dungeon41:
		if diaper quest is 1:
			if M is friendly:
				say "The [M] looks furious. [line break][speech style of M]'What are you doing?!  This is a shop, not a toilet!  [if the player is upright]Get on your knees[otherwise]Stay right where you are[end if], you clearly need to be diapered and punished!'[roman type][line break]";
				anger M;
			otherwise:
				say "The [M] frowns angrily. [line break][speech style of M]'This is why you need to be in diapers!'[roman type][line break][if M is uninterested]Uh-oh...[end if]";
				now M is interested;
		otherwise:
			if M is friendly:
				say "The [M] looks furious. [line break][speech style of M]'What are you doing?!  This is a shop, not a toilet!  [if the player is upright]Get on your knees[otherwise]Stay right where you are[end if], I'm going to make you wish you never stepped foot in here!'[roman type][line break]";
				anger M;
			otherwise:
				say "The [M] frowns angrily. [line break][speech style of M]'You are an utter disgrace!'[roman type][line break][if M is uninterested]Uh-oh...[end if]";
				now M is interested;
	otherwise:
...
To compute (M - a shopkeeper) using sex doll (N - 1):
	...
	say "[speech style of M]'[one of]Damn! I thought they must have improved the doll-program: for a moment there, it looked like you were going to struggle, or something.'[roman type] He gives your inflated arm a squeeze and shakes you. [line break][speech style of M]'Are you sure you don't want to squirm and try to run away?  Hmm?'[or]Aww, it's more fun when they struggle. Oh well, this'll do for now!'[stopping][roman type][line break]";
	say "[if the oral sex addiction of the player < 4]You stay perfectly still, hoping he might grow bored and let you go, all too aware of your perfectly made up face and inviting lips gaping vulnerably open. [end if]You sneak a look down at his groin, and blink in [horror the oral sex addiction of the player * 2] at the sight of the enormous cock straining up, pointing like a huge magnetised dowsing-rod at your [BreastDesc]. You look back up, and [if the humiliation of the player < 175000]cringe when you [end if]see a slow smile dawn on his face, and realise he watched you stare down at his quivering cock, and then back up to meet his gaze.";
...
To compute (M - a shopkeeper) entering mouth:
	...
	otherwise if face is not occupied:
		...
		otherwise if there is a worn ringagged clothing or the latex-transformation of the player > 6:
			let R be 1;
			if R is 1:
		say "The [M]'s mighty staff suddenly leaves your O-shaped suction-hole with a cartoonish rubber squeak. One hand clasps you behind your slender neck, holding you helplessly still while his other hand starts jerking with crazy speed as he aims his thick firehose at your face. There's nothing you can do as the bulbous end pulses and you get a close-up view as jet after jet explodes out all over your face, each spurt sounding exactly like water striking balloon-tight rubber.";
		...
		say "He leers at you, and you wonder whether he might decide to keep you here! [line break][variable custom style]Then again, would that be so bad?[roman type][line break]Part of you considers the possibility of hanging around, maybe poking him again?  After all, you have other orifices your new friend could play with.[line break]";
	otherwise:
...
To satisfy (M - a shopkeeper) for (N - a number) seconds:
	...
	otherwise:
		bore M for N seconds;
	send M home. [This makes sure the shopkeeper always makes it back to the shop. TODO: text so he doesn't just disappear]
...
To say LandingTaunt of (M - a shopkeeper):
	say "The [M] laughs at the sight of you. [line break][speech style of M]'[one of]About time!  Prepare yourself, criminal scum.[or]Life is full of ups and downs I guess. Mainly downs for you from here on out, though.[in random order]'[roman type][line break]";
	humiliate 50.
...
To say CreampieFlav of (M - a shopkeeper) in (F - asshole):
	if the class of the player is living sex doll:
		...
		say "[speech style of M]'Whoah!'[roman type], he exclaims, pulling his dick free with a cartoonish rubber squeak, your puckered flange squee-geeing his dick clean of [semen]. [line break][speech style of M]'Man, that was the best one yet! The sounds this new model makes really add something special to the experience. I wonder if I could convince them to let me add you to my product line? I could even give demonstrations, to potential customers. What say, [']doll[']?'[roman type][line break]";
		say "He leers at you, and you wonder whether he might [italic type]really[roman type] decide to keep you here! [line break][variable custom style]Then again, would that be so bad?[roman type][line break]Part of you wonders about the possibility of hanging around, maybe poking him again?  After all, you have other orifices your new friend could play with.[line break]";
	otherwise:
		say "[speech style of M]'Fuck, this is so good!  [one of]I haven't properly fucked anyone in way too long...'[or]Don't worry, I've still got lots of jizz left for you...'[stopping][roman type]  The [M] loses control over himself and orgasms, burying his entire length in you and releasing his hot load. You can almost hear it flowing inside you. [line break][speech style of M]'[if the reaction of the player is 2 or the class of the player is cheerleader]Sorry about that, to be fair I didn't mean to come inside you. [otherwise if the class of the player is living sex doll]Wow, you are one amazing sex doll. I hope you come back here again soon!'[otherwise if there is a worn sissy black cock whore tattoo][one of]Congratulations, you're at least good for one thing, getting bred by black cock. What do you want, a gold star?  Now piss off and come[or]Come[stopping] back when you're ready for more black cock, slut.'[otherwise if M is friendly-fucking]That was fucking amazing. Feel free to ask me to do that again any time!'[otherwise]I hope you learned your lesson.'[end if][roman type][line break]".
...
To compute fuckhole sex of (M - a shopkeeper):
	...
	otherwise if the reaction of the player is 2:
		say "The [M] keeps using your [variable F], but gently. [line break][speech style of M]'Haha, now you're realising your place. Go on, keep begging, I like it.'[roman type][line break]";
...
To say BreastsPenetrationFlav of (M - a shopkeeper):
	if the class of the player is living sex doll:
		say "He shakes his head. [line break][speech style of M]'I just gotta try those beautiful balloons!'[roman type][line break]";
...
To say PresentAcceptanceFlav of (M - a shopkeeper):
	say "The [M] smirks at your request. [line break][speech style of M]'That's fine by me!'[roman type][line break]".
...
To compute diaper donating of (M - a shopkeeper):
	...
	if D is diaper:
		say "[speech style of M]'Did you really think you could just get away with stealing my shit?  You're going to regret this.'[roman type]  The [M] kicks you hard in your side!  [line break][variable custom style]Fuck![roman type][line break]";
	otherwise:
		...
		if D is diaper:
			...
			say "The [M] forces the [D] onto your body, and then begins spanking you roughly through the padding!  He is so strong that it still feels very painful. [line break][variable custom style][if the player is able to speak]'[end if]Ow ow ow ow owwwwww![if the player is able to speak]'[end if][roman type][line break]";
...
To compute diaper use of (M - a shopkeeper):
	...
	if D is diaper:
		say "The [M] begins masturbating furiously. [line break][speech style of M]'Looks like you haven't used that diaper yet... let me help you get started!'[roman type][line break]Pulling the front of your [D] away from your waist, he points the tip of his cock inside your warm padding. [line break][speech style of M]'Ugh, yes.....'[roman type][line break]He shoots ropes and ropes directly onto your [genitals], where it starts to drip and soak into your padding. He lets go of the waistband, and it snaps back into place.";
...
To say WhoQuestion of (M - a shopkeeper):
	if discount is -1 or discount > 0 or M is uninterested or diaper quest is 1 or M is unfriendly:
...
To say BoringWhoAnswer of (M - a shopkeeper):
...
To compute successful dominance of (M - a shopkeeper):
...
To compute unique dominance reward of (M - a shopkeeper):
	compute power bottom reward of M.

To say DominanceSuccess of (M - a shopkeeper):	
	say DominanceIntro of M;
	now refactoryperiod is 1;[Ensures the player does not orgasm too early during the scene]
	unless M is wrapped:
		say "You spit on [his of M] [manly-penis], lubing [him of M] up a bit and breathing in his rich aroma while nuzzling around the shaft before finally lining up the tip with your hole.";
...
To vaginal dominate (M - a shopkeeper):[The shopkeeper dominant sex is more about him seducing you. You always get a discount, but its smaller the less of his cum you dealt with. The more you get seduced, the more you get a discount]
...
To anal dominate (M - a shopkeeper):
	...
	otherwise:[blacked]
		...
		say AfterDominationComment 3 of M;
		Dignify 10;
		if C is 1, FavourUp M by 2;[if you didn't get to cum, you did a better job sucking his dick after]
...
To replace (M - a shopkeeper) after domination:
...
To compute successful dominance of (M - a shopkeeper):
	...
	DifficultyUp M by 3;
	[Satisfy M;]
	if the location of M is Dungeon41, say "[line break]The [M] pops a blue pill and hops to his feet, full of energy.[line break]You feel more dominant!";
	otherwise say "[line break]The [M] slinks away as soon as [he of M] has the strength.[line break]You feel more dominant!". 

To say AfterDominationComment (N - a number) of (M - a shopkeeper):
	if N is 1:
...
To say DominanceFailure of (M - a shopkeeper):
	say DominanceIntro of M;
	unless M is wrapped:
...
To compute failed dominance punishment of (M - a shopkeeper):
	if the number of worn removable stolen clothing  + the number of held stolen clothing > 0:
		...
		repeat with T running through removable clothing:[If you're stolen anything, he takes EVERYTHING]
...
To say DragFlav of (M - a shopkeeper) to (R - Dungeon03):[The stone cell]
...
To say DragArrival of (M - a shopkeeper) to (R - Dungeon03):
...
To say DragFlav of (M - a shopkeeper) to (R - Dungeon05):[Storage room]
	say "[speech style of M]'Lets take this someplace private.'[roman type][line break]".

To say DragArrival of (M - a shopkeeper) to (R - Dungeon05):
...
To say DragFlav of (M - a shopkeeper) to (R - Dungeon08):[Training room]
	say "[speech style of M]'Lets take this somewhere more fun.'[roman type][line break]".

To say DragArrival of (M - a shopkeeper) to (R - Dungeon08):[The shopkeeper puts a dildo in one of your fuckholes]
