...
To compute fuckhole climax of (M - a shopkeeper):[TODO: break up]
	...
	if the player is a living sex doll:
		...
		otherwise if M is penetrating vagina:
			...
			CumThighsUp 2;
			WombFill 3;
		otherwise: [Must have been penetrating mouth. Do we fill mouth too, like we do AssFill and WombFill? No, since I have him pulling out , currently]
	...
	otherwise:
		say CreamPieFlav of M;
		if M is penetrating vagina, WombFill 3;
		otherwise AssFill 3;
	...
	if M is penetrating vagina and pregnancy fetish is 1 and the pregnancy of the player is 0:
		say "[first custom style][if the bimbo of the player < 6][one of]I can[']t believe he came inside. What if...? [or]W-what if I get pregnant? [or]Please don't let me be pregnant.... [at random][otherwise if the bimbo of the player < 12][one of]Doesn[']t he know I could get pregnant like this?[or]I could actually get pregnant from that...[or]Couldn[']t he have done it up my ass instead...[or]I[']m going to feel so dumb if I find out there are condoms in this game...[at random][otherwise][one of]I hope I get pregnant...[or]I hope that was enough to put a bun in my oven...[or]I know I might get pregnant from that, but it just feels so good...[or]It's no fun unless it's risky...[at random][roman type][line break]";
	send M home.

To say PullOutFlav of (M - a shopkeeper):
...
To compute anal climax of (M - a shopkeeper):
	compute fuckhole climax of M.

To compute vaginal climax of (M - a shopkeeper):
	compute fuckhole climax of M.
