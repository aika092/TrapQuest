...
To say MonsterComment of (M - a shopkeeper):
	...
	otherwise say "[if interracial fetish is 1 and the bimbo of the player < 4][line break][first custom style]Ugh, that [DickDesc of M] is so big, there's nowhere else I can look![otherwise if interracial fetish is 1 and the bimbo of the player < 7][first custom style]Why can't I look away from [his of M] massive black [DickDesc of M]?[otherwise if interracial fetish is 1 and the bimbo of the player < 11][line break][variable custom style]Wow, it's just so big, and... majestic...[otherwise if interracial fetish is 1 and the bimbo of the player < 14][variable custom style]I'm getting weak at the knees just looking at that majestic snake...[otherwise if interracial fetish is 1][line break][second custom style]I hope she'll let me worship [his of M] godly [manly-penis].[otherwise if the player is female and the bimbo of the player < 6][first custom style][one of]Ugh. Put your [manly-penis] away, sicko.[or]Oh I get it, he doesn't trust women so he has to watch me all the time. Misogynist.[or]This harlot isn't even wearing clothes. Who does she think she is?[or]She looks so sure of herself. Typical. She should know that [DickDesc of M] doesn't mean anything to anyone.[or]A woman in charge of the shop. I like it, but I wish she wasn't naked.[in random order][otherwise if the bimbo of the player < 6][first custom style][one of]I probably shouldn't steal anything. She'd definitely notice.[or]That bitch is cut! Maybe I should get [him of M] to give me some workout tips. After she puts some underwear on, of course[or]This chick looks like she knows [his of M] stuff. Wish she'd put some pants on, but still.[in random order][otherwise if the bimbo of the player < 10][variable custom style][one of]I can't stop staring at [his of M] [DickDesc of M].[or]She looks strong. I wonder what it would feel like if she let me touch [his of M] muscles.[or]I shouldn't steal anything. Who knows how she might punish me.[or]I don't think I could outrun [him of M] if I stole something. [big his of M] body is just, wow.[in random order][otherwise][second custom style][one of]She's really sexy![or]What a yummy looking [DickDesc of M]![or]I want to touch [his of M] muscles.[or]What a HUNK![or]I can't stop staring at [his of M] [DickDesc of M]! It looks so yummy![in random order][end if][roman type][line break]".
...
To compute appearance assessment of (M - shopkeeper):
	...
	if the appearance of the player > the outrage tolerance of M:
		FavourDown M by 1;
		if M is unfriendly:
			say "[speech style of M]'When you keep coming to my shop looking like that, I think it's only fair that we fuck before we do business...'[roman type][line break][big he of M] adopts a martial arts stance!";
