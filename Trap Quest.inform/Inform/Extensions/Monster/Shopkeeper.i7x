...
Definition: shopkeeper (called M) is manly-wenchy:
	decide yes.
...
To decide which number is the outrage tolerance of (M - shopkeeper):
	decide on the bimbo tolerance of M - 3.
...
To say BecomesAggressive of (M - shopkeeper):
	say "[big he of M] takes an offensive stance![line break][speech style of M]'[one of]I can't take you seriously at all! We should be fucking, not doing business.'[or]There's no time for shopping now, there's something much more important we must do first...'[in random order][roman type][line break]".
...
To vaginal dominate (M - shopkeeper):[The shopkeeper dominant sex is more about [him of M] seducing you. You always get a discount, but it's smaller the less of [his of M] cum you dealt with. The more you get seduced, the more you get a discount]
...
To anal dominate (M - shopkeeper):
	let V be the anal sex addiction of the player * 2 - the dominance of the player;[sex addiction and openness are factored into this check, since it's the dominance of the player]
...
To say DragFlav of (M - shopkeeper) to (R - Dungeon05):[Storage room]
	say "[speech style of M]'Lets take this some place private.'[roman type][line break]".
