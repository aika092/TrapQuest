...
To say DominanceFailure of (M - shopkeeper):
	...
	otherwise:
		say DominanceIntro of M;
		unless M is wrapped:
			say "You stick out your tongue at [him of M], giving [his of M] face a good smack as [if the player is not possessing a vagina]you grind your bare [AssDesc] against [his of M] hardening [manly-penis][otherwise]you grind [his of M] hardening [manly-penis] between your naked lower lips[end if].";
...
To say DragArrival of (M - shopkeeper) to (R - Dungeon08):[The shopkeeper puts a dildo in one of your fuckholes]
	...
	while D is unique and N < 25:
		...
		increase N by 1;
	if the player is possessing a vagina and D is vaginally summonable:
