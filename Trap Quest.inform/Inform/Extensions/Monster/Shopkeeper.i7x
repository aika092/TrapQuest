...
To set up (M - shopkeeper):
	...
	now the raw difficulty of M is 14;
	now M is guarding;
...
To compute unique banishment of (M - shopkeeper):
	...
	if X is a thing and full-lady fetish is 1 and a random number between 1 and 3 is 1 and the player is the donator:
		now the strap-length of X is 10;
		say "[BigNameDesc of M] leaves [his of M] [X] behind.";
