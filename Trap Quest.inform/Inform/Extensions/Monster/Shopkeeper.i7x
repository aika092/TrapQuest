...
To decide which number is the bimbo tolerance of (M - shopkeeper):
	...
	if interracial fetish is 1, decide on 12;
	decide on 15.
...
To say DamageReactSubmissive of (M - shopkeeper):
	say "[BigNameDesc of M] recoils slightly, angling [his of M] crotch away from you.".
...
To anal dominate (M - shopkeeper):
	...
	otherwise:[blacked]
		...
		if M is wrapped:
			say "[big he of M] comes with the force of an avalanche, holding your hips tightly as [he of M] floods the condom with a massive load of [semen], your [if there is a worn chastity cage]cage hanging uselessly[otherwise if the size of penis is 0]heart thumping in your chest[otherwise if the size of penis < 4][sissy-penis] hanging uselessly over [his of M] belly[otherwise]resting uselessly on [his of M] belly[end if] as [his of M] thrusting slows down.[line break][second custom style]I have to taste it.[roman type][line break] You pull off [him of M] slowly, savouring the feeling of the warm, stretchy bulge inside you as you kneel down in front of [him of M], [if C is 1]half-realizing you didn't get to cum[otherwise if the size of penis < 4]rubbing your [sissy-penis] with two fingers[otherwise]pumping away with one hand[end if] as you peel the latex sheath from [his of M] softening [manly-penis] and eagerly dump its contents into your mouth. [if C is 1]You also realize [i]exactly[/i] how dominant it is to top things off like this, but it's too hard to swallow everything at once, so you focus on that instead[otherwise]It's a little hard to swallow all at once, so you still have a good amount of it in your mouth as you go over the edge, panting the ground with your [load] as you realize [i]exactly[/i] dominant it was to top it all off with something like this[end if]";
			if C is 0, orgasm;
