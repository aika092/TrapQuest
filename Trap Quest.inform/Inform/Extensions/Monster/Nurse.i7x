...
nurse is in School11. The text-shortcut of nurse is "nrs". nurse has a number called boost-cooldown. nurse has a number called boost-int-drain. nurse has a number called breast-enhancement.
