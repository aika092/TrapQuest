...
To compute teaching of (L - tits-lesson):
	...
	say "[speech style of M]'Breasts.'[roman type][line break][NameDesc of M] stands at the front of the room with [his of M] hands at [his of M] hips, [his of M] giant chest gently heaving up and down in front of [him of M] as [he of M] breathes.[line break][speech style of M]'A woman's most important seductive tool, and a great symbol of [his of M] power. Why is it then, that so many of you fools do not spend your lives seeking new ways to enhance and empower your primary assets?'[roman type][line break]";
	allocate 35 seconds;
...
To say MonsterDesc of (M - teacher-hannah):
	say "This talk thin [man of M] has straight dark brown hair and is wearing a tight black latex dress that goes down to [his of M] knees. If it wasn't for the shiny, fetishy nature of [his of M] dress, you wouldn't then there was anything unusual about [him of M] at all. However having said that, [his of M] gaze and posture does seem to exude a great amount of confidence and strength.".
...
To compute unique death of (M - teacher-hannah):
	if wrist collar bar is in-play:
		if skeleton key is off-stage:
			say "[BigNameDesc of M] silently slumps to the ground, dead. The only thing of value on [his of M] body appears to be a [skeleton key]!";
...
To say MonsterDesc of (M - teacher-bianca):
	say "This tall curvy lady has long red and black hair. [big his of M] tight latex dress has a red-on-black polka dot pattern. A curved section at the bottom of the front of the skirt is missing, the resulting gap rising high enough to fully expose [his of M] black panties. [big he of M] seems completely comfortable with [his of M] appearance.".
