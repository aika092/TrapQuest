...
To compute (M - a monster) stomping (N - an aeromancer):
	if M is in the location of the player, say "With lightning speed [NameDesc of M] grabs the [N] and starts fucking [his of N] ass furiously. [big he of N] screams in both pleasure and terror and [he of M] starts coming inside [him of N] within seconds. [big his of N] belly expands in front of [him of N] as [he of M] fills [him of N] up. After [he of N] is full, [he of M] tosses [him of N] to the ground, where [he of N] promptly faints.";
...
To say DamageReactWeak of (M - an aeromancer):
	say "[BigNameDesc of M] takes the hit, [if M is confident aeromancer]angrily fighting to[otherwise]tears streaming down [his of M] face as [he of M] fights to[end if] maintain [his of M] balance!".
...
To anal dominate (M - an aeromancer):
	if sexual-penis-length >= 9:
		if lady fetish is 2, say "You throw [NameDesc of M] to the ground, ripping off [his of M] and [his of M] panties in one motion. [big his of M] eyes widen as the catches a glimpse of your hardening [sexual-player-penis], and suddenly [his of M] wand begins to crackle with energy. [big his of M] face sinks as it flies through the air and lands in your hands. [line break][speech style of M]'W-what?! You're betraying me?! I was only looking!'[roman type][line break]";
		...
		now player-fucking is DOMINANT-SUPER;
	otherwise if sexual-penis-length >= 7:
		if lady fetish is 2, say "You throw [NameDesc of M] to the ground, ripping off [his of M] and [his of M] panties in one motion. [big his of M] wand crackles with energy as [he of M] points it at you, and [his of M] face visibly sinks as it flies through the air and lands in your hands. [line break][speech style of M]'This blows. Oh well. At least do me a favour and fuck me, alright?'[roman type][line break]";
		say "[big he of M] rolls over onto [his of M] hands and knees, reaching back and pointing your [sexual-player-penis] at [his of M] asshole. It's not convincing, but you're in a merciful mood, so you grab [him of M] by the hips and groan as you slide your [sexual-player-penis] into [his of M] asshole. [big he of M] does all the work, panting with mixed arousal and exertion as [he of M] slowly brings you to orgasm. It doesn't take long, but [he of M]'s covered in a fine sheen of sweat by the time you finally do fire off your [load] into [his of M] ass.";
		say AfterDominationComment 7 of M;
		moderateDignify;
		now player-fucking is DOMINANT-SUPER;
	otherwise if sexual-penis-length >= 4:
		if lady fetish is 2, say "You throw [NameDesc of M] to the ground, ripping off [his of M] and [his of M] panties in one motion. [big his of M] wand crackles with energy as [he of M] points it at you, and [his of M] face visibly sinks as it flies through the air and lands in your hands. [line break][speech style of M]'This blows. Oh well. At least do me a favour and fuck me, alright?'[roman type][line break]";
		say "[big he of M] rolls over onto [his of M] hands and knees, reaching back and pointing your [sexual-player-penis] at [his of M] asshole. It's not convincing, but you're in a merciful mood, so you grab [him of M] by the hips and groan as you slide your [sexual-player-penis] into [his of M] asshole. [big he of M] does all the work, panting from exertion as [he of M] works [his of M] hips back against you. You don't last long, groaning with pleasure as you pull out and jizz all over [his of M] back.";
		say AfterDominationComment 7 of M;
		slightDignify;
		now player-fucking is DOMINANT-SUPER;
	otherwise:
		if lady fetish is 2, say "You force [NameDesc of M] onto [his of M] back, pulling up [his of M] skirt and ripping off [his of M] panties. [big he of M] begins to raise [his of M] wand, but you immediately yank it out of [his of M] hands. It seems to react to your touch, crackling with energy as [his of M] clothes disappear completely, leaving [him of M] naked. [big he of M] puts [his of M] hand on your shoulder as you line up your [SexDesc of penis] with [his of M] asshole. [line break][speech style of M]'Look, I know you're trying to dominate me and all, but I'm really going to need my wand back. Now.'[roman type][line break][big he of M] grins as you hand it back to [him of M].[line break][speech style of M]'Thanks a lot. Ok, go ahead.'[roman type][line break]";
...
To compute tornado experiment of (M - an aeromancer):
	...
	if the size of penis >= 9 or the health of M < 3:
		say "It feels incredible for a moment, but the cone dissipates after only a couple seconds. [line break][speech style of M]'Wow, looks like I[']m gonna have to turn up the juice!'[roman type][line break][BigNameDesc of M] furrows [his of M] brow as [he of M] raises [his of M] wand again, chanting under [his of M] breath as a second wind tunnel twice as large as the original slowly flows from the tip of [his of M] wand, sucking in air from all around you as it assaults your penis with a rapidly intensifying vortex of pressure. The aeromancer struggles to maintain the spell, clothes ruffling in the wind and eventually tearing off as the suction builds and builds, torturing you with an ever mounting onslaught of pleasure.";
...
To say CreampieFlav of (M - confident aeromancer) in (F - asshole):
	say "[BigNameDesc of M] fucks you harder and harder, wild gusts of wind screaming through the trees as [his of M] magical phallus pulses with its climax. You groan involuntarily as your belly fills up with torrent after torrent of compressed air, each one leaving a wider smirk on the aeromancer's face.";
