...
To say LeftoverDesc (N - 113):
	say "An unconscious aeromancer on the ground has a [if pregnancy fetish is 1]pregnant looking[otherwise]fully stretched[end if] belly and [semen] slowly flowing out of [his of an aeromancer] asshole.[line break]";
...
To say SexSubmissionFlav of (M - an aeromancer): [this is customized because I rewrote the scene so the player is floating a couple feet off the ground.]
...
To compute SelectionFailure of (M - an aeromancer):
	say "[BigNameDesc of M] finds [himself of M] unable to use you how it planned, and seems to settle for casting a simple spell. ";
...
To vaginal dominate (M - an aeromancer):[TODO: Consolidate]
	...
	if sexual-penis-length >= 9:
		say "[line break][speech style of M]'But you're... y-you're huge! C-couldn't you just use my ass? I'll even let you keep my wand.'[roman type][line break]Go for [his of M] ass instead?";
		if the player is consenting:
			anal dominate M;
		otherwise:
...
To say TwosomePrep of (M - confident aeromancer) in (F - asshole):
	say "[BigNameDesc of M] stretches out [his of M] arms and hands towards you. You yelp as you are suddenly forced several feet off the ground by a powerful gust of wind. Cackling with glee, the aeromancer uses [his of M] mastery of air to buffet you from one end of the [if M is in the Woods]clearing[otherwise]room[end if] to the other, eventually leaving you suspended in the centre, at just above waist height. [big he of M] takes a couple steps forward, barely containing [his of M] mirth as you [if the relevant sex addiction of M < 7]desperately try and fail to get purchase on the ground below[otherwise]look up at [his of M] in wide-eyed anticipation[end if].".
