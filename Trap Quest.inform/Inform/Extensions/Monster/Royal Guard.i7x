...
To say LeftoverDesc (N - 101):
	say "[if diaper quest is 1]A babified royal guard is sitting on the ground here, with a full nappy and a giant rattle. [big he of a royal guard] seems completely unaware of anything other than [his of a royal guard] own shame.[otherwise]The dead crumpled corpse of a royal guard is on the ground here[end if].[line break]";
...
To compute (M - a monster) stomping (N - a royal guard):[generic M here, but shouldn't matter.]
	...
	otherwise:
		if N is in the location of the player, say "[BigNameDesc of M] forcefully pushes the [NameDesc of N] to the ground and stamps on [his of N] body. [BigNameDesc of N] is now motionless on the ground.";
