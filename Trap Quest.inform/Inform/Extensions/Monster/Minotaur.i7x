...
A dungeon boss is a kind of monster. minotaur is a dungeon boss. minotaur is male. The leftover-type of minotaur is 107.

Definition: A minotaur (called M) is dungeon dwelling:
	if diaper quest is 1, decide no;
	decide yes.

minotaur is in Dungeon36. minotaur is captive. Figure of minotaur is the file "NPCs/Bosses/Minotaur/minotaur1.png". Figure of minotaur caged is the file "NPCs/Bosses/Minotaur/minotaur2.png". Figure of hulk is the file "NPCs/Bosses/Minotaur/hulk1.png".  The text-shortcut of minotaur is "mi". Understand "large", "hulk" as minotaur.
...
To say MediumDesc of (M - minotaur):
	say "large [ShortDesc of minotaur][if the item described is captive] (caged)[end if]".

Definition: minotaur (called M) is willing to do oral:
	decide no.

Definition: minotaur (called M) is willing to do titfucks:
	decide no.

To decide which figure-name is the monster-image of (M - minotaur):
	if mythical creature fetish is 1:
		if M is captive, decide on figure of minotaur caged;
...
This is the spawn initial minotaur rule:
	...
	if diaper quest is 1:
		remove minotaur from play;
	otherwise:
		if minotaur is released and minotaur is alive, summon minotaur in the dungeon.
...
To compute motion of (M - minotaur):
	if M is released:
	...
	if current-monster is captive:
		if current-monster is automatically tempted:
			if (a random number between 1 and 4 is 1 or wanking > 1) and the blue-balls of current-monster < 5:
				say "[one of][BigNameDesc of current-monster] turns toward you, grunting primally as [he of current-monster] vigorously thrusts [his of current-monster] giant [manly-penis] through the sturdy bars of [his of current-monster] cage.[or][BigNameDesc of current-monster] stares holes in your skull, drooling slightly as [he of current-monster] roughly humps the space between the heavy bars of [his of current-monster] cage.[or][BigNameDesc of current-monster] never once looks away from you, hungrily thrusting [his of current-monster] massive [manly-penis] through the bars of [his of current-monster] cage, panting roughly as [he of current-monster] smears them with thick, slimy pre-cum.[in random order]";
...
To say ArousedCagedMinotaurFlav:
	say "[one of][BigNameDesc of current-monster] thrusts his arm through a gap in his cage, grasping at the empty air between you.[or][BigNameDesc of current-monster] fixes you with an intimidating stare, furiously masturbating with obvious hunger in his eyes.[or][BigNameDesc of current-monster] stares at you with obvious and unrestrained arousal.[or][BigNameDesc of current-monster] stares at you with unrestrained lust in his eyes. [if the bimbo of the player < 8]You feel uncomfortable.[otherwise if the bimbo of the player < 12][line break][otherwise]You feel sexy![end if][or][BigNameDesc of current-monster] seems incredibly taken with your crotch.[in random order]".

To say CagedMinotaurMessFlav:
	let L be a random number between 2 and 4;
	say "[BigNameDesc of current-monster] roars as his cock explodes all over the floor and walls around [him of current-monster]. [run paragraph on]";
...
To compute fuckhole sex of (M - minotaur):
	...
	if the sex-length of M > 0:
		if the sex-length of M is 1, say "[BigNameDesc of M] roars as you feel [one of][him of M] start to ejaculate[or]cum spurting into your [variable F] in waves[or][his of M] [manly-penis] erupt inside of you[or][his of M] balls begin emptying themselves inside of you[in random order]! But [he of M][one of] doesn't stop fucking you.[or]'s still going![or] doesn't stop plowing you at all.[or] doesn't relent with [his of M] brutal pounding![at random]";
		otherwise say "[one of][BigNameDesc of M] is brutally plowing away at your [variable F]![or][BigNameDesc of M] grunts primally as [he of M] pounds your poor [variable F]![or][BigNameDesc of M] growls hungrily as [his of M] [if mythical creature fetish is 1]massive horsecock[otherwise]massive cock[end if] jack-hammers your [variable F].[or][BigNameDesc of M] holds you with a rigid death-grip as [he of M] slams in and out of your [variable F].[or][BigNameDesc of M] holds you down with an ironclad grip as [he of M] brutally pounds your [variable F]![or][BigNameDesc of M]'s massive [if mythical creature fetish is 1]furry [otherwise]nutsack[end if] slaps audibly against your taint as [he of M] brutally jack-hammers your [variable F].[in random order]";
	...
	otherwise:
		...
		otherwise say "[one of]Relaxing your [variable F], you accept the virtually endless torrent of [semen] into your [BellyDesc].[or]You do your best to stay relaxed as [his of M] [semen] spurts into your belly.[or]You can feel [his of M] [manly-penis] twitching as it continues to spurt [semen] into your [BellyDesc].[or]Relaxing your inner muscles, you accept the unending torrent of [semen] into your [BellyDesc].[at random]";
...
This is the minotaur replaces the monster rule:
	...
	say "[BigNameDesc of M] kicks the [N] out of the way, and takes over! [big he of M] [one of]sticks [his of M] giant [manly-penis] in your [asshole],[or]shoves [his of M] massive [manly-penis] up your ass[or]jams [his of M] giant dick into your [asshole][or]clumsily rams [his of M] huge dick in your [asshole][at random] and [one of]starts cumming[or]starts to cum[at random] almost immediately!  [line break][variable custom style][if the anal sex addiction of the player < 4]Oh Fuck![otherwise if the anal sex addiction of the player < 6]I thought I was safe with the [N] inside me![otherwise]Finally, a real dick![end if][roman type][line break]";
...
To get anal penetration image for (M - minotaur):
	if image cutscenes is 1 and mythical creature fetish is 1, display figure of minotaur cutscene 3.

To say AssholePenetrationFlav of (M - minotaur):
	say "[BigNameDesc of M] [one of]forcefully pushes [his of M][or]clumsily rams [his of M][or]jams [his of M][or]forces [his of M][at random] giant [manly-penis] into your [asshole], and starts fucking you furiously!  [if the sex-length of M is 0]Within seconds, [he of M] has started cumming inside you![otherwise]Your [asshole] is instantly stretched beyond belief.[end if]".

To get vaginal penetration image for (M - minotaur):
...
To compute unique death of (M - minotaur):
	let H be a random off-stage horn;
	if mythical creature fetish is 1 and H is a thing:
		say "The minotaur falls to the ground, dead. One of [his of M] horns smacks into the ground and snaps clean off. The [ShortDesc of H] appears to be hollow - you could almost use this as a drinking vessel!";
		now H is in the location of the player;
		compute autotaking H;
	otherwise:
		let B be a random off-stage potion of bull strength;
		say "[BigNameDesc of M] falls to the ground, defeated. [if B is potion][big he of M] dropped a [ShortDesc of B]![end if]";
		if B is potion:
			now B is in the location of the player;
			compute autotaking B.

[To uniquely destroy (M - minotaur):
	now M is captive.]
