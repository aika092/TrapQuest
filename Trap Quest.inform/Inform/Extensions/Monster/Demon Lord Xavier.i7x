...
To compute (M - demon lord) sexRuin in (F - a fuckhole):
...
To say CondomFailFlav of (M - demon lord) in (O - a fuckhole):
	say "[BigNameDesc of M] [one of]roars with pleasure, pushing the condom further and further off his [manly-penis] with the sheer force of his ejaculation[or]groans in pleasure, ejaculating with such force that condom is slowly dragged further and further off his [manly-penis][or]balloons the condom with his load, roaring with pleasure as the insane force of his ejaculation pushes it further and further off his [manly-penis][at random]. You feel every throb that much more intimately than the last, [one of]knowing it's far too late to escape[or]held too tightly to escape[or]completely pinned under his weight[at random] as a final, powerful spurt forces the condom off completely! He laughs powerfully as [one of]your unprotected [variable O] floods with his [semen], which leaks[or]his load explodes into your [variable O], flooding it with fresh [semen], which leaks[or]his [semen] coats the inside of your [variable O], leaking[at random] out slowly as he pulls out.".
...
To compute diaper mess reaction of (M - demon lord):
	if diaper quest is 1:
		...
		humiliate 200;
	otherwise:
		say "[BigNameDesc of M] looks at you with pure disgust in his eyes.[line break][speech style of M]'I DID NOT THINK THAT EVEN HUMANS WOULD DEBASE THEMSELVES TO SUCH DISGUSTING LEVELS[if M is uninterested].  GET OUT OF MY SIGHT[end if].'[roman type][line break]";
	humiliate 200.
