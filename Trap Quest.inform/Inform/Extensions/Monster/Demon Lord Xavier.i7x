...
Definition: demon lord is willing to do oral if diaper focus is 1.
...
To unseal xavier from (M - a monster):
	...
	if M is in the location of the player:
		...
		if O is body part, say "[big his of M] [DickDesc of M] grows most of all, utterly filling your [variable O] with its huge girth as [he of M] fucks you with renewed enthusiasm.";
		otherwise say "[big he of M] is looking upwards, and doesn't seem to be talking to anyone in particular. You realise this might be a sensible moment to try and make a quick exit...";
...
To compute perception of (M - demon lord):
	...
	otherwise if virgin of the player is 1 and the player is gendered female:
...
To compute unique climax of (M - demon lord) in (F - a fuckhole):[assumes M is male]
	fullscreencutshow figure of xavier cutscene 2 for M;
...
To say StrikingFailureFlav of (M - demon lord) on (B - a body part):
	say "[BigNameDesc of M] tries to scratch you [TargetName of B] with a claw but you dodge quickly. [big he of M] still manages to land a glancing blow! Ouch!";
	BodyRuin 1.
...
To compute punishment of (P - xavier-nightmare-belt):
	...
	if diaper messing < 3, fullscreencutshow figure of cutscene-xavier-nightmare-belt-clean for M;
	...
	if diaper messing >= 3, fullscreencutshow figure of cutscene-xavier-nightmare-belt-messy for M;
...
To say NonEnthusiasmResponse of (M - demon lord):
	if the class of the player is princess:
		say "[first custom style]'[one of]HAHAHA! THIS IS MY REVENGE, PRINCESS!'[or]LOUDER! ALL OF BIMBACIA MUST KNOW OF YOUR SERVITUDE!'[or]YOUR PUNISHMENT IS ONLY BEGINNING, DEAR PRINCESS!'[or]YOU HAVE ONLY YOURSELF TO BLAME, PRINCESS!'[at random][roman type][line break][BigNameDesc of M] claps you harshly across the ass.";
		PainUp 1;
	otherwise:
