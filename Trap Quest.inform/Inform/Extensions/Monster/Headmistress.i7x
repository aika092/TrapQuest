...
To say MonsterDesc of (M - headmistress):
	if M is sex-enslaved:
		if lady fetish is 2:
			say "[BigNameDesc of M][']s dress has been opened further at the front, including a big slit in the skirt section right revealing [his of M] bright red chastity cage. A presumably new tattoo sits above [his of M] [sissy-penis], with the words 'Enter in Rear' and an arrow pointing toward his butt. His ass has been made more easily accessible with the addition of a very long ankle spreader bar, which keeps his feet over a metre apart from each other at all times. A tally has been started on his right inner thigh. Looks like he's been fucked at least five times already. One ear has been pierced and a large 'SLUT' tag added. His wrists are cuffed behind him, leaving him absolutely powerless to stop anyone using him as they please. His tongue is stuck out of hos mouth with a lewd expression. You watch as he instinctively tries to draw it back into his mouth, but then hos 'SLUT' tag flutters wildly as [his of M] earring gives [him of M] a painful electric shock. He whimpers and returns to sticking his tongue as far out of his mouth as he can.";
		otherwise:
