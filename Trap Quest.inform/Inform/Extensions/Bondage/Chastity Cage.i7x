...
To compute unique summoning of (C - a chastity cage):
	if the player is possessing a penis, now the size of C is the size of penis.

Definition: a chastity cage is sissifying: decide yes.
Definition: a chastity cage is pink themed if the player is gendered male.
Definition: a chastity cage is grey themed if the player is gendered female.
