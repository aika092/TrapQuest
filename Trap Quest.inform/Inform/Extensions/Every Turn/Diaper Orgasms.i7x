...
To compute spontaneous cumbustion: [TODO: Make different levels of mess/urine soak/diaper addiction change probability]
	...
	if the player is diaper focused and the number of worn chastity cages is 0: [This also checks that the player is properly diapered]
		...
		if the player is able to orgasm and the diaper premature orgasm chance of the player > a random number between 5 and 8:
			if R < 6 and the urine-soak of D >= 6 and the mess of D > 0 and the diaper addiction of the player > 14:
				...
				orgasm;
			otherwise if R < 11 and the mess of D > 0 and the diaper addiction of the player > 14:
				...
				orgasm;
			otherwise if R < 3 and the urine-soak of D >= 6 and the diaper addiction of the player > 10:
		...
		otherwise if the player is able to get horny:
			if R < 16 and the urine-soak of D >= 6 and the mess of D > 0 and the diaper addiction of the player > 14:
			...
			otherwise if R < 11 and the mess of D > 0 and the diaper addiction of the player > 14:
				...
				arouse 300;
			otherwise if R < 6 and the urine-soak of D >= 6 and the diaper addiction of the player > 10:
				...
				arouse 300;
			otherwise if R < 4 and the urine-soak of D >= 6 and the diaper addiction of the player > 7:
