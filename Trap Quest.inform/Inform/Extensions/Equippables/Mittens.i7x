...
To say ClothingDesc of (W - a rubber mittens):
...
To say ClothingDesc of (W - a teddy bear mittens):
...
To decide which number is the initial cringe of (C - a teddy bear mittens):
	decide on 9.
...
To decide which object is the potential-upgrade-target of (C - a rubber mittens):
