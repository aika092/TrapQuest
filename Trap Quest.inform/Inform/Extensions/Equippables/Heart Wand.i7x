...
A heart wand is a kind of vibe-wand. A heart wand is usually unique. A heart wand is usually metal. There is 1 heart wand. The printed name of heart wand is "[TQlink of item described][item style][unless magic-curse of the item described is bland or curse-ID of the item described is unsure][magic-curse] [end if][raw-magic-modifier-desc]heart wand[clothing-title-after][TQxlink of item described][verb-desc of item described]". The text-shortcut of heart wand is "hw".
