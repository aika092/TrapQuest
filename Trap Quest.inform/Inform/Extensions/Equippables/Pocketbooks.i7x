...
Carry out browsing book of regrets:
	...
	otherwise if the pregnancy of the player > 0 and R is 1:[Probably too vicious a penalty but that's what you get!]
		say "'[one of]My belly is getting way too big! Next time that [printed name of the father] wants to breed me with [his of the father] big, [line break][second custom style]virile[roman type][line break][manly-penis], I[']m going to make [him of the father] wear a condom. UGH![or]I never should have let that [printed name of the father] stick [his of the father] [line break][second custom style]yummy[roman type][line break][manly-penis] in me and fertilize me with [his of the father] [semen]! I wish I wasn[']t pregnant![or]I can[']t believe that [printed name of the father] pumped me so full of [line break][second custom style]virile[roman type][line break]sperm! Didn[']t he know this would happen if he stuck that [line break][second custom style]yummy[roman type][line break][manly-penis] in my pussy?[at random] I want a do-over.' You cringe at what's written on the page, partly because of the [if the bimbo of the player > 14][line break][second custom style]prudish[roman type][line break][end if]wording, but also because it so accurately echoes the regret you've been holding in the pit of your stomach ever since you got pregnant. Suddenly, the book begins to glow, and the words start erasing themselves from the page! Dizziness passes through your body as your belly shrinks and definition drains from your muscles. You drop to your knees as an [if the semen volume of vagina > 9]absolutely obscene[otherwise if the semen volume of vagina > 4]obscene[otherwise]huge[end if] amount of [semen] comes dribbling down your thighs.[line break]";
		try kneeling;
	...
	otherwise if R is 1 and the virgin of the player is 0 and the player is female and the openness of vagina > 5:
		say "'[one of]I just can't stop thinking about the way I lost my cherry. My tight little [line break][second custom style]cumdump[roman type][line break]got ruined by that big, hard [manly-penis]! Now, it's like everybody wants to pin me down and [if pregnancy fetish is 1]breed my hot box[otherwise]come inside me[end if]! Life is so unfair[or]I can't believe I let anybody put their [manly-penis] in my [line break][second custom style]fuckhole[roman type][line break]! Now whenever I get fucked, I have to think about my first time, and how huge that [line break][second custom style]yummy[roman type][line break][manly-penis] was[or]I can barely look at myself in the mirror ever since I lost my virginity! All I can think about is getting pounded into the floor by that heavenly [manly-penis]. Umm, hellooo, if I wanted to be treated like the [line break][second custom style]worthless cumdumpster I am[roman type][line break], I would ask[at random]! I want a do-over.' You cringe at what's written on the page, partly because of the [if the bimbo of the player > 14][line break][second custom style]prudish[roman type][line break][end if]wording, but also because it captures how you've always felt on the inside ever since you lost your purity. The words light up as the book emits a wave of energy, erasing themselves from the page as your [vagina] suddenly and very painfully begins tightening up.[line break]";
		PussyClose 5;
	...
	otherwise if R is 1 and the analvirgin of the player is 0 and the player is male and the openness of asshole > 5:
		say "'[one of]Ever since that first time, all I can think about is getting my prostate pounded by that huge [manly-penis]! Now, that's the only way I get any satisfaction at all! It's not my fault my [line break][second custom style]hot fuckhole[roman type][line break]makes such a great cumdump[or]I still get tingles in my [asshole] whenever I think about my first time. I[']d sit on anyone's [line break][second custom style]hard[roman type][line break]cock and bounce on it until they came if I could just get a second chance! It's only fair I should get to choose who breeds my [line break][second custom style]nasty fuckhole[roman type][line break][or]It seems like every time I meet a real man, he decides the best place for his [manly-penis] is up my sissy ass! I know you can[']t get your virginity back, but my [line break][second custom style]slutty boy hole[roman type][line break]is getting tired of all these thick [line break][second custom style]creamy[roman type][line break]loads[roman type][at random]! I want a do-over.' You cringe at what's written on the page, partly because of the [if the bimbo of the player > 14][line break][second custom style]prudish[roman type][line break][end if]wording, but also because it captures how you've always felt on the inside ever since your first time getting fucked that way. The words light up as the book emits a wave of energy, erasing themselves from the page as your [asshole] suddenly and very painfully begins tightening up.[line break]";
		AssClose 5;
		if the noun is blessed and a random number between 1 and 3 is 1, decrease P by 2;
	...
	otherwise if the semen addiction of the player > 0 and R < 4:
		say "'[one of]Sometimes I wish there was more to life than sucking my man's [line break][second custom style]fat monster[roman type][line break]until he comes. I know my place is on my knees, but it's getting out of hand! It's getting so hard to think when I'm not gargling a fresh load of [line break][second custom style]yummy dick juice[roman type][line break], and I KNOW it all started with that first blowjob[or]Whenever my lips are wrapped around a big [line break][second custom style]hard[roman type][line break]cock, I know it's what I was always meant to do, but I can't focus on anything else! There used to be more to life than a [line break][second custom style]delicious[roman type][line break]helping of yummy [line break][second custom style]man stuff[roman type][line break]for breakfast lunch and dinner, but I can[']t remember what[or][line break][second custom style]Man cream[roman type][line break]is my favourite food, but sometimes I wish I didn[']t have to spend so much time every day draining every pair of aching balls I run into! Every time I do it it feels even better than last time, and sometimes I run out of room in my [line break][second custom style]jizz tank[roman type][line break]in the middle of the day[at random]! I want a do-over.' You cringe at what's written on the page, partly because of the [if the bimbo of the player > 14][line break][second custom style]prudish[roman type][line break][end if]wording, but also because it captures how you feel about your growing addiction to blowjobs. The words light up as you move to turn the page, erasing themselves as it suddenly gets a lot harder to think about sucking cocks. It's a lot harder to think about anything...[line break]";
 		SemenAddictDown 1;
		if the noun is not blessed or a random number between 1 and 3 < 2, increase P by 1;
		IntDown P + 1;
	otherwise if the sex addiction of the player > 0 and R < 4:
		say "'[one of]Whenever I look at a man, all I can think about is getting naked and bouncing on his big hard [line break][second custom style]pants candy[roman type][line break]! I know I LOVE getting fucked senseless like the [line break][second custom style]nasty[roman type][line break]whore I am, but sometimes I miss what it was like before[or]It's like my [line break][second custom style]dirty cock warmer[roman type][line break]has a mind of its own sometimes. There is a time and place to get bent over a table and fucked full of [semen], but it's not all the time! If only I had a way to keep my [line break][second custom style]slutty cumdump[roman type][line break]in line, like I did before[or]Milking a cock with my [line break][second custom style]nasty[roman type][line break]fuckhole feels so good, and it's obviously the only thing I'm useful for. But, sometimes I think all this naughty sex I'm having is making me even more addicted to [line break][second custom style]fun[roman type][line break]poundings! Not like I could stop now, but I know my boyfriend is going to get bored eventually[at random]. I want a do-over.' You cringe at what's written on the page, partly because of the [if the bimbo of the player > 14][line break][second custom style]prudish[roman type][line break][end if]wording, but also because it captures how you feel about your growing addiction to sex. The words light up as you move to turn the page, erasing themselves as it suddenly gets a lot harder to think about getting fucked. It's a lot harder to think about anything...[line break]";
		SexAddictDown 1;
		if the noun is not blessed or a random number between 1 and 3 < 2, increase P by 1;
		IntDown P + 1;
	otherwise:[R is 4]
