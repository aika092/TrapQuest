...
Carry out browsing book of regrets:[TODO: player says something like "I didn't write that, but it's accurate" to replace the lack of coloured text]
	...
	otherwise:
		...
		if incontinence > 1 and (diaper messing < 3 or asshole is not actually occupied) and there is a worn diaper, set next numerical response to "Read the page about your [if the player is not incontinent]growing [end if]incontinence.";
