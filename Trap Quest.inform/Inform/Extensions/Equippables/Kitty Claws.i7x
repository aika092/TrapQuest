...
To say ClothingDesc of (W - a kitty claws):
	...
	if the class of the player is catgirl and W is worn, say "You feel [if the number of worn clothing < 4]excellent[otherwise if the number of worn clothing < 7]better[otherwise]worse[end if] at running away from monsters whilst on your knees.".
