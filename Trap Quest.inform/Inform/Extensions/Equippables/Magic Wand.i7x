...
A magic wand is a kind of vibe-wand. A magic wand is usually slap ready. A magic wand is usually unique. A magic wand is usually metal. There is 1 magic wand. The printed name of magic wand is "[TQlink of item described][item style][unless magic-curse of the item described is bland or curse-ID of the item described is unsure][magic-curse] [end if][raw-magic-modifier-desc]magic wand[clothing-title-after][TQxlink of item described][verb-desc of item described]". The text-shortcut of magic wand is "mw". Figure of magic wand is the file "Items/Accessories/Toys/goldenphallus1.png".
...
To say ClothingDesc of (W - a magic wand):
	say "A solid gold wand you stole from an aeromancer. Despite being made of metal, it feels almost completely weightless when you hold it in your hand, as if filled with some magic lighter than air gas. There is a switch on the bottom that reads 'Vibrate'. [line break][variable custom style][if the intelligence of the player < 4]Viii...braa..taay. What does that mean?[otherwise if the sex addiction of the player < 7]So its THAT kind of wand.[otherwise]I know what I'm going to use THAT for! Teehee![end if][roman type][line break]".
