...
The printed name of ballet heels is usually "[clothing-title-before]pair of [clothing-material of item described] [heel-height of the item described] inch ballet heels[clothing-title-after]". The printed plural name of ballet heels is usually "[TQlink of item described][item style]pairs of [clothing-title-before][clothing-material of item described] [heel-height of the item described] inch ballet heels[clothing-title-after]". The text-shortcut of ballet heels is "bh".
...
To decide which number is the hindrance-modifier of (C - a ballet heels):
	decide on 0.

To decide which number is the heel-skill-influence of (C - a ballet heels):
	decide on 2.

To say UniqueShortDesc of (C - a ballet heels):
	say "ballet heels".
