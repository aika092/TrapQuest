...
To decide which number is the heel-skill-influence of (C - a ballet shoes):
	decide on 20.

To say UniqueDesc of (C - a ballet shoes):
	say "ballet shoes".
...
Figure of ballet shoes is the file "balletshoes1.png".
...
This is the ballet shoes fix rule:
	repeat with C running through ballet shoes:
		now C is unique.
The ballet shoes fix rule is listed in the diaper quest fix rules.
...
Figure of sissy ballet boots is the file "balletshoes2.png".
