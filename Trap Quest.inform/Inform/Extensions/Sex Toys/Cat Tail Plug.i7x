...
A cat tail plug is a kind of balancing tail plug. A cat tail plug is unique. The printed name of cat tail plug is usually "[TQlink of item described][clothing-title-before][PlugSize size of item described] cat tail butt plug[clothing-title-after][TQxlink of item described][verb-desc of item described]". There is 1 cat tail plug. Figure of cat tail plug is the file "Items/Accessories/Toys/catplug1.png". The text-shortcut of a cat tail plug is "ctp".
...
Definition: a cat tail plug (called C) is cat themed:
	decide yes.
