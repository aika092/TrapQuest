	...
	if the toy-charge of P > 10:
		...
		otherwise:
			if the soreness of F > 7:
				say "[one of]Your [ShortDesc of P] slows down just enough to keep stimulating you without [if refractoryperiod < 1]getting you any closer to orgasm. How cruel![otherwise]making you more sore. The relief is nice, but you feel a mounting need for release.[end if][or][or]Your [ShortDesc of P] continues to stimulate you.[or][or][or][cycling]";
				passively stimulate F from P;
			otherwise:
