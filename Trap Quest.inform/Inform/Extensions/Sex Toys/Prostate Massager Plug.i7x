...
A prostate massager plug is a kind of plug. A prostate massager plug is unique. The printed name of prostate massager plug is usually "[TQlink of item described][clothing-title-before][PlugSize size of item described] [if the player is male]prostate[otherwise]G spot[end if] massager butt plug[clothing-title-after][TQxlink of item described][verb-desc of item described]". There is 1 prostate massager plug. Figure of prostate massager plug is the file "Items\Accessories\Toys\prostateplug1.png". The size of a prostate massager plug is usually 4. Understand "G spot", "spot" as prostate massager plug. The text-shortcut of a prostate massager plug is "mpl".
