...
A golden phallus is a kind of dong. A golden phallus is unique. The printed name of golden phallus is "[TQlink of item described][item style][unless magic-curse of the item described is bland or curse-ID of the item described is unsure][magic-curse] [end if]golden [if the bimbo of the player < 8]phallus[otherwise]dildo[end if][clothing-title-after]". The text-shortcut of golden phallus is "gd". The size of golden phallus is usually 3. There is 1 golden phallus. Figure of golden phallus is the file "Items/Accessories/Toys/goldenphallus1.png". The text-shortcut of a golden phallus is "gp". A golden phallus is usually metal.

Definition: a golden phallus is yellow themed: decide yes.
...
To compute climax effect of (C - a golden phallus):
	...
	if C is not cursed, BodyHeal 1;
	if C is blessed, BodyHeal 1;
	if the body soreness of the player < B, say "[bold type]Somehow your body feels a bit less bruised![roman type][line break]".

To decide which number is the crafting key of (C - a golden phallus):
	decide on 36.

Definition: a golden phallus is ingredient: decide yes.

Definition: a golden phallus is inflation themed: decide yes.
