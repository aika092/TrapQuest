...
Figure of no-image-yet is the file "noimage.png".
...
To say InfluenceDesc of (C - a clothing):
	...
	if the vaginal-sex-addiction-influence of C < 0, say "You can sense that this item is [if the vaginal-sex-addiction-influence of C < -1]significantly [end if]suppressing any [if the vaginal sex addiction of the player < 3]weird [end if]urges to [if the virgin of the player is 1]lose your virginity[otherwise]let guys fuck you in the pussy[end if].";
	if the vaginal-sex-addiction-influence of C > 0, say "You can sense that this item is making you [if the vaginal-sex-addiction-influence of C > 1]a lot [end if]more [if the virgin of the player is 1]tempted to lose your virginity[otherwise]eager to have vaginal sex[end if].";
	if the anal-sex-addiction-influence of C < 0, say "You can sense that this item is [if the anal-sex-addiction-influence of C < -1]significantly [end if][if the anal sex addiction of the player > 4]reducing your desire to engage in anal sex[otherwise if the analvirgin of the player is 1]helping you to suppress any urges to try out anal sex[otherwise]helping you to suppress any urges to seek out more anal sex[end if].";
	if the anal-sex-addiction-influence of C > 0, say "You can sense that this item is making you [if the anal-sex-addiction-influence of C > 1]a lot [end if]more [if the analvirgin of the player is 1]tempted to try anal sex[otherwise]eager to have butt sex[end if].";
	if the titfuck-addiction-influence of C < 0, say "You can sense that this item is [if the titfuck-addiction-influence of C < -1]significantly [end if][if the titfuck addiction of the player > 4]reducing your enjoyment of giving men titfucks[otherwise]helping you avoid any temptation to try pleasuring men with your breasts[end if].";
	if the titfuck-addiction-influence of C > 0, say "You can sense that this item is making you [if the titfuck-addiction-influence of C > 1]a lot [end if]more [if the titfuck addiction of the player < 5]aroused by the thought of massaging[otherwise]eager to pleasure[end if] a [manly-penis] between your breasts.";
	if the sex-addiction-influence of C < 0, say "You can sense that this item is [if the sex-addiction-influence of C < -1]significantly [end if][if diaper quest is 1]reducing your cravings for orgasms[otherwise if the sex addiction of the player > 7]reducing your enjoyment of submissive sex[otherwise]helping you maintain your preference for dominant sex[end if].";
	if the sex-addiction-influence of C > 0, say "You can sense that this item is making you [if diaper quest is 1]crave orgasms[otherwise if the sex addiction of the player > 7]enjoy submissive sex[otherwise]think about sex[end if] [if the sex-addiction-influence of C > 1]a lot [end if]more.";
	...
	if the delicateness-influence of C < 0, say "You can sense that this item is making you [if the delicateness-influence of C < -1]much [end if]better at coping with pain.";
	if the delicateness-influence of C > 0, say "You can sense that this item is making you [if the delicateness-influence of C > 1]much [end if]less tolerant of pain.";
...
Report examining clothing:
	if the noun is super-short:
		say "The skirt is so super short that you[unless the noun is worn][']ll still be completely exposed even when wearing it.[otherwise][']re still completely exposed.[end if] [if the humiliation of the player > 27500 and the outrage of the noun is not too humiliating and diaper quest is 0][line break][second custom style]Which is exactly what I want![roman type][line break]";
	otherwise if the noun is actually sheer:
		...
		if the noun is knickers or the noun is trousers or the noun is overdress or the noun is skirt or the noun is nipple covering and the noun is breast covering, say "The [if the noun is actually sheer]sheer [end if]nature of the item means that you[unless the noun is worn][']ll still be exposing your naughty bits even when wearing it[otherwise]r naughty bits are still visible[end if].[if the humiliation of the player > 27500 and the outrage of the noun is not too humiliating and diaper quest is 0][line break][second custom style]Which is exactly what I want![roman type][line break]";
		otherwise say "The [if the noun is actually sheer]sheer [end if]nature of the item means that you[unless the noun is worn]r skin will still be visible even when wearing it[otherwise]r skin is still visible[end if].[if the humiliation of the player > 27500 and the outrage of the noun is not too humiliating and diaper quest is 0][line break][second custom style]Which is exactly what I want![roman type][line break]";
	otherwise if the noun is short:
		say "The skirt is just long enough to cover your [if the size of penis < 4]naughty bits[otherwise][asshole][end if] as long as you never bend over[if the size of penis > 3], but it can't do anything to hide your [ShortDesc of penis], even when you're standing![otherwise].[end if] [if the humiliation of the player > 27500 and the outrage of the noun is not too humiliating and diaper quest is 0][first custom style]So, good as long as I don[']t act like a whore.[roman type][line break][second custom style]I can pretend to be modest but put my bits on display at the same time![roman type][line break][end if]";
...
Report examining clothing:
	...
	otherwise:
		...
		otherwise if diaper quest is 1 and the humiliation of the player < 40000 and the noun is too adult: [The item isn't humiliating at all!  Let's find out if the player finds it too boring.]
		...
		otherwise if the humiliation of the player < 40000: [The item isn't humiliating at all!  Let's find out if the player finds it too boring.]
