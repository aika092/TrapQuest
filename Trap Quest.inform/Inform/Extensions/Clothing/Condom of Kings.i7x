...
Check wearing condom of kings:
	if the player is female, say "Only a [if the bimbo of the player > 10][second custom style]sexy [roman type][end if]man could wear this." instead;
