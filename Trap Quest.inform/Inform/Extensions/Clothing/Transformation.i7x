...
To say TransformReaction of (C - a clothing): [We make the assumption it's worse.  We just need to assess how bad the damage is.]
	...
	otherwise if the outrage of C is too humiliating:
		...
		otherwise:
			...
			otherwise say "[variable custom style][one of]I feel very reluctant to let anyone[if there is an intelligent monster in the location of the player] else[end if] see me like this...[or]What a joke.  This is too trashy for me.[or]This is too nasty [if the humiliation of the player > 27500]even [end if]for me.[or]I'm not looking forward to people seeing me in this.[or]This is much worse![or]This is not my idea of an upgrade![or]Ugh.  I'm really tempted to take this off, it's just too much.[in random order][roman type][line break]";
	...
	otherwise if diaper quest is 1 and the humiliation of the player < 40000:
		 if C is equippable or C is bag of holding:
			say "[if C is too adult][second custom style][one of]Ugh, this is still way too boring for me![or]*sigh* Isn't there any way to make it even more obvious it's for babies?[in random order][otherwise if the bimbo of the player < 7][first custom style][one of]I don't have any problems with using this.[or]I'm fine holding onto this.[purely at random][otherwise][variable custom style][one of]Ooh, I look even more adorable with this![or]Ooh, how cute!  I'm more than happy carrying this.[in random order][end if][roman type][line break]";
		otherwise:
			say "[if C is too adult][second custom style][one of]Ugh, this is still way too adult for me![or]*sigh* Isn't there any way to make it even more cartoony and fun?[or]I would prefer something that properly lets everyone know just how immature I am![or]Hmm, this is better but it doesn't scream 'will you take care of me?' in the way I was hoping.[or]Hmm, better, but still too grown up for me.[in random order][otherwise if the bimbo of the player < 7][first custom style][one of]I don't have any problems with wearing this.[or]I'm fine with wearing this.[purely at random][otherwise][variable custom style][one of]I love wearing this![or]I feel so giddy wearing this![or]Ooh, I'm fine wearing this![or]Ooh, how cute!  I'm more than happy wearing this.[or]Wow, I look so adorable in this![in random order][end if][roman type][line break]";
	otherwise if the humiliation of the player < 40000:
		 if C is equippable or C is bag of holding:
			say "[if C is too boring][second custom style][one of]Ugh, this is still way too practical for me!  I need something that yells 'I'M A DISGUSTING WHORE'.[or]*sigh* Isn't there any way to make it even more slutty?[in random order][otherwise if the bimbo of the player < 7][first custom style][one of]I don't have any problems with using this.[or]This is still fine for me.[purely at random][otherwise][variable custom style][one of]Oh nice, I'm going to love showing this off![or]Ooh, how lush! My friends would be so jealous if they could see me with this.[in random order][end if][roman type][line break]";
		otherwise:
			say "[if C is too boring and C is actually dense and C is breast covering or C is belly covering or C is crotch covering][second custom style][one of]Ugh, this is still way too plain for me![or]*sigh* Isn't there any way to make it even more revealing?[or]Aww, I was hoping for something even more slutty![or]Hmm, can't it get even more revealing?[in random order][otherwise if C is too boring][second custom style][one of]Ugh, this is still way too boring for me![or]*sigh* Isn't there any way to make it even more lewd?[or]I would prefer something that properly lets everyone know just how slutty I am![or]Hmm, this is better but it doesn't scream 'FUCK ME' in the way I was hoping.[or]Hmm, better, but still too boring for me.[in random order][otherwise if the bimbo of the player < 7][first custom style][one of]I don't have any problems with wearing this.[or]I'm fine with wearing this.[purely at random][otherwise][variable custom style][one of]I love wearing this![or]I feel AMAZING wearing this![or]Ooh, I'm fine wearing this![or]Ooh, how lush!  I'm more than happy wearing this.[or]Wow, I look [beautiful] in this![in random order][end if][roman type][line break]".
