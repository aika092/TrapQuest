...
To say ExamineDesc of (B - an infernal gem):
...
To say ShortDesc of (C - an infernal gem):
	say "red gem".
To say MediumDesc of (C - an infernal gem):
	say "magic red gem".

Definition: an infernal gem is demonic: decide yes.
Definition: an infernal gem is gem themed: decide yes.
