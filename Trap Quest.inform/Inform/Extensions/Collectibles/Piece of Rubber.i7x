...
To decide which number is the crafting key of (C - a piece of rubber):
	decide on 44.

To decide which number is the bartering value of (T - a piece of rubber) for (M - a sex doll):
	decide on 2.
To decide which number is the bartering value of (T - a piece of rubber) for (M - an aeromancer):
	decide on 3.

Definition: a piece of rubber is inflation themed: decide yes.
Definition: a piece of rubber is pink themed: decide yes.
