...
Definition: a reception bell (called M) is immune to change:
	decide yes.
...
Definition: a black candle (called M) is immune to change:
	decide yes.
...
Definition: a doom notes (called M) is immune to change:
	decide yes.
