...
To decide which number is the crafting key of (C - a metal disc):
	decide on 47.
To decide which number is the bartering value of (T - a metal disc) for (M - a royal guard):
	decide on 2.

To decide which number is the bartering value of (T - a metal disc) for (M - a mechanic):
	decide on 3.

To decide which number is the bartering value of (T - a metal disc) for (M - a shopkeeper):
	decide on 1.
