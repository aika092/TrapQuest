...
To decide which figure-name is clothing-image of (C - slave-dress):
	decide on figure of slave-dress.

To say ClothingDesc of (M - slave-dress):
...
To say ShortDesc of (C - slave-dress):
	say "slave dress".
To say MediumDesc of (C - slave-dress):
	say "slave strap dress".
