...
A maternity dress is a kind of overdress.  A maternity dress is usually unique.  A maternity dress is usually absorption.  A maternity dress is usually fully covering.  A maternity dress is usually vaginal-sex-addiction-influencing. Figure of Maternity Dress is the file "maternitydress1.png".
...
To compute periodic effect of (M - a maternity dress):
	...
	if a random number between 1 and 250 < 2 + unlucky:
