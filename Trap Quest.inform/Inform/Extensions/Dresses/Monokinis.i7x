...
Figure of white monokini is the file "monokini3.png".
...
To decide which object is the potential-upgrade-target of (C - a white monokini):
	decide on a random off-stage blue minimalist monokini.
...
Figure of green monokini is the file "monokini1.png".
...
To decide which object is the potential-upgrade-target of (C - a green monokini):
...
Figure of grey monokini is the file "monokini2.png".
...
To decide which object is the potential-upgrade-target of (C - a grey monokini):
	decide on a random off-stage green monokini.
