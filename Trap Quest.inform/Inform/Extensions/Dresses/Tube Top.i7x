...
To reflect on (A - outrageous-tubetop):
	say "[variable custom style]I wouldn't be seen dead in this tube top back home...[roman type][line break]".
...
To say ShortDesc of (C - a cyan tube top):
	say "cyan boob tube".
To say MediumDesc of (C - a cyan tube top):
	say "tiny cyan boob tube".

Definition: a cyan tube top is blue themed: decide yes.
...
To say ShortDesc of (C - a silver tube top):
	say "silver boob tube".
To say MediumDesc of (C - a silver tube top):
	say "tiny silver boob tube".

Definition: a silver tube top is grey themed: decide yes.
...
To say ShortDesc of (C - a pink tube top):
	say "pink boob tube".
To say MediumDesc of (C - a pink tube top):
...
Definition: a yellow exposing tube top is yellow themed: decide yes.
...
To decide which figure-name is clothing-image of (C - leopard print tube top):
	decide on figure of leopard print tube top.

To say ShortDesc of (C - leopard print tube top):
	say "tube top".
To say MediumDesc of (C - leopard print tube top):
