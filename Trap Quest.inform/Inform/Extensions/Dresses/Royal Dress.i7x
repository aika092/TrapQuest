...
To say ClothingDesc of (O - a ballgown royal dress):
	say "A pink, puffy silk dress that [if the thickness of hips > 5 and O is worn]would be just above knee height on a normal sized ass, but yours prevents it from sitting properly and so it covers almost none of your modesty[otherwise]is just above knee height[end if].  A deep V-cut cleavage invites the eye towards your breasts.  [if the outrage of O is too humiliating][first custom style]It's still more modest than most of the clothing in this game.  But there's just something about being dressed as a dainty princess that's so... humiliating.[roman type]  [end if]The fine cut of the material is evidence that this dress is meant only for the most important of people.".
