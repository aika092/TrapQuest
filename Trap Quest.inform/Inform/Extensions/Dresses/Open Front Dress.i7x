...
an open-front-dress is a kind of overdress. The skirt-length of an open-front-dress is 5. an open-front-dress is arm exposing. an open-front-dress is erect-nipple-exposing. an open-front-dress is transformation-rare.
...
To decide which number is the initial cringe of (C - an open-front-dress):
	decide on 3.
To decide which number is the front-skirt-length of (C - an open-front-dress):
	decide on 1.
...
To decide which figure-name is clothing-image of (C - yellow-open-front-dress):
...
Definition: yellow-open-front-dress is end of transformation chain:
