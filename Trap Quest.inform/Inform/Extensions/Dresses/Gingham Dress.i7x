...
Part 2 - dangerously short gingham dress

A dangerously short gingham dress is a kind of gingham dress.

The printed name of dangerously short gingham dress is usually "[clothing-title-before]dangerously short gingham dress[clothing-title-after]". The text-shortcut of dangerously short gingham dress is "sgd". A dangerously short gingham dress is usually fully covering. The skirt-length of a dangerously short gingham dress is 1.
...
To say ClothingDesc of (C - a dangerously short gingham dress):
	say "A pink and white dangerously short gingham dress. It has a very 'babygirl' feel.".

To say ShortDesc of (C - a dangerously short gingham dress):
	say "dangerously short gingham dress".

To decide which number is the initial outrage of (C - a dangerously short gingham dress):
	if diaper quest is 0, decide on 8;
	decide on 4.

To decide which number is the initial cringe of (C - a dangerously short gingham dress):
	decide on 6.

Definition: a dangerously short gingham dress is pink themed: decide yes.

dainty dress is an overdress. The skirt-length of dainty dress is 4. dainty dress is only arm covering. The printed name of dainty dress is "[clothing-title-before]dainty dress[clothing-title-after]". The text-shortcut of dainty dress is "dtyd".
...
To decide which number is the initial cringe of (C - dainty dress):
	decide on 3.
To decide which number is the defaultDiaperCoveringLength of (C - dainty dress):
...
To decide which number is the initial outrage of (C - nursery smock):
	if diaper quest is 0, decide on the initial cringe of C;
	decide on 2.
To decide which number is the initial cringe of (C - nursery smock):
	decide on 9.

To decide which number is the diaperCoveringLength of (C - nursery smock):
	decide on 6.
To decide which number is the diaperHidingLength of (C - nursery smock):
	if C is crotch-displaced or C is crotch-unzipped or C is crotch-ripped, decide on -1;
	decide on 6.

Definition: nursery smock is yellow themed: decide yes.
