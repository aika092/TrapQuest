...
Figure of Latex Dress 3 is the file "latexdress3.png".
Figure of Latex Dress 4 is the file "latexdress4.png".
Figure of Latex Dress 5 is the file "latexdress5.png".
Figure of Latex Dress 6 is the file "latexdress6.png".
Figure of Latex Dress 7 is the file "latexdress7.png".
...
To decide which object is the unique-upgrade-target of (C - a fetish dress):
	if the number of worn trousers is 0 and the number of worn rings is 0 and the number of worn bracelets is 0, decide on a random off-stage assless fetish hobble dress;
	decide on nothing.
...
The printed name of green fetish hobble dress is usually "[TQlink of item described][clothing-title-before]green latex dress[clothing-title-after][TQxlink of item described][verb-desc of item described]".
...
The printed name of translucent fetish dress is usually "[TQlink of item described][clothing-title-before]translucent latex dress[clothing-title-after][TQxlink of item described][verb-desc of item described]".
...
The printed name of pink fetish dress is usually "[TQlink of item described][clothing-title-before]pink latex dress[clothing-title-after][TQxlink of item described][verb-desc of item described]".
...
To decide which object is the potential-upgrade-target of (C - a pink fetish dress):
...
The printed name of red fetish dress is usually "[TQlink of item described][clothing-title-before]red latex dress[clothing-title-after][TQxlink of item described][verb-desc of item described]".
...
To decide which object is the potential-upgrade-target of (C - a red fetish dress):
	if the largeness of breasts > 8, decide on nothing;
	decide on a random off-stage translucent fetish dress.
...
The printed name of black fetish hobble dress is usually "[TQlink of item described][clothing-title-before]black latex hobble dress[clothing-title-after][TQxlink of item described][verb-desc of item described]".
...
The printed name of purple fetish hobble dress is usually "[TQlink of item described][clothing-title-before]purple latex hobble dress[clothing-title-after][TQxlink of item described][verb-desc of item described]".
...
The printed name of assless fetish hobble dress is usually "[TQlink of item described][clothing-title-before]assless latex hobble dress[clothing-title-after][TQxlink of item described][verb-desc of item described]".
