...
To say ShortDesc of (C - a lycra-bodysuit):
	say "neon green bodysuit".

To decide which number is the initial outrage of (C - a lycra-bodysuit):
	decide on 10.
