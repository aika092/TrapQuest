...
There is 1 I heart cum shirt.

To decide which figure-name is clothing-image of (C - an I heart cum shirt):
	decide on figure of I heart cum shirt.

To say ClothingDesc of (C - an I heart cum shirt):
	say "This long sleeved shirt has the phrase 'I <3 cum' in medium sized characters on it.".

To say ShortDesc of (C - an I heart cum shirt):
	say "very offensive shirt advertising that you love [semen]".

To decide which number is the initial outrage of (C - an I heart cum shirt):
	decide on 2.

To compute periodic effect of (G - an I heart cum shirt):
	if the semen taste addiction of the player < 20 and a random number between 1 and 50 * the semen taste addiction of the player < 4:
		say "[bold type]You feel a small amount of magic emanate from your [printed name of G][bold type], and you feel a bit more [if the semen taste addiction of the player < 7]curious[otherwise if the semen taste addiction of the player < 14]eager[otherwise]desperate[end if] to taste some semen.[roman type][line break]";
