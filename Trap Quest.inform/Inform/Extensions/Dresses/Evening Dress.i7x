...
Figure of Evening Dress 5 is the file "Items/Clothes/Upper/Dresses/Evening/eveningdress5.png".
...
This is the remove inappropriate evening dress rule:
	repeat with B running through evening dresses:
...
To decide which figure-name is clothing-image of (C - a red evening dress):
	decide on figure of evening dress 1.

To say ClothingDesc of (C - a red evening dress):
	say "This red evening dress restricts your movement with its tight hobble skirt section around your legs. Even worse, the fabric only covers your sides and shoulders; it does nothing to defend your crotch and leaves your chest and belly bare as well.".

To say ShortDesc of (C - a red evening dress):
	say "red evening dress".

To say MediumDesc of (C - a red evening dress):
	say "private parts baring red evening dress".

To say spawning flavour of (C - a red evening dress):
	say "[bold type]A red evening dress appears on you! Its outrageous style means that your chest and crotch remain completely exposed, and it restricts your walking![roman type][line break]".

To decide which number is the initial outrage of (C - a red evening dress):
	decide on 10.

Definition: a red evening dress is red themed: decide yes.
...
To decide which figure-name is clothing-image of (C - a pink evening dress):
	decide on figure of evening dress 2.
...
To say ShortDesc of (C - a pink evening dress):
	say "pink evening dress".

To say MediumDesc of (C - a pink evening dress):
	say "hips emphasising pink evening dress".

To decide which number is the initial outrage of (C - a pink evening dress):
	decide on 6.
...
The printed name of black lace evening dress is usually "[clothing-title-before]black lace evening dress[clothing-title-after]".

To decide which figure-name is clothing-image of (C - a black lace evening dress):
	decide on figure of evening dress 3.

To say ClothingDesc of (C - a black lace evening dress):
	say "This lacy black evening dress restricts your movement with its tight hobble skirt section around your legs. Its pattern is woven such that the dress is partially see through. [if the bimbo of the player < 12]Even worse, [otherwise]Even more exciting, [end if]the cleavage V neck starts at your belly button, meaning it's impossible to use the dress to cover any of your [BreastDesc].".

To say ShortDesc of (C - a black lace evening dress):
	say "black lace evening dress".

To say MediumDesc of (C - a black lace evening dress):
...
Part 4 - Lace Evening Dress

A lace evening dress is a kind of evening dress. A lace evening dress is usually sheer. There is 1 lace evening dress. A lace evening dress is usually fully covering. A lace evening dress is usually only arm covering. A lace evening dress is usually not-top-displacable. The text-shortcut of lace evening dress is "lev".

The printed name of lace evening dress is usually "[clothing-title-before]lace evening dress[clothing-title-after]".

To decide which figure-name is clothing-image of (C - a lace evening dress):
...
To say MediumDesc of (C - a lace evening dress):
...
To decide which figure-name is clothing-image of (C - purple-evening-dress):
...
To say spawning flavour of (C - purple-evening-dress):
	say "[bold type]A purple evening dress appears on you![roman type][line break]".

Definition: purple-evening-dress is slitted: decide yes.
Definition: purple-evening-dress is pink themed: decide yes.
Definition: purple-evening-dress is purple themed: decide yes.
