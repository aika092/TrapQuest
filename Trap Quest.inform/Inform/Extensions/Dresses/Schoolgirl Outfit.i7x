...
Definition: a schoolgirl outfit (called C) is schoolgirl-enabling:
	decide yes.
...
To decide which object is the potential-upgrade-target of (C - a cheeky schoolgirl outfit):
...
To decide which object is the potential-upgrade-target of (C - a provocative schoolgirl outfit):
...
To decide which object is the potential-upgrade-target of (C - a halloween schoolgirl outfit):
