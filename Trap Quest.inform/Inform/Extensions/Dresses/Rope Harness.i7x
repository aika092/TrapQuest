...
A rope harness is a kind of overdress.  A rope harness is usually hemp.  A rope harness is usually see-through.  A rope harness is usually fully exposing.  A rope harness is usually belly covering.  A rope harness is usually unskirted.  A rope harness is usually nipple exposing.  There is rope harness. Figure of rope harness is the file "ropeharness1.png". The soak-limit of a rope harness is usually 7.
...
To compute periodic effect of (C - a rope harness):
	if a random number between -300 and 6 > the square root of the raw strength of the player:
		say "[bold type]Thanks to wearing the [printed name of C], your muscles have gotten stronger![roman type][line break]";
		StrengthUp 1.
