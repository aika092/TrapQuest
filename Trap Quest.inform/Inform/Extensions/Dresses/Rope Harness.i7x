...
A rope harness is a kind of overdress. A rope harness is usually hemp. A rope harness is usually see-through. A rope harness is usually fully exposing. A rope harness is usually belly covering. A rope harness is usually unskirted. A rope harness is usually nipple exposing. There is rope harness. Figure of rope harness is the file "ropeharness1.png". The soak-limit of a rope harness is usually 7.  A rope harness has a number called charge.
