...
A baby-dress is a kind of overdress. A baby-dress is usually unique. A baby-dress is usually high cut. A baby-dress is usually no-crotch. A baby-dress is usually short. A baby-dress is usually top-exclusive.

To decide which number is the initial outrage of (C - a baby-dress):
	if diaper quest is 1, decide on 0; [In DQ, these are no considered provocative, just childish]
	decide on 4.
...
Definition: a baby-dress (called C) is fetish appropriate:
	if diaper lover > 0, decide yes;
	decide no.

Definition: a baby-dress (called C) is sissifying:
	if diaper lover > 0, decide yes;
	decide no.
...
Definition: a baby-dress (called C) is baby themed: [Is it something that only an adult baby fetishist would have?]
	decide yes.
...
To say ClothingDesc of (C - a teddybear baby dress):
	say "A blue and pink dress with a teddybear on the chest and a skirt that starts above the belly button and is no more than a few inches long, to fully expose [if C is worn]your[otherwise]the wearer's[end if] underwear.".

To compute SelfExamineDesc of (C - a teddybear baby dress):
...
To say ClothingDesc of (C - a kitty cat baby dress):
	say "A pink and white dress with a kitty cat motif. The dress ends halfway down the hips, to fully expose [if C is worn]your[otherwise]the wearer's[end if] underwear.".

To say ShortDesc of (C - a kitty cat baby dress):
	say "super short kitty cat baby dress".

Definition: a kitty cat baby dress (called C) is cat themed:
	decide yes.
...
To compute SelfExamineDesc of (C - a dinosaur baby dress):
	say "super short dinosaur baby dress".
	

Part 10 - Yellow Babydoll Dress

A yellow babydoll dress is a kind of baby-dress. There is 1 yellow babydoll dress. The printed name of yellow babydoll dress is "[TQlink of item described][clothing-title-before]super short yellow babydoll dress[clothing-title-after][TQxlink of item described][verb-desc of item described]". Understand "super", "short" as yellow babydoll dress. A yellow babydoll dress is usually super-short. A yellow babydoll dress is usually belly exposing. The text-shortcut of yellow babydoll dress is "ybdd".
