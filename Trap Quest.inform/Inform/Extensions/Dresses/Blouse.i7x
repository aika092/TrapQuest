...
To compute banish drop of (C - a bodice) from (M - a wench):
	if C is off-stage:
		...
		say "[BigNameDesc of M] removes and drops the [C] [he of M] was wearing.";
		let N be a random number between 6 and 9;
		if bukkake fetish is 1, now the semen-soak of C is N;
		otherwise now the water-soak of C is N;
		compute autotaking C.

pink bodice is a bodice. pink bodice is only arm covering. The text-shortcut of pink bodice is "pbl".
Definition: pink bodice is pink themed: decide yes.
black bodice is a bodice. The text-shortcut of black bodice is "bbl".
Definition: black bodice is black themed: decide yes.
...
Definition: white-bodice is white themed: decide yes.

The printed name of pink bodice is "[clothing-title-before]pink blouse[clothing-title-after]".
The printed name of black bodice is "[clothing-title-before]black blouse[clothing-title-after]".
The printed name of white-bodice is "[clothing-title-before]white blouse[clothing-title-after]".
...
To decide which number is the adult-influence of (C - a bodice):
	decide on 1.
